module tt_um_pqc_ntt_bfly (clk,
 ...
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(net73),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0690_ (.A(net159),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__inv_2 _0691_ (.A(\sreg[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0108_));
 sky130_fd_sc_hd__inv_2 _0692_ (.A(\sreg[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0109_));
 sky130_fd_sc_hd__inv_2 _0693_ (.A(\sreg[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0110_));
 sky130_fd_sc_hd__inv_2 _0694_ (.A(\sreg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0111_));
 sky130_fd_sc_hd__inv_2 _0695_ (.A(\sreg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__inv_2 _0696_ (.A(\sreg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0113_));
 sky130_fd_sc_hd__inv_2 _0697_ (.A(\sreg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__inv_2 _0698_ (.A(\sreg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0115_));
 sky130_fd_sc_hd__inv_2 _0699_ (.A(\sreg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0116_));
 sky130_fd_sc_hd__inv_2 _0700_ (.A(\sreg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0117_));
 sky130_fd_sc_hd__inv_2 _0701_ (.A(\sreg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0118_));
 sky130_fd_sc_hd__inv_2 _0702_ (.A(\scheme[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0119_));
 sky130_fd_sc_hd__inv_2 _0703_ (.A(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__inv_2 _0704_ (.A(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0121_));
 sky130_fd_sc_hd__nand3_2 _0705_ (.A(net81),
    .B(net83),
    .C(net86),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0122_));
 sky130_fd_sc_hd__inv_2 _0706_ (.A(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(uio_out[5]));
 sky130_fd_sc_hd__or2_2 _0707_ (.A(net83),
    .B(net86),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__o21ai_2 _0708_ (.A1(net82),
    .A2(_0123_),
    .B1(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0124_));
 sky130_fd_sc_hd__inv_2 _0709_ (.A(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(busy));
 sky130_fd_sc_hd__or2_2 _0710_ (.A(net10),
    .B(busy),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__nor3_2 _0711_ (.A(net82),
    .B(net84),
    .C(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__or3_2 _0712_ (.A(net82),
    .B(net84),
    .C(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__nand2_2 _0713_ (.A(_0119_),
    .B(\scheme[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__nor2_2 _0714_ (.A(\scheme[1] ),
    .B(\scheme[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0129_));
 sky130_fd_sc_hd__or2_2 _0715_ (.A(\scheme[1] ),
    .B(\scheme[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0130_));
 sky130_fd_sc_hd__xnor2_2 _0716_ (.A(\cnt[2] ),
    .B(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0131_));
 sky130_fd_sc_hd__a22o_2 _0717_ (.A1(\cnt[3] ),
    .A2(\cnt[0] ),
    .B1(\scheme[1] ),
    .B2(\cnt[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__o22a_2 _0718_ (.A1(\cnt[3] ),
    .A2(\cnt[0] ),
    .B1(\scheme[1] ),
    .B2(\cnt[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__o21ai_2 _0719_ (.A1(_0107_),
    .A2(_0128_),
    .B1(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0134_));
 sky130_fd_sc_hd__a2111o_2 _0720_ (.A1(_0107_),
    .A2(_0128_),
    .B1(_0131_),
    .C1(_0133_),
    .D1(_0134_),
    ...
    .VPWR(VPWR),
    .X(_0135_));
 sky130_fd_sc_hd__o2bb2a_2 _0721_ (.A1_N(net65),
    .A2_N(_0135_),
    .B1(net11),
    .B2(_0125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0136_));
 sky130_fd_sc_hd__o211ai_2 _0722_ (.A1(net86),
    .A2(_0124_),
    .B1(_0125_),
    .C1(_0136_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0137_));
 sky130_fd_sc_hd__o211a_2 _0723_ (.A1(net86),
    .A2(_0136_),
    .B1(_0137_),
    .C1(net97),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__a21o_2 _0724_ (.A1(net86),
    .A2(_0136_),
    .B1(net83),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0138_));
 sky130_fd_sc_hd__and3_2 _0725_ (.A(net83),
    .B(net86),
    .C(_0136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0139_));
 sky130_fd_sc_hd__and3b_2 _0726_ (.A_N(_0139_),
    .B(net97),
    .C(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0001_));
 sky130_fd_sc_hd__a21boi_2 _0727_ (.A1(uio_out[5]),
    .A2(_0136_),
    .B1_N(net91),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0140_));
 sky130_fd_sc_hd__o21a_2 _0728_ (.A1(net82),
    .A2(_0139_),
    .B1(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0002_));
 sky130_fd_sc_hd__and2_2 _0729_ (.A(net10),
    .B(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0141_));
 sky130_fd_sc_hd__nand2_2 _0730_ (.A(net10),
    .B(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0142_));
 sky130_fd_sc_hd__nand2_2 _0731_ (.A(net60),
    .B(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0732_ (.A(net31),
    ...
    .VPWR(VPWR),
    .Y(_0144_));
 sky130_fd_sc_hd__or3b_2 _0733_ (.A(net10),
    .B(busy),
    .C_N(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0145_));
 sky130_fd_sc_hd__mux2_1 _0734_ (.A0(net12),
    .A1(\scheme[0] ),
    .S(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0146_));
 sky130_fd_sc_hd__and2_2 _0735_ (.A(net91),
    .B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__o21ai_2 _0736_ (.A1(net13),
    .A2(_0145_),
    .B1(net92),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__a21oi_2 _0737_ (.A1(_0119_),
    .A2(_0145_),
    .B1(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0004_));
 sky130_fd_sc_hd__and3b_2 _0738_ (.A_N(net87),
    .B(net83),
    .C(net81),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__or3b_2 _0739_ (.A(net80),
    .B(net86),
    .C_N(net83),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__and3b_2 _0740_ (.A_N(net81),
    .B(net83),
    .C(net87),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0150_));
 sky130_fd_sc_hd__and3b_2 _0741_ (.A_N(net83),
    .B(net87),
    .C(net81),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__nor2_2 _0742_ (.A(net79),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0152_));
 sky130_fd_sc_hd__or2_2 _0743_ (.A(net79),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__nor2_2 _0744_ (.A(_0148_),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0154_));
 sky130_fd_sc_hd__or2_2 _0745_ (.A(_0148_),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0155_));
 sky130_fd_sc_hd__or3_2 _0746_ (.A(_0148_),
    .B(net79),
    .C(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__nor3b_2 _0747_ (.A(net84),
    .B(net86),
    .C_N(net81),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0157_));
 sky130_fd_sc_hd__nor4_2 _0748_ (.A(_0148_),
    .B(net79),
    .C(_0151_),
    .D(net77),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0158_));
 sky130_fd_sc_hd__a22o_2 _0749_ (.A1(\areg[23] ),
    .A2(net52),
    .B1(net77),
    .B2(\breg[23] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0159_));
 sky130_fd_sc_hd__a21oi_2 _0750_ (.A1(\sreg[23] ),
    .A2(net50),
    .B1(_0159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__o21bai_2 _0751_ (.A1(net81),
    .A2(net87),
    .B1_N(net84),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__o21ba_2 _0752_ (.A1(net81),
    .A2(net87),
    .B1_N(net83),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0162_));
 sky130_fd_sc_hd__and4bb_2 _0753_ (.A_N(net82),
    .B_N(net84),
    .C(net88),
    .D(abit),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__a221oi_2 _0754_ (.A1(\sreg[23] ),
    .A2(net58),
    .B1(net68),
    .B2(\breg[23] ),
    .C1(net71),
    ...
    .VPWR(VPWR),
    .Y(_0164_));
 sky130_fd_sc_hd__a41o_2 _0755_ (.A1(\sreg[23] ),
    .A2(net80),
    .A3(net84),
    .A4(net86),
    .B1(_0164_),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__or2_2 _0756_ (.A(_0160_),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0166_));
 sky130_fd_sc_hd__and2_2 _0757_ (.A(\breg[22] ),
    .B(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0167_));
 sky130_fd_sc_hd__a221o_2 _0758_ (.A1(\areg[22] ),
    .A2(net52),
    .B1(net47),
    .B2(\sreg[22] ),
    .C1(_0167_),
    ...
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__or4bb_2 _0759_ (.A(net83),
    .B(net87),
    .C_N(borrow),
    .D_N(net81),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__or4b_2 _0760_ (.A(net79),
    .B(_0151_),
    .C(net72),
    .D_N(_0169_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__a2111o_2 _0761_ (.A1(_0162_),
    .A2(_0169_),
    .B1(net68),
    .C1(net79),
    .D1(_0151_),
    ...
    .VPWR(VPWR),
    .X(_0171_));
 sky130_fd_sc_hd__nor2_2 _0762_ (.A(_0119_),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0172_));
 sky130_fd_sc_hd__a221oi_2 _0763_ (.A1(\sreg[22] ),
    .A2(net58),
    .B1(net67),
    .B2(\breg[22] ),
    .C1(_0172_),
    ...
    .VPWR(VPWR),
    .Y(_0173_));
 sky130_fd_sc_hd__xnor2_2 _0764_ (.A(net75),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0174_));
 sky130_fd_sc_hd__and2_2 _0765_ (.A(_0168_),
    .B(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0175_));
 sky130_fd_sc_hd__a21oi_2 _0766_ (.A1(abit),
    .A2(\breg[0] ),
    .B1(\sreg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__and3_2 _0767_ (.A(\sreg[0] ),
    .B(abit),
    .C(\breg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__or3_2 _0768_ (.A(net61),
    .B(_0176_),
    .C(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__nor2_2 _0769_ (.A(_0119_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0179_));
 sky130_fd_sc_hd__or2_2 _0770_ (.A(_0119_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__nor2_2 _0771_ (.A(_0168_),
    .B(_0174_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__or2_2 _0772_ (.A(_0175_),
    .B(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0182_));
 sky130_fd_sc_hd__nor2_2 _0773_ (.A(net30),
    .B(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0183_));
 sky130_fd_sc_hd__nand2_2 _0774_ (.A(_0160_),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__and2_2 _0775_ (.A(_0166_),
    .B(_0184_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0185_));
 sky130_fd_sc_hd__o21a_2 _0776_ (.A1(_0175_),
    .A2(_0183_),
    .B1(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0186_));
 sky130_fd_sc_hd__or3_2 _0777_ (.A(_0175_),
    .B(_0183_),
    .C(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0187_));
 sky130_fd_sc_hd__a22o_2 _0778_ (.A1(\areg[21] ),
    .A2(net52),
    .B1(net76),
    .B2(\breg[21] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0188_));
 sky130_fd_sc_hd__a21oi_2 _0779_ (.A1(\sreg[21] ),
    .A2(net47),
    .B1(_0188_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0189_));
 sky130_fd_sc_hd__a221o_2 _0780_ (.A1(\sreg[21] ),
    .A2(net58),
    .B1(net67),
    .B2(\breg[21] ),
    .C1(_0172_),
    ...
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__xnor2_2 _0781_ (.A(net75),
    .B(_0190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0191_));
 sky130_fd_sc_hd__xor2_2 _0782_ (.A(_0189_),
    .B(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0192_));
 sky130_fd_sc_hd__nand2_2 _0783_ (.A(_0179_),
    .B(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0193_));
 sky130_fd_sc_hd__o21a_2 _0784_ (.A1(_0189_),
    .A2(_0191_),
    .B1(_0193_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__and2_2 _0785_ (.A(net30),
    .B(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__or2_2 _0786_ (.A(_0183_),
    .B(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0196_));
 sky130_fd_sc_hd__nor2_2 _0787_ (.A(_0194_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0197_));
 sky130_fd_sc_hd__a22o_2 _0788_ (.A1(\areg[20] ),
    .A2(net53),
    .B1(net76),
    .B2(\breg[20] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__a21oi_2 _0789_ (.A1(\sreg[20] ),
    .A2(net47),
    .B1(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__a221oi_2 _0790_ (.A1(\sreg[20] ),
    .A2(net58),
    .B1(net67),
    .B2(\breg[20] ),
    .C1(_0172_),
    ...
    .VPWR(VPWR),
    .Y(_0200_));
 sky130_fd_sc_hd__xnor2_2 _0791_ (.A(net70),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__or2_2 _0792_ (.A(_0199_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__xnor2_2 _0793_ (.A(_0199_),
    .B(_0201_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0203_));
 sky130_fd_sc_hd__or2_2 _0794_ (.A(net30),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0204_));
 sky130_fd_sc_hd__or2_2 _0795_ (.A(_0179_),
    .B(_0192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0205_));
 sky130_fd_sc_hd__nand2_2 _0796_ (.A(_0193_),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0206_));
 sky130_fd_sc_hd__and3_2 _0797_ (.A(_0202_),
    .B(_0204_),
    .C(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0207_));
 sky130_fd_sc_hd__and2_2 _0798_ (.A(\breg[15] ),
    .B(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__a221o_2 _0799_ (.A1(\areg[15] ),
    .A2(net52),
    .B1(net48),
    .B2(\sreg[15] ),
    .C1(_0208_),
    ...
    .VPWR(VPWR),
    .X(_0209_));
 sky130_fd_sc_hd__nand2_2 _0800_ (.A(\breg[15] ),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__o221a_2 _0801_ (.A1(_0111_),
    .A2(net59),
    .B1(net46),
    .B2(_0119_),
    .C1(_0210_),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__xnor2_2 _0802_ (.A(net74),
    .B(_0211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__nand2_2 _0803_ (.A(_0209_),
    .B(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__xor2_2 _0804_ (.A(_0209_),
    .B(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0214_));
 sky130_fd_sc_hd__a21bo_2 _0805_ (.A1(_0179_),
    .A2(_0214_),
    .B1_N(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__a22o_2 _0806_ (.A1(\areg[16] ),
    .A2(net52),
    .B1(net76),
    .B2(\breg[16] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__a21oi_2 _0807_ (.A1(\sreg[16] ),
    .A2(net48),
    .B1(_0216_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0217_));
 sky130_fd_sc_hd__a221oi_2 _0808_ (.A1(\sreg[16] ),
    .A2(net58),
    .B1(net67),
    .B2(\breg[16] ),
    .C1(_0172_),
    ...
    .VPWR(VPWR),
    .Y(_0218_));
 sky130_fd_sc_hd__xnor2_2 _0809_ (.A(net70),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0219_));
 sky130_fd_sc_hd__or2_2 _0810_ (.A(_0217_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0220_));
 sky130_fd_sc_hd__xnor2_2 _0811_ (.A(_0217_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _0812_ (.A(net30),
    ...
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__xnor2_2 _0813_ (.A(net30),
    .B(_0221_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0223_));
 sky130_fd_sc_hd__and2b_2 _0814_ (.A_N(_0223_),
    .B(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0224_));
 sky130_fd_sc_hd__and2b_2 _0815_ (.A_N(_0215_),
    .B(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__or2_2 _0816_ (.A(_0224_),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0226_));
 sky130_fd_sc_hd__and2_2 _0817_ (.A(\breg[6] ),
    .B(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0227_));
 sky130_fd_sc_hd__a221o_2 _0818_ (.A1(\areg[6] ),
    .A2(net54),
    .B1(net49),
    .B2(\sreg[6] ),
    .C1(_0227_),
    ...
    .VPWR(VPWR),
    .X(_0228_));
 sky130_fd_sc_hd__a221o_2 _0819_ (.A1(\sreg[6] ),
    .A2(net58),
    .B1(net68),
    .B2(\breg[6] ),
    .C1(net72),
    ...
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__nand4_2 _0820_ (.A(\sreg[6] ),
    .B(net80),
    .C(net85),
    .D(net88),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0230_));
 sky130_fd_sc_hd__and3_2 _0821_ (.A(_0228_),
    .B(_0229_),
    .C(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0231_));
 sky130_fd_sc_hd__nand3_2 _0822_ (.A(_0228_),
    .B(_0229_),
    .C(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__a22o_2 _0823_ (.A1(\areg[7] ),
    .A2(net54),
    .B1(net77),
    .B2(\breg[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0233_));
 sky130_fd_sc_hd__a21oi_2 _0824_ (.A1(\sreg[7] ),
    .A2(net49),
    .B1(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0234_));
 sky130_fd_sc_hd__a221oi_2 _0825_ (.A1(\sreg[7] ),
    .A2(net58),
    .B1(net68),
    .B2(\breg[7] ),
    .C1(net72),
    ...
    .VPWR(VPWR),
    .Y(_0235_));
 sky130_fd_sc_hd__a41o_2 _0826_ (.A1(\sreg[7] ),
    .A2(net80),
    .A3(net85),
    .A4(net88),
    .B1(_0235_),
    ...
    .VPWR(VPWR),
    .X(_0236_));
 sky130_fd_sc_hd__or2_2 _0827_ (.A(_0234_),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__nand2_2 _0828_ (.A(_0234_),
    .B(_0236_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0238_));
 sky130_fd_sc_hd__and2_2 _0829_ (.A(_0237_),
    .B(_0238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__and2_2 _0830_ (.A(\breg[5] ),
    .B(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0240_));
 sky130_fd_sc_hd__a221o_2 _0831_ (.A1(\areg[5] ),
    .A2(net54),
    .B1(net49),
    .B2(\sreg[5] ),
    .C1(_0240_),
    ...
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__a221o_2 _0832_ (.A1(\sreg[5] ),
    .A2(net58),
    .B1(net68),
    .B2(\breg[5] ),
    .C1(net72),
    ...
    .VPWR(VPWR),
    .X(_0242_));
 sky130_fd_sc_hd__nand4_2 _0833_ (.A(\sreg[5] ),
    .B(net80),
    .C(net85),
    .D(net88),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0243_));
 sky130_fd_sc_hd__and3_2 _0834_ (.A(_0241_),
    .B(_0242_),
    .C(_0243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__nand3_2 _0835_ (.A(_0241_),
    .B(_0242_),
    .C(_0243_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0245_));
 sky130_fd_sc_hd__a21o_2 _0836_ (.A1(_0229_),
    .A2(_0230_),
    .B1(_0228_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0246_));
 sky130_fd_sc_hd__and3_2 _0837_ (.A(_0232_),
    .B(_0244_),
    .C(_0246_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__o21a_2 _0838_ (.A1(_0231_),
    .A2(_0247_),
    .B1(_0239_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__a21oi_2 _0839_ (.A1(_0232_),
    .A2(_0246_),
    .B1(_0244_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0249_));
 sky130_fd_sc_hd__nor2_2 _0840_ (.A(_0247_),
    .B(_0249_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0250_));
 sky130_fd_sc_hd__xnor2_2 _0841_ (.A(_0232_),
    .B(_0239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0251_));
 sky130_fd_sc_hd__a21oi_2 _0842_ (.A1(_0250_),
    .A2(_0251_),
    .B1(_0248_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0252_));
 sky130_fd_sc_hd__and2_2 _0843_ (.A(\breg[2] ),
    .B(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0253_));
 sky130_fd_sc_hd__a221oi_2 _0844_ (.A1(\areg[2] ),
    .A2(net54),
    .B1(net49),
    .B2(\sreg[2] ),
    .C1(_0253_),
    ...
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__a221oi_2 _0845_ (.A1(\sreg[2] ),
    .A2(net58),
    .B1(net68),
    .B2(\breg[2] ),
    .C1(net72),
    ...
    .VPWR(VPWR),
    .Y(_0255_));
 sky130_fd_sc_hd__and4_2 _0846_ (.A(\sreg[2] ),
    .B(net80),
    .C(net85),
    .D(net88),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__or3_2 _0847_ (.A(_0254_),
    .B(_0255_),
    .C(_0256_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0257_));
 sky130_fd_sc_hd__and2_2 _0848_ (.A(\breg[3] ),
    .B(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__a221o_2 _0849_ (.A1(\areg[3] ),
    .A2(net54),
    .B1(net51),
    .B2(\sreg[3] ),
    .C1(_0258_),
    ...
    .VPWR(VPWR),
    .X(_0259_));
 sky130_fd_sc_hd__a221o_2 _0850_ (.A1(\sreg[3] ),
    .A2(net58),
    .B1(net68),
    .B2(\breg[3] ),
    .C1(net72),
    ...
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__nand4_2 _0851_ (.A(\sreg[3] ),
    .B(net80),
    .C(net85),
    .D(net88),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__nand3_2 _0852_ (.A(_0259_),
    .B(_0260_),
    .C(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0262_));
 sky130_fd_sc_hd__a21o_2 _0853_ (.A1(_0260_),
    .A2(_0261_),
    .B1(_0259_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0263_));
 sky130_fd_sc_hd__and2_2 _0854_ (.A(_0262_),
    .B(_0263_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0264_));
 sky130_fd_sc_hd__and2b_2 _0855_ (.A_N(_0257_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0265_));
 sky130_fd_sc_hd__o21ai_2 _0856_ (.A1(_0255_),
    .A2(_0256_),
    .B1(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0266_));
 sky130_fd_sc_hd__and2_2 _0857_ (.A(_0257_),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0267_));
 sky130_fd_sc_hd__and2_2 _0858_ (.A(\breg[1] ),
    .B(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0268_));
 sky130_fd_sc_hd__a221o_2 _0859_ (.A1(\areg[1] ),
    .A2(net54),
    .B1(net51),
    .B2(\sreg[1] ),
    .C1(_0268_),
    ...
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__a221o_2 _0860_ (.A1(\sreg[1] ),
    .A2(_0153_),
    .B1(net68),
    .B2(\breg[1] ),
    .C1(net72),
    ...
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__nand4_2 _0861_ (.A(\sreg[1] ),
    .B(net80),
    .C(net85),
    .D(net88),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0271_));
 sky130_fd_sc_hd__and3_2 _0862_ (.A(_0269_),
    .B(_0270_),
    .C(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0272_));
 sky130_fd_sc_hd__and3_2 _0863_ (.A(_0257_),
    .B(_0266_),
    .C(_0272_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__and2_2 _0864_ (.A(\breg[0] ),
    .B(net77),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0274_));
 sky130_fd_sc_hd__a221o_2 _0865_ (.A1(\areg[0] ),
    .A2(net54),
    .B1(net51),
    .B2(\sreg[0] ),
    .C1(_0274_),
    ...
    .VPWR(VPWR),
    .X(_0275_));
 sky130_fd_sc_hd__o31ai_2 _0866_ (.A1(net79),
    .A2(_0151_),
    .A3(net68),
    .B1(_0118_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0276_));
 sky130_fd_sc_hd__and2_2 _0867_ (.A(\breg[0] ),
    .B(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__a211o_2 _0868_ (.A1(_0170_),
    .A2(_0276_),
    .B1(_0277_),
    .C1(net72),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__o21ai_2 _0869_ (.A1(_0276_),
    .A2(_0277_),
    .B1(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0279_));
 sky130_fd_sc_hd__and3_2 _0870_ (.A(_0275_),
    .B(_0278_),
    .C(_0279_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0280_));
 sky130_fd_sc_hd__a21o_2 _0871_ (.A1(_0278_),
    .A2(_0279_),
    .B1(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0281_));
 sky130_fd_sc_hd__nand2b_2 _0872_ (.A_N(_0280_),
    .B(_0281_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__o21ai_2 _0873_ (.A1(net80),
    .A2(_0121_),
    .B1(net84),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__nand2_2 _0874_ (.A(_0178_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0284_));
 sky130_fd_sc_hd__a21o_2 _0875_ (.A1(_0281_),
    .A2(_0284_),
    .B1(_0280_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__a21oi_2 _0876_ (.A1(_0270_),
    .A2(_0271_),
    .B1(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__nor2_2 _0877_ (.A(_0272_),
    .B(_0286_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0287_));
 sky130_fd_sc_hd__nand2_2 _0878_ (.A(_0285_),
    .B(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0288_));
 sky130_fd_sc_hd__a31o_2 _0879_ (.A1(_0267_),
    .A2(_0285_),
    .A3(_0287_),
    .B1(_0273_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__xnor2_2 _0880_ (.A(_0257_),
    .B(_0264_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0290_));
 sky130_fd_sc_hd__a21o_2 _0881_ (.A1(_0289_),
    .A2(_0290_),
    .B1(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0291_));
 sky130_fd_sc_hd__and2_2 _0882_ (.A(\breg[4] ),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0292_));
 sky130_fd_sc_hd__a221o_2 _0883_ (.A1(\areg[4] ),
    .A2(net54),
    .B1(net51),
    .B2(\sreg[4] ),
    .C1(_0292_),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__a221o_2 _0884_ (.A1(\sreg[4] ),
    .A2(_0153_),
    .B1(net69),
    .B2(\breg[4] ),
    .C1(net73),
    ...
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__nand4_2 _0885_ (.A(\sreg[4] ),
    .B(_0120_),
    .C(net85),
    .D(net88),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0295_));
 sky130_fd_sc_hd__and3_2 _0886_ (.A(_0293_),
    .B(_0294_),
    .C(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__a21o_2 _0887_ (.A1(_0242_),
    .A2(_0243_),
    .B1(_0241_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0297_));
 sky130_fd_sc_hd__and3_2 _0888_ (.A(_0245_),
    .B(_0296_),
    .C(_0297_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0298_));
 sky130_fd_sc_hd__a21o_2 _0889_ (.A1(_0245_),
    .A2(_0297_),
    .B1(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__nand2b_2 _0890_ (.A_N(_0298_),
    .B(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0300_));
 sky130_fd_sc_hd__a21oi_2 _0891_ (.A1(_0294_),
    .A2(_0295_),
    .B1(_0293_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0301_));
 sky130_fd_sc_hd__nor3_2 _0892_ (.A(_0262_),
    .B(_0296_),
    .C(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0302_));
 sky130_fd_sc_hd__or3_2 _0893_ (.A(_0262_),
    .B(_0296_),
    .C(_0301_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0303_));
 sky130_fd_sc_hd__o21ai_2 _0894_ (.A1(_0296_),
    .A2(_0301_),
    .B1(_0262_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0304_));
 sky130_fd_sc_hd__nand2_2 _0895_ (.A(_0303_),
    .B(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0305_));
 sky130_fd_sc_hd__nor2_2 _0896_ (.A(_0300_),
    .B(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0306_));
 sky130_fd_sc_hd__and2_2 _0897_ (.A(_0291_),
    .B(_0306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__a21o_2 _0898_ (.A1(_0299_),
    .A2(_0302_),
    .B1(_0298_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__a211oi_2 _0899_ (.A1(_0291_),
    .A2(_0306_),
    .B1(_0308_),
    .C1(_0248_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0309_));
 sky130_fd_sc_hd__or2_2 _0900_ (.A(_0252_),
    .B(_0309_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0310_));
 sky130_fd_sc_hd__and2_2 _0901_ (.A(\breg[14] ),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0311_));
 sky130_fd_sc_hd__a221o_2 _0902_ (.A1(\areg[14] ),
    .A2(net53),
    .B1(net50),
    .B2(\sreg[14] ),
    .C1(_0311_),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__nand2_2 _0903_ (.A(\breg[14] ),
    .B(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0313_));
 sky130_fd_sc_hd__o221a_2 _0904_ (.A1(_0112_),
    .A2(net59),
    .B1(net46),
    .B2(_0119_),
    .C1(_0313_),
    ...
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__xnor2_2 _0905_ (.A(net74),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0315_));
 sky130_fd_sc_hd__nand2_2 _0906_ (.A(_0312_),
    .B(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0316_));
 sky130_fd_sc_hd__xnor2_2 _0907_ (.A(_0312_),
    .B(_0315_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__o21a_2 _0908_ (.A1(net30),
    .A2(_0317_),
    .B1(_0316_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__xnor2_2 _0909_ (.A(_0179_),
    .B(_0214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0319_));
 sky130_fd_sc_hd__or2_2 _0910_ (.A(_0318_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__xnor2_2 _0911_ (.A(_0318_),
    .B(_0319_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0321_));
 sky130_fd_sc_hd__and2_2 _0912_ (.A(\breg[13] ),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0322_));
 sky130_fd_sc_hd__a221o_2 _0913_ (.A1(\areg[13] ),
    .A2(net53),
    .B1(net50),
    .B2(\sreg[13] ),
    .C1(_0322_),
    ...
    .VPWR(VPWR),
    .X(_0323_));
 sky130_fd_sc_hd__nand2_2 _0914_ (.A(\breg[13] ),
    .B(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0324_));
 sky130_fd_sc_hd__o221a_2 _0915_ (.A1(_0113_),
    .A2(net59),
    .B1(net46),
    .B2(_0129_),
    .C1(_0324_),
    ...
    .VPWR(VPWR),
    .X(_0325_));
 sky130_fd_sc_hd__xnor2_2 _0916_ (.A(net74),
    .B(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0326_));
 sky130_fd_sc_hd__and2_2 _0917_ (.A(_0323_),
    .B(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0327_));
 sky130_fd_sc_hd__nor2_2 _0918_ (.A(_0129_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__xor2_2 _0919_ (.A(_0323_),
    .B(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0329_));
 sky130_fd_sc_hd__a21oi_2 _0920_ (.A1(_0328_),
    .A2(_0329_),
    .B1(_0327_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0330_));
 sky130_fd_sc_hd__xnor2_2 _0921_ (.A(_0180_),
    .B(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0331_));
 sky130_fd_sc_hd__nor2_2 _0922_ (.A(_0330_),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0332_));
 sky130_fd_sc_hd__nand2_2 _0923_ (.A(_0330_),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__xnor2_2 _0924_ (.A(_0330_),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0334_));
 sky130_fd_sc_hd__and2_2 _0925_ (.A(\breg[12] ),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0335_));
 sky130_fd_sc_hd__a221o_2 _0926_ (.A1(\areg[12] ),
    .A2(net53),
    .B1(net50),
    .B2(\sreg[12] ),
    .C1(_0335_),
    ...
    .VPWR(VPWR),
    .X(_0336_));
 sky130_fd_sc_hd__nand2_2 _0927_ (.A(\breg[12] ),
    .B(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0337_));
 sky130_fd_sc_hd__o221a_2 _0928_ (.A1(_0114_),
    .A2(_0152_),
    .B1(net46),
    .B2(_0128_),
    .C1(_0337_),
    ...
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__or2_2 _0929_ (.A(net70),
    .B(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0339_));
 sky130_fd_sc_hd__nand2_2 _0930_ (.A(net70),
    .B(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0340_));
 sky130_fd_sc_hd__xnor2_2 _0931_ (.A(net70),
    .B(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__nor2_2 _0932_ (.A(_0128_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0342_));
 sky130_fd_sc_hd__xnor2_2 _0933_ (.A(_0336_),
    .B(_0341_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0343_));
 sky130_fd_sc_hd__a32o_2 _0934_ (.A1(_0336_),
    .A2(_0339_),
    .A3(_0340_),
    .B1(_0342_),
    .B2(_0343_),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__xor2_2 _0935_ (.A(_0328_),
    .B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__nand2_2 _0936_ (.A(_0344_),
    .B(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0346_));
 sky130_fd_sc_hd__nor2_2 _0937_ (.A(_0344_),
    .B(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__xnor2_2 _0938_ (.A(_0344_),
    .B(_0345_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__and2_2 _0939_ (.A(\breg[11] ),
    .B(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0349_));
 sky130_fd_sc_hd__a221o_2 _0940_ (.A1(\areg[11] ),
    .A2(net52),
    .B1(net48),
    .B2(\sreg[11] ),
    .C1(_0349_),
    ...
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__nand2_2 _0941_ (.A(\breg[11] ),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0351_));
 sky130_fd_sc_hd__o221a_2 _0942_ (.A1(_0115_),
    .A2(_0152_),
    .B1(net46),
    .B2(_0130_),
    .C1(_0351_),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__xnor2_2 _0943_ (.A(net73),
    .B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0353_));
 sky130_fd_sc_hd__nand2_2 _0944_ (.A(_0350_),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__or2_2 _0945_ (.A(_0130_),
    .B(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0355_));
 sky130_fd_sc_hd__inv_2 _0946_ (.A(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0356_));
 sky130_fd_sc_hd__xnor2_2 _0947_ (.A(_0350_),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__o21a_2 _0948_ (.A1(_0355_),
    .A2(_0357_),
    .B1(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__xor2_2 _0949_ (.A(_0342_),
    .B(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0359_));
 sky130_fd_sc_hd__nand2b_2 _0950_ (.A_N(_0358_),
    .B(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__xor2_2 _0951_ (.A(_0358_),
    .B(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0361_));
 sky130_fd_sc_hd__or4_2 _0952_ (.A(_0321_),
    .B(_0334_),
    .C(_0348_),
    .D(_0361_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__and2_2 _0953_ (.A(\breg[10] ),
    .B(net76),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0363_));
 sky130_fd_sc_hd__a221o_2 _0954_ (.A1(\areg[10] ),
    .A2(net52),
    .B1(net48),
    .B2(\sreg[10] ),
    .C1(_0363_),
    ...
    .VPWR(VPWR),
    .X(_0364_));
 sky130_fd_sc_hd__nand2_2 _0955_ (.A(\breg[10] ),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0365_));
 sky130_fd_sc_hd__o221a_2 _0956_ (.A1(_0116_),
    .A2(_0152_),
    .B1(net46),
    .B2(_0130_),
    .C1(_0365_),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__xnor2_2 _0957_ (.A(net73),
    .B(_0366_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0367_));
 sky130_fd_sc_hd__nand2_2 _0958_ (.A(_0364_),
    .B(_0367_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0368_));
 sky130_fd_sc_hd__xnor2_2 _0959_ (.A(_0364_),
    .B(_0367_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0369_));
 sky130_fd_sc_hd__o21ai_2 _0960_ (.A1(_0355_),
    .A2(_0369_),
    .B1(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0370_));
 sky130_fd_sc_hd__xnor2_2 _0961_ (.A(_0356_),
    .B(_0357_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0371_));
 sky130_fd_sc_hd__xnor2_2 _0962_ (.A(_0370_),
    .B(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__a22o_2 _0963_ (.A1(\areg[9] ),
    .A2(_0156_),
    .B1(net77),
    .B2(\breg[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0373_));
 sky130_fd_sc_hd__a21oi_2 _0964_ (.A1(\sreg[9] ),
    .A2(net51),
    .B1(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__a221oi_2 _0965_ (.A1(\sreg[9] ),
    .A2(_0153_),
    .B1(net68),
    .B2(\breg[9] ),
    .C1(net72),
    ...
    .VPWR(VPWR),
    .Y(_0375_));
 sky130_fd_sc_hd__a41o_2 _0966_ (.A1(\sreg[9] ),
    .A2(net80),
    .A3(net85),
    .A4(net88),
    .B1(_0375_),
    ...
    .VPWR(VPWR),
    .X(_0376_));
 sky130_fd_sc_hd__or2_2 _0967_ (.A(_0374_),
    .B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0377_));
 sky130_fd_sc_hd__xnor2_2 _0968_ (.A(_0355_),
    .B(_0369_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__or2_2 _0969_ (.A(_0377_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__xnor2_2 _0970_ (.A(_0377_),
    .B(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0380_));
 sky130_fd_sc_hd__and2_2 _0971_ (.A(\sreg[8] ),
    .B(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__a22o_2 _0972_ (.A1(\areg[8] ),
    .A2(net52),
    .B1(net76),
    .B2(\breg[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__or2_2 _0973_ (.A(_0381_),
    .B(_0382_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__nand2_2 _0974_ (.A(\breg[8] ),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0384_));
 sky130_fd_sc_hd__o221a_2 _0975_ (.A1(_0117_),
    .A2(_0152_),
    .B1(net46),
    .B2(_0130_),
    .C1(_0384_),
    ...
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__xnor2_2 _0976_ (.A(_0162_),
    .B(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0386_));
 sky130_fd_sc_hd__o21ba_2 _0977_ (.A1(_0381_),
    .A2(_0382_),
    .B1_N(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__xnor2_2 _0978_ (.A(_0383_),
    .B(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__a21oi_2 _0979_ (.A1(_0356_),
    .A2(_0388_),
    .B1(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__nand2_2 _0980_ (.A(_0374_),
    .B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__and2_2 _0981_ (.A(_0377_),
    .B(_0390_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0391_));
 sky130_fd_sc_hd__and2b_2 _0982_ (.A_N(_0391_),
    .B(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0392_));
 sky130_fd_sc_hd__nand2b_2 _0983_ (.A_N(_0389_),
    .B(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0393_));
 sky130_fd_sc_hd__xnor2_2 _0984_ (.A(_0389_),
    .B(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0394_));
 sky130_fd_sc_hd__xnor2_2 _0985_ (.A(_0356_),
    .B(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0395_));
 sky130_fd_sc_hd__or2_2 _0986_ (.A(_0237_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__xor2_2 _0987_ (.A(_0237_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__or4bb_2 _0988_ (.A(_0372_),
    .B(_0380_),
    .C_N(_0394_),
    .D_N(_0397_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0398_));
 sky130_fd_sc_hd__or4_2 _0989_ (.A(_0252_),
    .B(_0309_),
    .C(_0362_),
    .D(_0398_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0399_));
 sky130_fd_sc_hd__o21a_2 _0990_ (.A1(_0347_),
    .A2(_0360_),
    .B1(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0400_));
 sky130_fd_sc_hd__a211o_2 _0991_ (.A1(_0318_),
    .A2(_0319_),
    .B1(_0330_),
    .C1(_0331_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0401_));
 sky130_fd_sc_hd__o311a_2 _0992_ (.A1(_0321_),
    .A2(_0334_),
    .A3(_0400_),
    .B1(_0401_),
    .C1(_0320_),
    ...
    .VPWR(VPWR),
    .X(_0402_));
 sky130_fd_sc_hd__a2111o_2 _0993_ (.A1(_0393_),
    .A2(_0396_),
    .B1(_0372_),
    .C1(_0380_),
    .D1(_0392_),
    ...
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__a2bb2o_2 _0994_ (.A1_N(_0377_),
    .A2_N(_0378_),
    .B1(_0370_),
    .B2(_0371_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0404_));
 sky130_fd_sc_hd__o21ai_2 _0995_ (.A1(_0370_),
    .A2(_0371_),
    .B1(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0405_));
 sky130_fd_sc_hd__and2_2 _0996_ (.A(_0403_),
    .B(_0405_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0406_));
 sky130_fd_sc_hd__a21o_2 _0997_ (.A1(_0403_),
    .A2(_0405_),
    .B1(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__a31o_2 _0998_ (.A1(_0399_),
    .A2(_0402_),
    .A3(_0407_),
    .B1(_0226_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0408_));
 sky130_fd_sc_hd__a22o_2 _0999_ (.A1(\areg[17] ),
    .A2(net52),
    .B1(net76),
    .B2(\breg[17] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__a21oi_2 _1000_ (.A1(\sreg[17] ),
    .A2(net48),
    .B1(_0409_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0410_));
 sky130_fd_sc_hd__nand2_2 _1001_ (.A(\breg[17] ),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0411_));
 sky130_fd_sc_hd__o221a_2 _1002_ (.A1(_0110_),
    .A2(net59),
    .B1(net46),
    .B2(_0119_),
    .C1(_0411_),
    ...
    .VPWR(VPWR),
    .X(_0412_));
 sky130_fd_sc_hd__xnor2_2 _1003_ (.A(net70),
    .B(_0412_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0413_));
 sky130_fd_sc_hd__or2_2 _1004_ (.A(_0410_),
    .B(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__xnor2_2 _1005_ (.A(_0410_),
    .B(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0415_));
 sky130_fd_sc_hd__or2_2 _1006_ (.A(net30),
    .B(_0415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__nand2_2 _1007_ (.A(net30),
    .B(_0415_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0417_));
 sky130_fd_sc_hd__nand2_2 _1008_ (.A(_0416_),
    .B(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0418_));
 sky130_fd_sc_hd__a21oi_2 _1009_ (.A1(_0220_),
    .A2(_0222_),
    .B1(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0419_));
 sky130_fd_sc_hd__and3_2 _1010_ (.A(_0220_),
    .B(_0222_),
    .C(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0420_));
 sky130_fd_sc_hd__or2_2 _1011_ (.A(_0419_),
    .B(_0420_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0421_));
 sky130_fd_sc_hd__a22o_2 _1012_ (.A1(\areg[18] ),
    .A2(net52),
    .B1(net76),
    .B2(\breg[18] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__a21oi_2 _1013_ (.A1(\sreg[18] ),
    .A2(net48),
    .B1(_0422_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0423_));
 sky130_fd_sc_hd__nand2_2 _1014_ (.A(\breg[18] ),
    .B(net67),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0424_));
 sky130_fd_sc_hd__o221a_2 _1015_ (.A1(_0109_),
    .A2(net59),
    .B1(net46),
    .B2(_0119_),
    .C1(_0424_),
    ...
    .VPWR(VPWR),
    .X(_0425_));
 sky130_fd_sc_hd__xnor2_2 _1016_ (.A(net70),
    .B(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0426_));
 sky130_fd_sc_hd__or2_2 _1017_ (.A(_0423_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__xnor2_2 _1018_ (.A(_0423_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0428_));
 sky130_fd_sc_hd__or2_2 _1019_ (.A(net30),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0429_));
 sky130_fd_sc_hd__and2_2 _1020_ (.A(\breg[19] ),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0430_));
 sky130_fd_sc_hd__a221o_2 _1021_ (.A1(\areg[19] ),
    .A2(net53),
    .B1(net50),
    .B2(\sreg[19] ),
    .C1(_0430_),
    ...
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__nand2_2 _1022_ (.A(\breg[19] ),
    .B(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0432_));
 sky130_fd_sc_hd__o221a_2 _1023_ (.A1(_0108_),
    .A2(net59),
    .B1(_0171_),
    .B2(_0119_),
    .C1(_0432_),
    ...
    .VPWR(VPWR),
    .X(_0433_));
 sky130_fd_sc_hd__xnor2_2 _1024_ (.A(net74),
    .B(_0433_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__xnor2_2 _1025_ (.A(_0431_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0435_));
 sky130_fd_sc_hd__nor2_2 _1026_ (.A(_0180_),
    .B(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0436_));
 sky130_fd_sc_hd__and2_2 _1027_ (.A(_0180_),
    .B(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__or2_2 _1028_ (.A(_0436_),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__a21oi_2 _1029_ (.A1(_0427_),
    .A2(_0429_),
    .B1(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__nand3_2 _1030_ (.A(_0427_),
    .B(_0429_),
    .C(_0438_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0440_));
 sky130_fd_sc_hd__and2b_2 _1031_ (.A_N(_0439_),
    .B(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__xnor2_2 _1032_ (.A(net30),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0442_));
 sky130_fd_sc_hd__a21oi_2 _1033_ (.A1(_0414_),
    .A2(_0416_),
    .B1(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__and3_2 _1034_ (.A(_0414_),
    .B(_0416_),
    .C(_0442_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0444_));
 sky130_fd_sc_hd__or2_2 _1035_ (.A(_0443_),
    .B(_0444_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0445_));
 sky130_fd_sc_hd__or3b_2 _1036_ (.A(_0439_),
    .B(_0445_),
    .C_N(_0440_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__nor2_2 _1037_ (.A(_0224_),
    .B(_0419_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0447_));
 sky130_fd_sc_hd__or2_2 _1038_ (.A(_0420_),
    .B(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__a21oi_2 _1039_ (.A1(_0440_),
    .A2(_0443_),
    .B1(_0439_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0449_));
 sky130_fd_sc_hd__o31a_2 _1040_ (.A1(_0420_),
    .A2(_0446_),
    .A3(_0447_),
    .B1(_0449_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0450_));
 sky130_fd_sc_hd__o31ai_2 _1041_ (.A1(_0408_),
    .A2(_0421_),
    .A3(_0446_),
    .B1(_0450_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0451_));
 sky130_fd_sc_hd__a21o_2 _1042_ (.A1(_0431_),
    .A2(_0434_),
    .B1(_0436_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__nand2_2 _1043_ (.A(_0180_),
    .B(_0203_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0453_));
 sky130_fd_sc_hd__nand2_2 _1044_ (.A(_0204_),
    .B(_0453_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__and3_2 _1045_ (.A(_0204_),
    .B(_0452_),
    .C(_0453_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__xnor2_2 _1046_ (.A(_0452_),
    .B(_0454_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0456_));
 sky130_fd_sc_hd__a21oi_2 _1047_ (.A1(_0202_),
    .A2(_0204_),
    .B1(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0457_));
 sky130_fd_sc_hd__and2b_2 _1048_ (.A_N(_0207_),
    .B(_0455_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__or2_2 _1049_ (.A(_0207_),
    .B(_0457_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0459_));
 sky130_fd_sc_hd__inv_2 _1050_ (.A(_0459_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0460_));
 sky130_fd_sc_hd__a311o_2 _1051_ (.A1(_0451_),
    .A2(_0456_),
    .A3(_0460_),
    .B1(_0458_),
    .C1(_0457_),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__nand2_2 _1052_ (.A(_0194_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0462_));
 sky130_fd_sc_hd__or2_2 _1053_ (.A(_0186_),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__o311a_2 _1054_ (.A1(_0186_),
    .A2(_0197_),
    .A3(_0461_),
    .B1(_0463_),
    .C1(_0187_),
    ...
    .VPWR(VPWR),
    .X(_0464_));
 sky130_fd_sc_hd__xnor2_2 _1055_ (.A(_0166_),
    .B(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0465_));
 sky130_fd_sc_hd__o221a_2 _1056_ (.A1(_0124_),
    .A2(net56),
    .B1(net25),
    .B2(_0149_),
    .C1(_0125_),
    ...
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__o221ai_2 _1057_ (.A1(_0124_),
    .A2(net56),
    .B1(net25),
    .B2(_0149_),
    .C1(_0125_),
    ...
    .VPWR(VPWR),
    .Y(_0467_));
 sky130_fd_sc_hd__xnor2_2 _1058_ (.A(_0282_),
    .B(_0284_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0468_));
 sky130_fd_sc_hd__mux2_1 _1059_ (.A0(\breg[16] ),
    .A1(_0468_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0469_));
 sky130_fd_sc_hd__or2_2 _1060_ (.A(net19),
    .B(_0469_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__o211a_2 _1061_ (.A1(net144),
    .A2(net22),
    .B1(_0470_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__or2_2 _1062_ (.A(_0285_),
    .B(_0287_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0471_));
 sky130_fd_sc_hd__and2_2 _1063_ (.A(_0288_),
    .B(_0471_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__mux2_1 _1064_ (.A0(\breg[17] ),
    .A1(_0472_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0473_));
 sky130_fd_sc_hd__or2_2 _1065_ (.A(net19),
    .B(_0473_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__o211a_2 _1066_ (.A1(net147),
    .A2(net22),
    .B1(_0474_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__xnor2_2 _1067_ (.A(_0267_),
    .B(_0288_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0475_));
 sky130_fd_sc_hd__o21ba_2 _1068_ (.A1(_0272_),
    .A2(_0475_),
    .B1_N(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__mux2_1 _1069_ (.A0(\breg[18] ),
    .A1(_0476_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__or2_2 _1070_ (.A(net19),
    .B(_0477_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__o211a_2 _1071_ (.A1(net170),
    .A2(net22),
    .B1(_0478_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__xor2_2 _1072_ (.A(_0289_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__xnor2_2 _1073_ (.A(_0289_),
    .B(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0480_));
 sky130_fd_sc_hd__nor2_2 _1074_ (.A(_0154_),
    .B(_0480_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__a211o_2 _1075_ (.A1(\breg[19] ),
    .A2(_0154_),
    .B1(net20),
    .C1(_0481_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0482_));
 sky130_fd_sc_hd__o211a_2 _1076_ (.A1(net167),
    .A2(net22),
    .B1(_0482_),
    .C1(net97),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__xnor2_2 _1077_ (.A(_0291_),
    .B(_0305_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0483_));
 sky130_fd_sc_hd__mux2_1 _1078_ (.A0(\breg[20] ),
    .A1(_0483_),
    .S(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__or2_2 _1079_ (.A(net20),
    .B(_0484_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0485_));
 sky130_fd_sc_hd__o211a_2 _1080_ (.A1(net164),
    .A2(net22),
    .B1(_0485_),
    .C1(net95),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0009_));
 sky130_fd_sc_hd__a21oi_2 _1081_ (.A1(_0291_),
    .A2(_0304_),
    .B1(_0302_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0486_));
 sky130_fd_sc_hd__xor2_2 _1082_ (.A(_0300_),
    .B(_0486_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__mux2_1 _1083_ (.A0(\breg[21] ),
    .A1(_0487_),
    .S(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__or2_2 _1084_ (.A(net20),
    .B(_0488_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0489_));
 sky130_fd_sc_hd__o211a_2 _1085_ (.A1(net174),
    .A2(net24),
    .B1(_0489_),
    .C1(net97),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__nor3_2 _1086_ (.A(_0250_),
    .B(_0307_),
    .C(_0308_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0490_));
 sky130_fd_sc_hd__o21a_2 _1087_ (.A1(_0307_),
    .A2(_0308_),
    .B1(_0250_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0491_));
 sky130_fd_sc_hd__nor2_2 _1088_ (.A(_0490_),
    .B(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0492_));
 sky130_fd_sc_hd__mux2_1 _1089_ (.A0(\breg[22] ),
    .A1(_0492_),
    .S(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__or2_2 _1090_ (.A(net21),
    .B(_0493_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__o211a_2 _1091_ (.A1(net182),
    .A2(net24),
    .B1(_0494_),
    .C1(net97),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__nor2_2 _1092_ (.A(_0247_),
    .B(_0491_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0495_));
 sky130_fd_sc_hd__xnor2_2 _1093_ (.A(_0251_),
    .B(_0495_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0496_));
 sky130_fd_sc_hd__mux2_1 _1094_ (.A0(\breg[23] ),
    .A1(_0496_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__or2_2 _1095_ (.A(net19),
    .B(_0497_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0498_));
 sky130_fd_sc_hd__o211a_2 _1096_ (.A1(net152),
    .A2(net22),
    .B1(_0498_),
    .C1(net95),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0012_));
 sky130_fd_sc_hd__or3b_2 _1097_ (.A(_0252_),
    .B(_0309_),
    .C_N(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0499_));
 sky130_fd_sc_hd__xnor2_2 _1098_ (.A(_0310_),
    .B(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0500_));
 sky130_fd_sc_hd__mux2_1 _1099_ (.A0(\areg[0] ),
    .A1(_0500_),
    .S(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__or2_2 _1100_ (.A(net19),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__o211a_2 _1101_ (.A1(net142),
    .A2(net22),
    .B1(_0502_),
    .C1(net95),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0013_));
 sky130_fd_sc_hd__nand2_2 _1102_ (.A(_0396_),
    .B(_0499_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__xor2_2 _1103_ (.A(_0394_),
    .B(_0503_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__mux2_1 _1104_ (.A0(\areg[1] ),
    .A1(_0504_),
    .S(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__or2_2 _1105_ (.A(net21),
    .B(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0506_));
 sky130_fd_sc_hd__o211a_2 _1106_ (.A1(net143),
    .A2(net22),
    .B1(_0506_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0014_));
 sky130_fd_sc_hd__a31o_2 _1107_ (.A1(_0393_),
    .A2(_0396_),
    .A3(_0499_),
    .B1(_0392_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0507_));
 sky130_fd_sc_hd__xor2_2 _1108_ (.A(_0380_),
    .B(_0507_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0508_));
 sky130_fd_sc_hd__mux2_1 _1109_ (.A0(\areg[2] ),
    .A1(_0508_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__or2_2 _1110_ (.A(net19),
    .B(_0509_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__o211a_2 _1111_ (.A1(net139),
    .A2(net23),
    .B1(_0510_),
    .C1(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__o21ai_2 _1112_ (.A1(_0380_),
    .A2(_0507_),
    .B1(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0511_));
 sky130_fd_sc_hd__xnor2_2 _1113_ (.A(_0372_),
    .B(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__mux2_1 _1114_ (.A0(\areg[3] ),
    .A1(_0512_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0513_));
 sky130_fd_sc_hd__or2_2 _1115_ (.A(net19),
    .B(_0513_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0514_));
 sky130_fd_sc_hd__o211a_2 _1116_ (.A1(net138),
    .A2(net23),
    .B1(_0514_),
    .C1(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__or2_2 _1117_ (.A(_0310_),
    .B(_0398_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0515_));
 sky130_fd_sc_hd__a21o_2 _1118_ (.A1(_0406_),
    .A2(_0515_),
    .B1(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0516_));
 sky130_fd_sc_hd__nand3_2 _1119_ (.A(_0361_),
    .B(_0406_),
    .C(_0515_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0517_));
 sky130_fd_sc_hd__and2_2 _1120_ (.A(_0516_),
    .B(_0517_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0518_));
 sky130_fd_sc_hd__mux2_1 _1121_ (.A0(\areg[4] ),
    .A1(_0518_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0519_));
 sky130_fd_sc_hd__or2_2 _1122_ (.A(net19),
    .B(_0519_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0520_));
 sky130_fd_sc_hd__o211a_2 _1123_ (.A1(net146),
    .A2(net23),
    .B1(_0520_),
    .C1(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__nand2_2 _1124_ (.A(_0360_),
    .B(_0516_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0521_));
 sky130_fd_sc_hd__xnor2_2 _1125_ (.A(_0348_),
    .B(_0521_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0522_));
 sky130_fd_sc_hd__mux2_1 _1126_ (.A0(\areg[5] ),
    .A1(_0522_),
    .S(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0523_));
 sky130_fd_sc_hd__or2_2 _1127_ (.A(net20),
    .B(_0523_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0524_));
 sky130_fd_sc_hd__o211a_2 _1128_ (.A1(net148),
    .A2(net24),
    .B1(_0524_),
    .C1(net91),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0018_));
 sky130_fd_sc_hd__o21ai_2 _1129_ (.A1(_0348_),
    .A2(_0516_),
    .B1(_0400_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0525_));
 sky130_fd_sc_hd__xnor2_2 _1130_ (.A(_0334_),
    .B(_0525_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0526_));
 sky130_fd_sc_hd__mux2_1 _1131_ (.A0(\areg[6] ),
    .A1(_0526_),
    .S(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0527_));
 sky130_fd_sc_hd__or2_2 _1132_ (.A(net20),
    .B(_0527_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0528_));
 sky130_fd_sc_hd__o211a_2 _1133_ (.A1(net156),
    .A2(net24),
    .B1(_0528_),
    .C1(net91),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__a21oi_2 _1134_ (.A1(_0333_),
    .A2(_0525_),
    .B1(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0529_));
 sky130_fd_sc_hd__xor2_2 _1135_ (.A(_0321_),
    .B(_0529_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0530_));
 sky130_fd_sc_hd__mux2_1 _1136_ (.A0(\areg[7] ),
    .A1(_0530_),
    .S(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0531_));
 sky130_fd_sc_hd__or2_2 _1137_ (.A(net21),
    .B(_0531_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0532_));
 sky130_fd_sc_hd__o211a_2 _1138_ (.A1(net181),
    .A2(net23),
    .B1(_0532_),
    .C1(net95),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__nand4_2 _1139_ (.A(_0226_),
    .B(_0399_),
    .C(_0402_),
    .D(_0407_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0533_));
 sky130_fd_sc_hd__and2_2 _1140_ (.A(_0408_),
    .B(_0533_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0534_));
 sky130_fd_sc_hd__mux2_1 _1141_ (.A0(\areg[8] ),
    .A1(_0534_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0535_));
 sky130_fd_sc_hd__or2_2 _1142_ (.A(net19),
    .B(_0535_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0536_));
 sky130_fd_sc_hd__o211a_2 _1143_ (.A1(net179),
    .A2(net22),
    .B1(_0536_),
    .C1(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__nand2b_2 _1144_ (.A_N(_0224_),
    .B(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0537_));
 sky130_fd_sc_hd__xnor2_2 _1145_ (.A(_0421_),
    .B(_0537_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0538_));
 sky130_fd_sc_hd__mux2_1 _1146_ (.A0(\areg[9] ),
    .A1(_0538_),
    .S(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0539_));
 sky130_fd_sc_hd__or2_2 _1147_ (.A(net21),
    .B(_0539_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0540_));
 sky130_fd_sc_hd__o211a_2 _1148_ (.A1(net180),
    .A2(net22),
    .B1(_0540_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__a211oi_2 _1149_ (.A1(_0408_),
    .A2(_0447_),
    .B1(_0445_),
    .C1(_0420_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0541_));
 sky130_fd_sc_hd__o211a_2 _1150_ (.A1(_0408_),
    .A2(_0421_),
    .B1(_0445_),
    .C1(_0448_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0542_));
 sky130_fd_sc_hd__nor2_2 _1151_ (.A(_0541_),
    .B(_0542_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0543_));
 sky130_fd_sc_hd__mux2_1 _1152_ (.A0(\areg[10] ),
    .A1(_0543_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0544_));
 sky130_fd_sc_hd__or2_2 _1153_ (.A(net19),
    .B(_0544_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0545_));
 sky130_fd_sc_hd__o211a_2 _1154_ (.A1(net176),
    .A2(net23),
    .B1(_0545_),
    .C1(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__nor2_2 _1155_ (.A(_0443_),
    .B(_0541_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0546_));
 sky130_fd_sc_hd__xnor2_2 _1156_ (.A(_0441_),
    .B(_0546_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0547_));
 sky130_fd_sc_hd__mux2_1 _1157_ (.A0(\areg[11] ),
    .A1(_0547_),
    .S(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0548_));
 sky130_fd_sc_hd__or2_2 _1158_ (.A(net20),
    .B(_0548_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0549_));
 sky130_fd_sc_hd__o211a_2 _1159_ (.A1(net177),
    .A2(net24),
    .B1(_0549_),
    .C1(net91),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0024_));
 sky130_fd_sc_hd__xnor2_2 _1160_ (.A(net26),
    .B(_0456_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0550_));
 sky130_fd_sc_hd__nor2_2 _1161_ (.A(net57),
    .B(_0550_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0551_));
 sky130_fd_sc_hd__a211o_2 _1162_ (.A1(\areg[12] ),
    .A2(net57),
    .B1(net20),
    .C1(_0551_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0552_));
 sky130_fd_sc_hd__o211a_2 _1163_ (.A1(net158),
    .A2(net24),
    .B1(_0552_),
    .C1(net92),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__a21oi_2 _1164_ (.A1(_0451_),
    .A2(_0456_),
    .B1(_0455_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0553_));
 sky130_fd_sc_hd__xnor2_2 _1165_ (.A(_0459_),
    .B(_0553_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0554_));
 sky130_fd_sc_hd__nor2_2 _1166_ (.A(net57),
    .B(_0554_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0555_));
 sky130_fd_sc_hd__a211o_2 _1167_ (.A1(\areg[13] ),
    .A2(net57),
    .B1(net20),
    .C1(_0555_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0556_));
 sky130_fd_sc_hd__o211a_2 _1168_ (.A1(net145),
    .A2(net24),
    .B1(_0556_),
    .C1(net92),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__and2b_2 _1169_ (.A_N(_0197_),
    .B(_0462_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0557_));
 sky130_fd_sc_hd__xnor2_2 _1170_ (.A(_0461_),
    .B(_0557_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0558_));
 sky130_fd_sc_hd__nor2_2 _1171_ (.A(net57),
    .B(_0558_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0559_));
 sky130_fd_sc_hd__a211o_2 _1172_ (.A1(\areg[14] ),
    .A2(net57),
    .B1(net20),
    .C1(_0559_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0560_));
 sky130_fd_sc_hd__o211a_2 _1173_ (.A1(net151),
    .A2(net24),
    .B1(_0560_),
    .C1(net92),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0027_));
 sky130_fd_sc_hd__nand2b_2 _1174_ (.A_N(_0186_),
    .B(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0561_));
 sky130_fd_sc_hd__a21oi_2 _1175_ (.A1(_0461_),
    .A2(_0462_),
    .B1(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0562_));
 sky130_fd_sc_hd__xnor2_2 _1176_ (.A(_0561_),
    .B(_0562_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0563_));
 sky130_fd_sc_hd__nor2_2 _1177_ (.A(net57),
    .B(_0563_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0564_));
 sky130_fd_sc_hd__a211o_2 _1178_ (.A1(\areg[15] ),
    .A2(net57),
    .B1(net20),
    .C1(_0564_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0565_));
 sky130_fd_sc_hd__o211a_2 _1179_ (.A1(net141),
    .A2(net24),
    .B1(_0565_),
    .C1(net92),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__nor2_1 _1180_ (.A(net79),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0566_));
 sky130_fd_sc_hd__or2_2 _1181_ (.A(_0150_),
    .B(net78),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0567_));
 sky130_fd_sc_hd__nor2_2 _1182_ (.A(net38),
    .B(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0568_));
 sky130_fd_sc_hd__a22o_2 _1183_ (.A1(\wreg[16] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0569_));
 sky130_fd_sc_hd__a21o_2 _1184_ (.A1(_0468_),
    .A2(net44),
    .B1(_0569_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0570_));
 sky130_fd_sc_hd__and2_2 _1185_ (.A(net100),
    .B(_0570_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0029_));
 sky130_fd_sc_hd__a22o_2 _1186_ (.A1(\wreg[17] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0571_));
 sky130_fd_sc_hd__a21o_2 _1187_ (.A1(_0472_),
    .A2(net44),
    .B1(_0571_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0572_));
 sky130_fd_sc_hd__and2_2 _1188_ (.A(net96),
    .B(_0572_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__a22o_2 _1189_ (.A1(\wreg[18] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[2] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0573_));
 sky130_fd_sc_hd__a21o_2 _1190_ (.A1(_0476_),
    .A2(net44),
    .B1(_0573_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0574_));
 sky130_fd_sc_hd__and2_2 _1191_ (.A(net96),
    .B(_0574_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__nor2_2 _1192_ (.A(_0480_),
    .B(_0566_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0575_));
 sky130_fd_sc_hd__a22o_2 _1193_ (.A1(\wreg[19] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0576_));
 sky130_fd_sc_hd__o21a_2 _1194_ (.A1(_0575_),
    .A2(_0576_),
    .B1(net100),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0032_));
 sky130_fd_sc_hd__a22o_2 _1195_ (.A1(\wreg[20] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0577_));
 sky130_fd_sc_hd__a21o_2 _1196_ (.A1(_0483_),
    .A2(net44),
    .B1(_0577_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0578_));
 sky130_fd_sc_hd__and2_2 _1197_ (.A(net100),
    .B(_0578_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0033_));
 sky130_fd_sc_hd__a22o_2 _1198_ (.A1(\wreg[21] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0579_));
 sky130_fd_sc_hd__a21o_2 _1199_ (.A1(_0487_),
    .A2(net44),
    .B1(_0579_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0580_));
 sky130_fd_sc_hd__and2_2 _1200_ (.A(net100),
    .B(_0580_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0034_));
 sky130_fd_sc_hd__a22o_2 _1201_ (.A1(\wreg[22] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0581_));
 sky130_fd_sc_hd__a21o_2 _1202_ (.A1(_0492_),
    .A2(net44),
    .B1(_0581_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0582_));
 sky130_fd_sc_hd__and2_2 _1203_ (.A(net100),
    .B(_0582_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__a22o_2 _1204_ (.A1(\wreg[23] ),
    .A2(net38),
    .B1(net29),
    .B2(\breg[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0583_));
 sky130_fd_sc_hd__a21o_2 _1205_ (.A1(_0496_),
    .A2(net44),
    .B1(_0583_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0584_));
 sky130_fd_sc_hd__and2_2 _1206_ (.A(net95),
    .B(_0584_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__a22o_2 _1207_ (.A1(\breg[0] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[8] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0585_));
 sky130_fd_sc_hd__a21o_2 _1208_ (.A1(_0500_),
    .A2(net43),
    .B1(_0585_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0586_));
 sky130_fd_sc_hd__and2_2 _1209_ (.A(net95),
    .B(_0586_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__a22o_2 _1210_ (.A1(\breg[1] ),
    .A2(net38),
    .B1(_0568_),
    .B2(\breg[9] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0587_));
 sky130_fd_sc_hd__a21o_2 _1211_ (.A1(_0504_),
    .A2(_0567_),
    .B1(_0587_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _1212_ (.A(net94),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__mux2_1 _1213_ (.A0(\breg[2] ),
    .A1(_0508_),
    .S(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0589_));
 sky130_fd_sc_hd__mux2_1 _1214_ (.A0(_0589_),
    .A1(\breg[10] ),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0590_));
 sky130_fd_sc_hd__and2_2 _1215_ (.A(net89),
    .B(_0590_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0039_));
 sky130_fd_sc_hd__a22o_2 _1216_ (.A1(\breg[3] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[11] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0591_));
 sky130_fd_sc_hd__a21o_2 _1217_ (.A1(_0512_),
    .A2(net43),
    .B1(_0591_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0592_));
 sky130_fd_sc_hd__and2_2 _1218_ (.A(net89),
    .B(_0592_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__a22o_2 _1219_ (.A1(\breg[4] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[12] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0593_));
 sky130_fd_sc_hd__a21o_2 _1220_ (.A1(_0518_),
    .A2(net43),
    .B1(_0593_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0594_));
 sky130_fd_sc_hd__and2_2 _1221_ (.A(net89),
    .B(_0594_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0041_));
 sky130_fd_sc_hd__a22o_2 _1222_ (.A1(\breg[5] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[13] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0595_));
 sky130_fd_sc_hd__a21o_2 _1223_ (.A1(_0522_),
    .A2(net43),
    .B1(_0595_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0596_));
 sky130_fd_sc_hd__and2_2 _1224_ (.A(net91),
    .B(_0596_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__and3_2 _1225_ (.A(\breg[6] ),
    .B(net10),
    .C(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0597_));
 sky130_fd_sc_hd__a221o_2 _1226_ (.A1(_0526_),
    .A2(net43),
    .B1(net28),
    .B2(\breg[14] ),
    .C1(_0597_),
    ...
    .VPWR(VPWR),
    .X(_0598_));
 sky130_fd_sc_hd__and2_2 _1227_ (.A(net91),
    .B(_0598_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__a22o_2 _1228_ (.A1(\breg[7] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[15] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0599_));
 sky130_fd_sc_hd__a21o_2 _1229_ (.A1(_0530_),
    .A2(net43),
    .B1(_0599_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0600_));
 sky130_fd_sc_hd__and2_2 _1230_ (.A(net95),
    .B(_0600_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0044_));
 sky130_fd_sc_hd__a22o_2 _1231_ (.A1(\breg[8] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[16] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0601_));
 sky130_fd_sc_hd__a21o_2 _1232_ (.A1(_0534_),
    .A2(net43),
    .B1(_0601_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0602_));
 sky130_fd_sc_hd__and2_2 _1233_ (.A(net90),
    .B(_0602_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0045_));
 sky130_fd_sc_hd__a22o_2 _1234_ (.A1(\breg[9] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[17] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0603_));
 sky130_fd_sc_hd__a21o_2 _1235_ (.A1(_0538_),
    .A2(net43),
    .B1(_0603_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0604_));
 sky130_fd_sc_hd__and2_2 _1236_ (.A(net94),
    .B(_0604_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0046_));
 sky130_fd_sc_hd__a22o_2 _1237_ (.A1(\breg[10] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[18] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0605_));
 sky130_fd_sc_hd__a21o_2 _1238_ (.A1(_0543_),
    .A2(net43),
    .B1(_0605_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0606_));
 sky130_fd_sc_hd__and2_2 _1239_ (.A(net89),
    .B(_0606_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0047_));
 sky130_fd_sc_hd__a22o_2 _1240_ (.A1(\breg[11] ),
    .A2(net37),
    .B1(net27),
    .B2(\breg[19] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0607_));
 sky130_fd_sc_hd__a21o_2 _1241_ (.A1(_0547_),
    .A2(net44),
    .B1(_0607_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0608_));
 sky130_fd_sc_hd__and2_2 _1242_ (.A(net90),
    .B(_0608_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0048_));
 sky130_fd_sc_hd__nor2_2 _1243_ (.A(_0550_),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0609_));
 sky130_fd_sc_hd__a22o_2 _1244_ (.A1(\breg[12] ),
    .A2(net37),
    .B1(net28),
    .B2(\breg[20] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0610_));
 sky130_fd_sc_hd__o21a_2 _1245_ (.A1(_0609_),
    .A2(_0610_),
    .B1(net91),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__nor2_2 _1246_ (.A(_0554_),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0611_));
 sky130_fd_sc_hd__a22o_2 _1247_ (.A1(\breg[13] ),
    .A2(net39),
    .B1(net28),
    .B2(\breg[21] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0612_));
 sky130_fd_sc_hd__o21a_2 _1248_ (.A1(_0611_),
    .A2(_0612_),
    .B1(net91),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__nor2_2 _1249_ (.A(_0558_),
    .B(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0613_));
 sky130_fd_sc_hd__a22o_2 _1250_ (.A1(\breg[14] ),
    .A2(net39),
    .B1(net28),
    .B2(\breg[22] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0614_));
 sky130_fd_sc_hd__o21a_2 _1251_ (.A1(_0613_),
    .A2(_0614_),
    .B1(net91),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0051_));
 sky130_fd_sc_hd__nor2_2 _1252_ (.A(_0563_),
    .B(_0566_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0615_));
 sky130_fd_sc_hd__a22o_2 _1253_ (.A1(\breg[15] ),
    .A2(net39),
    .B1(net28),
    .B2(\breg[23] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0616_));
 sky130_fd_sc_hd__o21a_2 _1254_ (.A1(_0615_),
    .A2(_0616_),
    .B1(net97),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__o221a_2 _1255_ (.A1(\wreg[1] ),
    .A2(net60),
    .B1(net35),
    .B2(net2),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0617_));
 sky130_fd_sc_hd__o21a_2 _1256_ (.A1(net157),
    .A2(net32),
    .B1(_0617_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0053_));
 sky130_fd_sc_hd__o221a_2 _1257_ (.A1(\wreg[2] ),
    .A2(net60),
    .B1(net35),
    .B2(net3),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0618_));
 sky130_fd_sc_hd__o21a_2 _1258_ (.A1(net133),
    .A2(net32),
    .B1(_0618_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0054_));
 sky130_fd_sc_hd__o221a_2 _1259_ (.A1(\wreg[3] ),
    .A2(net60),
    .B1(net35),
    .B2(net4),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0619_));
 sky130_fd_sc_hd__o21a_2 _1260_ (.A1(net125),
    .A2(net32),
    .B1(_0619_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0055_));
 sky130_fd_sc_hd__o221a_2 _1261_ (.A1(\wreg[4] ),
    .A2(net60),
    .B1(net35),
    .B2(net5),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0620_));
 sky130_fd_sc_hd__o21a_2 _1262_ (.A1(net117),
    .A2(net32),
    .B1(_0620_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0056_));
 sky130_fd_sc_hd__o221a_2 _1263_ (.A1(\wreg[5] ),
    .A2(net60),
    .B1(net34),
    .B2(net6),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0621_));
 sky130_fd_sc_hd__o21a_2 _1264_ (.A1(net121),
    .A2(net31),
    .B1(_0621_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0057_));
 sky130_fd_sc_hd__o221a_2 _1265_ (.A1(\wreg[6] ),
    .A2(net62),
    .B1(net34),
    .B2(net7),
    .C1(net97),
    ...
    .VPWR(VPWR),
    .X(_0622_));
 sky130_fd_sc_hd__o21a_2 _1266_ (.A1(net134),
    .A2(net31),
    .B1(_0622_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__o221a_2 _1267_ (.A1(\wreg[7] ),
    .A2(net62),
    .B1(net34),
    .B2(net8),
    .C1(net97),
    ...
    .VPWR(VPWR),
    .X(_0623_));
 sky130_fd_sc_hd__o21a_2 _1268_ (.A1(net126),
    .A2(net31),
    .B1(_0623_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__o221a_2 _1269_ (.A1(\wreg[8] ),
    .A2(net62),
    .B1(net34),
    .B2(net9),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0624_));
 sky130_fd_sc_hd__o21a_2 _1270_ (.A1(net129),
    .A2(net31),
    .B1(_0624_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__o221a_2 _1271_ (.A1(\wreg[9] ),
    .A2(net60),
    .B1(net35),
    .B2(abit),
    .C1(net99),
    ...
    .VPWR(VPWR),
    .X(_0625_));
 sky130_fd_sc_hd__o21a_2 _1272_ (.A1(net131),
    .A2(net31),
    .B1(_0625_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__o221a_2 _1273_ (.A1(\wreg[10] ),
    .A2(net60),
    .B1(net36),
    .B2(\wreg[1] ),
    .C1(net99),
    ...
    .VPWR(VPWR),
    .X(_0626_));
 sky130_fd_sc_hd__o21a_2 _1274_ (.A1(net122),
    .A2(net32),
    .B1(_0626_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__o221a_2 _1275_ (.A1(\wreg[11] ),
    .A2(net61),
    .B1(net36),
    .B2(\wreg[2] ),
    .C1(net99),
    ...
    .VPWR(VPWR),
    .X(_0627_));
 sky130_fd_sc_hd__o21a_2 _1276_ (.A1(net127),
    .A2(net33),
    .B1(_0627_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__o221a_2 _1277_ (.A1(\wreg[12] ),
    .A2(net61),
    .B1(net36),
    .B2(\wreg[3] ),
    .C1(net99),
    ...
    .VPWR(VPWR),
    .X(_0628_));
 sky130_fd_sc_hd__o21a_2 _1278_ (.A1(net128),
    .A2(net33),
    .B1(_0628_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__o221a_2 _1279_ (.A1(\wreg[13] ),
    .A2(net60),
    .B1(net34),
    .B2(\wreg[4] ),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0629_));
 sky130_fd_sc_hd__o21a_2 _1280_ (.A1(net120),
    .A2(net33),
    .B1(_0629_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__o221a_2 _1281_ (.A1(\wreg[14] ),
    .A2(net62),
    .B1(net34),
    .B2(\wreg[5] ),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0630_));
 sky130_fd_sc_hd__o21a_2 _1282_ (.A1(net116),
    .A2(net31),
    .B1(_0630_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0066_));
 sky130_fd_sc_hd__o221a_2 _1283_ (.A1(\wreg[15] ),
    .A2(net62),
    .B1(net34),
    .B2(\wreg[6] ),
    .C1(net97),
    ...
    .VPWR(VPWR),
    .X(_0631_));
 sky130_fd_sc_hd__o21a_2 _1284_ (.A1(net124),
    .A2(net31),
    .B1(_0631_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0067_));
 sky130_fd_sc_hd__o221a_2 _1285_ (.A1(\wreg[16] ),
    .A2(net62),
    .B1(net36),
    .B2(\wreg[7] ),
    .C1(net101),
    ...
    .VPWR(VPWR),
    .X(_0632_));
 sky130_fd_sc_hd__o21a_2 _1286_ (.A1(net123),
    .A2(net33),
    .B1(_0632_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0068_));
 sky130_fd_sc_hd__o221a_2 _1287_ (.A1(\wreg[17] ),
    .A2(net60),
    .B1(net34),
    .B2(\wreg[8] ),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0633_));
 sky130_fd_sc_hd__o21a_2 _1288_ (.A1(net132),
    .A2(net31),
    .B1(_0633_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__o221a_2 _1289_ (.A1(\wreg[18] ),
    .A2(net61),
    .B1(net35),
    .B2(\wreg[9] ),
    .C1(net99),
    ...
    .VPWR(VPWR),
    .X(_0634_));
 sky130_fd_sc_hd__o21a_2 _1290_ (.A1(net136),
    .A2(net32),
    .B1(_0634_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__o221a_2 _1291_ (.A1(\wreg[19] ),
    .A2(net61),
    .B1(net35),
    .B2(\wreg[10] ),
    .C1(net100),
    ...
    .VPWR(VPWR),
    .X(_0635_));
 sky130_fd_sc_hd__o21a_2 _1292_ (.A1(net135),
    .A2(net32),
    .B1(_0635_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0071_));
 sky130_fd_sc_hd__o221a_2 _1293_ (.A1(\wreg[20] ),
    .A2(net61),
    .B1(net35),
    .B2(\wreg[11] ),
    .C1(net100),
    ...
    .VPWR(VPWR),
    .X(_0636_));
 sky130_fd_sc_hd__o21a_2 _1294_ (.A1(net115),
    .A2(net32),
    .B1(_0636_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__o221a_2 _1295_ (.A1(\wreg[21] ),
    .A2(net61),
    .B1(net35),
    .B2(\wreg[12] ),
    .C1(net99),
    ...
    .VPWR(VPWR),
    .X(_0637_));
 sky130_fd_sc_hd__o21a_2 _1296_ (.A1(net119),
    .A2(net32),
    .B1(_0637_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__o221a_2 _1297_ (.A1(\wreg[22] ),
    .A2(net61),
    .B1(net34),
    .B2(\wreg[13] ),
    .C1(net98),
    ...
    .VPWR(VPWR),
    .X(_0638_));
 sky130_fd_sc_hd__o21a_2 _1298_ (.A1(net130),
    .A2(net32),
    .B1(_0638_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0074_));
 sky130_fd_sc_hd__o221a_2 _1299_ (.A1(\wreg[23] ),
    .A2(net62),
    .B1(net34),
    .B2(\wreg[14] ),
    .C1(net101),
    ...
    .VPWR(VPWR),
    .X(_0639_));
 sky130_fd_sc_hd__o21a_2 _1300_ (.A1(net118),
    .A2(net31),
    .B1(_0639_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__a22o_2 _1301_ (.A1(\wreg[15] ),
    .A2(net39),
    .B1(_0144_),
    .B2(\wreg[23] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0640_));
 sky130_fd_sc_hd__and2_2 _1302_ (.A(net101),
    .B(_0640_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__nand2_2 _1303_ (.A(net63),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0641_));
 sky130_fd_sc_hd__and3_2 _1304_ (.A(_0120_),
    .B(net84),
    .C(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0642_));
 sky130_fd_sc_hd__or3b_2 _1305_ (.A(net81),
    .B(net86),
    .C_N(net84),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0643_));
 sky130_fd_sc_hd__nand2_2 _1306_ (.A(net25),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0644_));
 sky130_fd_sc_hd__a21oi_2 _1307_ (.A1(_0465_),
    .A2(net40),
    .B1(_0641_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0645_));
 sky130_fd_sc_hd__a21o_2 _1308_ (.A1(_0465_),
    .A2(net40),
    .B1(_0641_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0646_));
 sky130_fd_sc_hd__a221o_2 _1309_ (.A1(net66),
    .A2(_0472_),
    .B1(net41),
    .B2(_0468_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0647_));
 sky130_fd_sc_hd__o211a_2 _1310_ (.A1(\sreg[0] ),
    .A2(net14),
    .B1(_0647_),
    .C1(net100),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0077_));
 sky130_fd_sc_hd__a221o_2 _1311_ (.A1(net65),
    .A2(_0476_),
    .B1(net41),
    .B2(_0472_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0648_));
 sky130_fd_sc_hd__o211a_2 _1312_ (.A1(net166),
    .A2(net14),
    .B1(_0648_),
    .C1(net96),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0078_));
 sky130_fd_sc_hd__a221o_2 _1313_ (.A1(net65),
    .A2(_0479_),
    .B1(net41),
    .B2(_0476_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0649_));
 sky130_fd_sc_hd__o211a_2 _1314_ (.A1(net172),
    .A2(net14),
    .B1(_0649_),
    .C1(net96),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0079_));
 sky130_fd_sc_hd__a221o_2 _1315_ (.A1(net65),
    .A2(_0483_),
    .B1(net41),
    .B2(_0479_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0650_));
 sky130_fd_sc_hd__o211a_2 _1316_ (.A1(net169),
    .A2(net14),
    .B1(_0650_),
    .C1(net96),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__a221o_2 _1317_ (.A1(net65),
    .A2(_0487_),
    .B1(net41),
    .B2(_0483_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0651_));
 sky130_fd_sc_hd__o211a_2 _1318_ (.A1(net171),
    .A2(net15),
    .B1(_0651_),
    .C1(net96),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0081_));
 sky130_fd_sc_hd__a221o_2 _1319_ (.A1(net65),
    .A2(_0492_),
    .B1(net42),
    .B2(_0487_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0652_));
 sky130_fd_sc_hd__o211a_2 _1320_ (.A1(net163),
    .A2(net15),
    .B1(_0652_),
    .C1(net96),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0082_));
 sky130_fd_sc_hd__a221o_2 _1321_ (.A1(net65),
    .A2(_0496_),
    .B1(net42),
    .B2(_0492_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0653_));
 sky130_fd_sc_hd__o211a_2 _1322_ (.A1(net165),
    .A2(net15),
    .B1(_0653_),
    .C1(net96),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0083_));
 sky130_fd_sc_hd__a221o_2 _1323_ (.A1(net65),
    .A2(_0500_),
    .B1(net42),
    .B2(_0496_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0654_));
 sky130_fd_sc_hd__o211a_2 _1324_ (.A1(net175),
    .A2(net15),
    .B1(_0654_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__a221o_2 _1325_ (.A1(net65),
    .A2(_0504_),
    .B1(net42),
    .B2(_0500_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0655_));
 sky130_fd_sc_hd__o211a_2 _1326_ (.A1(net150),
    .A2(net15),
    .B1(_0655_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__a221o_2 _1327_ (.A1(net65),
    .A2(_0508_),
    .B1(net42),
    .B2(_0504_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0656_));
 sky130_fd_sc_hd__o211a_2 _1328_ (.A1(net173),
    .A2(net15),
    .B1(_0656_),
    .C1(net94),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0086_));
 sky130_fd_sc_hd__a221o_2 _1329_ (.A1(net64),
    .A2(_0512_),
    .B1(net40),
    .B2(_0508_),
    .C1(net16),
    ...
    .VPWR(VPWR),
    .X(_0657_));
 sky130_fd_sc_hd__o211a_2 _1330_ (.A1(net154),
    .A2(net14),
    .B1(_0657_),
    .C1(net89),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0087_));
 sky130_fd_sc_hd__a221o_2 _1331_ (.A1(net64),
    .A2(_0518_),
    .B1(net40),
    .B2(_0512_),
    .C1(net16),
    ...
    .VPWR(VPWR),
    .X(_0658_));
 sky130_fd_sc_hd__o211a_2 _1332_ (.A1(net155),
    .A2(net14),
    .B1(_0658_),
    .C1(net90),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__a221o_2 _1333_ (.A1(net64),
    .A2(_0522_),
    .B1(net40),
    .B2(_0518_),
    .C1(net16),
    ...
    .VPWR(VPWR),
    .X(_0659_));
 sky130_fd_sc_hd__o211a_2 _1334_ (.A1(net149),
    .A2(net14),
    .B1(_0659_),
    .C1(net90),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0089_));
 sky130_fd_sc_hd__a221o_2 _1335_ (.A1(net64),
    .A2(_0526_),
    .B1(net41),
    .B2(_0522_),
    .C1(net16),
    ...
    .VPWR(VPWR),
    .X(_0660_));
 sky130_fd_sc_hd__o211a_2 _1336_ (.A1(net153),
    .A2(net14),
    .B1(_0660_),
    .C1(net93),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__a22o_2 _1337_ (.A1(net64),
    .A2(_0530_),
    .B1(net41),
    .B2(_0526_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0661_));
 sky130_fd_sc_hd__a21o_2 _1338_ (.A1(_0465_),
    .A2(net41),
    .B1(net64),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0662_));
 sky130_fd_sc_hd__a22o_2 _1339_ (.A1(\sreg[14] ),
    .A2(net16),
    .B1(_0661_),
    .B2(_0662_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0663_));
 sky130_fd_sc_hd__and2_2 _1340_ (.A(net93),
    .B(_0663_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__a22o_2 _1341_ (.A1(net64),
    .A2(_0534_),
    .B1(net40),
    .B2(_0530_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0664_));
 sky130_fd_sc_hd__a22o_2 _1342_ (.A1(\sreg[15] ),
    .A2(net16),
    .B1(_0662_),
    .B2(_0664_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0665_));
 sky130_fd_sc_hd__and2_2 _1343_ (.A(net90),
    .B(_0665_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0092_));
 sky130_fd_sc_hd__a221o_2 _1344_ (.A1(net64),
    .A2(_0538_),
    .B1(net40),
    .B2(_0534_),
    .C1(net16),
    ...
    .VPWR(VPWR),
    .X(_0666_));
 sky130_fd_sc_hd__o211a_2 _1345_ (.A1(net162),
    .A2(net14),
    .B1(_0666_),
    .C1(net90),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__a221o_2 _1346_ (.A1(net64),
    .A2(_0543_),
    .B1(net40),
    .B2(_0538_),
    .C1(net16),
    ...
    .VPWR(VPWR),
    .X(_0667_));
 sky130_fd_sc_hd__o211a_2 _1347_ (.A1(net168),
    .A2(net14),
    .B1(_0667_),
    .C1(net90),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__a22o_2 _1348_ (.A1(net64),
    .A2(_0547_),
    .B1(net40),
    .B2(_0543_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0668_));
 sky130_fd_sc_hd__a22o_2 _1349_ (.A1(\sreg[18] ),
    .A2(net16),
    .B1(_0662_),
    .B2(_0668_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0669_));
 sky130_fd_sc_hd__and2_2 _1350_ (.A(net90),
    .B(_0669_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__a2bb2o_2 _1351_ (.A1_N(net63),
    .A2_N(_0550_),
    .B1(net41),
    .B2(_0547_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0670_));
 sky130_fd_sc_hd__a22o_2 _1352_ (.A1(\sreg[19] ),
    .A2(net16),
    .B1(_0662_),
    .B2(_0670_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0671_));
 sky130_fd_sc_hd__and2_2 _1353_ (.A(net93),
    .B(_0671_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0096_));
 sky130_fd_sc_hd__o22ai_2 _1354_ (.A1(net63),
    .A2(_0554_),
    .B1(_0643_),
    .B2(_0550_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0672_));
 sky130_fd_sc_hd__a22o_2 _1355_ (.A1(\sreg[20] ),
    .A2(net18),
    .B1(_0662_),
    .B2(_0672_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _1356_ (.A(net93),
    ...
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__and2_2 _1357_ (.A(\sreg[21] ),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0674_));
 sky130_fd_sc_hd__o22a_2 _1358_ (.A1(net63),
    .A2(_0558_),
    .B1(_0643_),
    .B2(_0554_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0675_));
 sky130_fd_sc_hd__a21oi_2 _1359_ (.A1(net63),
    .A2(_0644_),
    .B1(_0675_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0676_));
 sky130_fd_sc_hd__o21a_2 _1360_ (.A1(_0674_),
    .A2(_0676_),
    .B1(net92),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__o22ai_2 _1361_ (.A1(net63),
    .A2(_0563_),
    .B1(_0643_),
    .B2(_0558_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0677_));
 sky130_fd_sc_hd__a22o_2 _1362_ (.A1(\sreg[22] ),
    .A2(net18),
    .B1(_0662_),
    .B2(_0677_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0678_));
 sky130_fd_sc_hd__and2_2 _1363_ (.A(net93),
    .B(_0678_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__and2_2 _1364_ (.A(net66),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0679_));
 sky130_fd_sc_hd__a2bb2o_2 _1365_ (.A1_N(_0563_),
    .A2_N(_0644_),
    .B1(net18),
    .B2(\sreg[23] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0680_));
 sky130_fd_sc_hd__o21a_2 _1366_ (.A1(_0679_),
    .A2(_0680_),
    .B1(net92),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0100_));
 sky130_fd_sc_hd__nand2_2 _1367_ (.A(\cnt[0] ),
    .B(_0641_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0681_));
 sky130_fd_sc_hd__o211a_2 _1368_ (.A1(net178),
    .A2(net66),
    .B1(_0681_),
    .C1(net93),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0101_));
 sky130_fd_sc_hd__nor2_2 _1369_ (.A(_0107_),
    .B(_0681_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0682_));
 sky130_fd_sc_hd__nand2_2 _1370_ (.A(net93),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0683_));
 sky130_fd_sc_hd__a211oi_2 _1371_ (.A1(_0107_),
    .A2(_0681_),
    .B1(_0682_),
    .C1(_0683_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0102_));
 sky130_fd_sc_hd__and3_2 _1372_ (.A(\cnt[2] ),
    .B(\cnt[1] ),
    .C(\cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0684_));
 sky130_fd_sc_hd__a21oi_2 _1373_ (.A1(net66),
    .A2(_0684_),
    .B1(_0683_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0685_));
 sky130_fd_sc_hd__o21a_2 _1374_ (.A1(net140),
    .A2(_0682_),
    .B1(_0685_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0103_));
 sky130_fd_sc_hd__and3_2 _1375_ (.A(net93),
    .B(net66),
    .C(_0684_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0686_));
 sky130_fd_sc_hd__mux2_1 _1376_ (.A0(_0686_),
    .A1(_0685_),
    .S(net161),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0104_));
 sky130_fd_sc_hd__a31o_2 _1377_ (.A1(\cnt[3] ),
    .A2(_0641_),
    .A3(_0684_),
    .B1(\cnt[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0687_));
 sky130_fd_sc_hd__a41o_2 _1378_ (.A1(\cnt[4] ),
    .A2(\cnt[3] ),
    .A3(_0641_),
    .A4(_0684_),
    .B1(_0683_),
    ...
    .VPWR(VPWR),
    .X(_0688_));
 sky130_fd_sc_hd__and2b_2 _1379_ (.A_N(_0688_),
    .B(_0687_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0105_));
 sky130_fd_sc_hd__nand2_2 _1380_ (.A(net79),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0689_));
 sky130_fd_sc_hd__o211a_2 _1381_ (.A1(net137),
    .A2(net79),
    .B1(_0689_),
    .C1(net97),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__dfxtp_2 _1382_ (.CLK(clknet_4_13_0_clk),
    .D(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\state[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1383_ (.CLK(clknet_4_13_0_clk),
    .D(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\state[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1384_ (.CLK(clknet_4_7_0_clk),
    .D(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\state[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1385_ (.CLK(clknet_4_5_0_clk),
    .D(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\scheme[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1386_ (.CLK(clknet_4_5_0_clk),
    .D(_0004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\scheme[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1387_ (.CLK(clknet_4_3_0_clk),
    .D(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1388_ (.CLK(clknet_4_8_0_clk),
    .D(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1389_ (.CLK(clknet_4_9_0_clk),
    .D(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1390_ (.CLK(clknet_4_2_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\areg[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1391_ (.CLK(clknet_4_3_0_clk),
    .D(_0009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1392_ (.CLK(clknet_4_3_0_clk),
    .D(_0010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1393_ (.CLK(clknet_4_6_0_clk),
    .D(_0011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1394_ (.CLK(clknet_4_10_0_clk),
    .D(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1395_ (.CLK(clknet_4_8_0_clk),
    .D(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1396_ (.CLK(clknet_4_9_0_clk),
    .D(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1397_ (.CLK(clknet_4_0_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\areg[10] ));
 sky130_fd_sc_hd__dfxtp_2 _1398_ (.CLK(clknet_4_1_0_clk),
    .D(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[11] ));
 sky130_fd_sc_hd__dfxtp_2 _1399_ (.CLK(clknet_4_1_0_clk),
    .D(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1400_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\areg[13] ));
 sky130_fd_sc_hd__dfxtp_2 _1401_ (.CLK(clknet_4_4_0_clk),
    .D(_0019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1402_ (.CLK(clknet_4_2_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\areg[15] ));
 sky130_fd_sc_hd__dfxtp_2 _1403_ (.CLK(clknet_4_2_0_clk),
    .D(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[16] ));
 sky130_fd_sc_hd__dfxtp_2 _1404_ (.CLK(clknet_4_8_0_clk),
    .D(_0022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1405_ (.CLK(clknet_4_0_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\areg[18] ));
 sky130_fd_sc_hd__dfxtp_2 _1406_ (.CLK(clknet_4_3_0_clk),
    .D(_0024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1407_ (.CLK(clknet_4_7_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\areg[20] ));
 sky130_fd_sc_hd__dfxtp_2 _1408_ (.CLK(clknet_4_7_0_clk),
    .D(_0026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[21] ));
 sky130_fd_sc_hd__dfxtp_2 _1409_ (.CLK(clknet_4_7_0_clk),
    .D(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\areg[22] ));
 sky130_fd_sc_hd__dfxtp_2 _1410_ (.CLK(clknet_4_7_0_clk),
    .D(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1411_ (.CLK(clknet_4_11_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\breg[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1412_ (.CLK(clknet_4_11_0_clk),
    .D(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1413_ (.CLK(clknet_4_10_0_clk),
    .D(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1414_ (.CLK(clknet_4_11_0_clk),
    .D(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1415_ (.CLK(clknet_4_11_0_clk),
    .D(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1416_ (.CLK(clknet_4_14_0_clk),
    .D(_0034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1417_ (.CLK(clknet_4_11_0_clk),
    .D(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1418_ (.CLK(clknet_4_10_0_clk),
    .D(_0036_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1419_ (.CLK(clknet_4_8_0_clk),
    .D(_0037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1420_ (.CLK(clknet_4_9_0_clk),
    .D(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1421_ (.CLK(clknet_4_2_0_clk),
    .D(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[10] ));
 sky130_fd_sc_hd__dfxtp_2 _1422_ (.CLK(clknet_4_1_0_clk),
    .D(_0040_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[11] ));
 sky130_fd_sc_hd__dfxtp_2 _1423_ (.CLK(clknet_4_1_0_clk),
    .D(_0041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[12] ));
 sky130_fd_sc_hd__dfxtp_2 _1424_ (.CLK(clknet_4_6_0_clk),
    .D(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[13] ));
 sky130_fd_sc_hd__dfxtp_2 _1425_ (.CLK(clknet_4_6_0_clk),
    .D(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[14] ));
 sky130_fd_sc_hd__dfxtp_2 _1426_ (.CLK(clknet_4_2_0_clk),
    .D(_0044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[15] ));
 sky130_fd_sc_hd__dfxtp_2 _1427_ (.CLK(clknet_4_2_0_clk),
    .D(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[16] ));
 sky130_fd_sc_hd__dfxtp_2 _1428_ (.CLK(clknet_4_8_0_clk),
    .D(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[17] ));
 sky130_fd_sc_hd__dfxtp_2 _1429_ (.CLK(clknet_4_1_0_clk),
    .D(_0047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\breg[18] ));
 sky130_fd_sc_hd__dfxtp_2 _1430_ (.CLK(clknet_4_2_0_clk),
    .D(_0048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1432_ (.CLK(clknet_4_6_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\breg[21] ));
 sky130_fd_sc_hd__dfxtp_2 _1433_ (.CLK(clknet_4_6_0_clk),
    .D(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1434_ (.CLK(clknet_4_3_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\breg[23] ));
 sky130_fd_sc_hd__dfxtp_2 _1435_ (.CLK(clknet_4_15_0_clk),
    .D(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(abit));
 sky130_fd_sc_hd__dfxtp_2 _1436_ (.CLK(clknet_4_15_0_clk),
    .D(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1437_ (.CLK(clknet_4_14_0_clk),
    .D(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1438_ (.CLK(clknet_4_15_0_clk),
    .D(_0056_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1439_ (.CLK(clknet_4_15_0_clk),
    .D(_0057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1440_ (.CLK(clknet_4_13_0_clk),
    .D(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1441_ (.CLK(clknet_4_12_0_clk),
    .D(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1443_ (.CLK(clknet_4_12_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\wreg[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1444_ (.CLK(clknet_4_14_0_clk),
    .D(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1445_ (.CLK(clknet_4_15_0_clk),
    .D(_0063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[10] ));
 sky130_fd_sc_hd__dfxtp_2 _1446_ (.CLK(clknet_4_15_0_clk),
    .D(_0064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1448_ (.CLK(clknet_4_12_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\wreg[13] ));
 sky130_fd_sc_hd__dfxtp_2 _1449_ (.CLK(clknet_4_12_0_clk),
    .D(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[14] ));
 sky130_fd_sc_hd__dfxtp_2 _1450_ (.CLK(clknet_4_13_0_clk),
    .D(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[15] ));
 sky130_fd_sc_hd__dfxtp_2 _1451_ (.CLK(clknet_4_12_0_clk),
    .D(_0069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[16] ));
 sky130_fd_sc_hd__dfxtp_2 _1452_ (.CLK(clknet_4_14_0_clk),
    .D(_0070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[17] ));
 sky130_fd_sc_hd__dfxtp_2 _1453_ (.CLK(clknet_4_14_0_clk),
    .D(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1455_ (.CLK(clknet_4_14_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\wreg[20] ));
 sky130_fd_sc_hd__dfxtp_2 _1456_ (.CLK(clknet_4_12_0_clk),
    .D(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[21] ));
 sky130_fd_sc_hd__dfxtp_2 _1457_ (.CLK(clknet_4_11_0_clk),
    .D(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[22] ));
 sky130_fd_sc_hd__dfxtp_2 _1458_ (.CLK(clknet_4_13_0_clk),
    .D(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\wreg[23] ));
 sky130_fd_sc_hd__dfxtp_2 _1459_ (.CLK(clknet_4_10_0_clk),
    .D(_0077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1460_ (.CLK(clknet_4_10_0_clk),
    .D(_0078_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__dfxtp_2 _1461_ (.CLK(clknet_4_9_0_clk),
    ...
    .VPWR(VPWR),
    .Q(\sreg[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1462_ (.CLK(clknet_4_10_0_clk),
    .D(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1463_ (.CLK(clknet_4_10_0_clk),
    .D(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1464_ (.CLK(clknet_4_9_0_clk),
    .D(_0082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[5] ));
 sky130_fd_sc_hd__dfxtp_2 _1465_ (.CLK(clknet_4_9_0_clk),
    .D(_0083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[6] ));
 sky130_fd_sc_hd__dfxtp_2 _1466_ (.CLK(clknet_4_9_0_clk),
    .D(_0084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[7] ));
 sky130_fd_sc_hd__dfxtp_2 _1467_ (.CLK(clknet_4_8_0_clk),
    .D(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[8] ));
 sky130_fd_sc_hd__dfxtp_2 _1468_ (.CLK(clknet_4_8_0_clk),
    .D(_0086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[9] ));
 sky130_fd_sc_hd__dfxtp_2 _1469_ (.CLK(clknet_4_0_0_clk),
    .D(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[10] ));
 sky130_fd_sc_hd__dfxtp_2 _1470_ (.CLK(clknet_4_1_0_clk),
    .D(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[11] ));
 sky130_fd_sc_hd__dfxtp_2 _1471_ (.CLK(clknet_4_1_0_clk),
    .D(_0089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[12] ));
 sky130_fd_sc_hd__dfxtp_2 _1472_ (.CLK(clknet_4_4_0_clk),
    .D(_0090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[13] ));
 sky130_fd_sc_hd__dfxtp_2 _1473_ (.CLK(clknet_4_4_0_clk),
    .D(_0091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[14] ));
 sky130_fd_sc_hd__dfxtp_2 _1474_ (.CLK(clknet_4_0_0_clk),
    .D(_0092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[15] ));
 sky130_fd_sc_hd__dfxtp_2 _1475_ (.CLK(clknet_4_0_0_clk),
    .D(_0093_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[16] ));
 sky130_fd_sc_hd__dfxtp_2 _1476_ (.CLK(clknet_4_0_0_clk),
    .D(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[17] ));
 sky130_fd_sc_hd__dfxtp_2 _1477_ (.CLK(clknet_4_0_0_clk),
    .D(_0095_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[18] ));
 sky130_fd_sc_hd__dfxtp_2 _1478_ (.CLK(clknet_4_4_0_clk),
    .D(_0096_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[19] ));
 sky130_fd_sc_hd__dfxtp_2 _1479_ (.CLK(clknet_4_4_0_clk),
    .D(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[20] ));
 sky130_fd_sc_hd__dfxtp_2 _1480_ (.CLK(clknet_4_4_0_clk),
    .D(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[21] ));
 sky130_fd_sc_hd__dfxtp_2 _1481_ (.CLK(clknet_4_4_0_clk),
    .D(_0099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[22] ));
 sky130_fd_sc_hd__dfxtp_2 _1482_ (.CLK(clknet_4_7_0_clk),
    .D(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\sreg[23] ));
 sky130_fd_sc_hd__dfxtp_2 _1483_ (.CLK(clknet_4_5_0_clk),
    .D(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cnt[0] ));
 sky130_fd_sc_hd__dfxtp_2 _1484_ (.CLK(clknet_4_5_0_clk),
    .D(net160),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cnt[1] ));
 sky130_fd_sc_hd__dfxtp_2 _1485_ (.CLK(clknet_4_5_0_clk),
    .D(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cnt[2] ));
 sky130_fd_sc_hd__dfxtp_2 _1486_ (.CLK(clknet_4_5_0_clk),
    .D(_0104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cnt[3] ));
 sky130_fd_sc_hd__dfxtp_2 _1487_ (.CLK(clknet_4_5_0_clk),
    .D(_0105_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cnt[4] ));
 sky130_fd_sc_hd__dfxtp_2 _1488_ (.CLK(clknet_4_6_0_clk),
    .D(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(borrow));
 sky130_fd_sc_hd__buf_2 _1503_ (.A(busy),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__buf_2 _1504_ (.A(\areg[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _1505_ (.A(\areg[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _1506_ (.A(\areg[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _1507_ (.A(\areg[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _1508_ (.A(\areg[20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _1509_ (.A(\areg[21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__buf_2 _1510_ (.A(\areg[22] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _1511_ (.A(\areg[23] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_4_3_0_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload1 (.A(clknet_4_7_0_clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload2 (.A(clknet_4_11_0_clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload3 (.A(clknet_4_13_0_clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkbuf_4 clkload4 (.A(clknet_4_15_0_clk),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout101 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(_0646_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(_0646_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(net18),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(_0645_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net21),
    ...
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(_0467_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(net24),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(net29),
    ...
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(_0568_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(net36),
    ...
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout36 (.A(_0142_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(net39),
    ...
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout40 (.A(net41),
    ...
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout41 (.A(_0642_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout42 (.A(_0642_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout43 (.A(net44),
    ...
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout44 (.A(_0567_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout47 (.A(net50),
    ...
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout49 (.A(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout51 (.A(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout53 (.A(net54),
    ...
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout54 (.A(_0156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout55 (.A(net56),
    ...
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout56 (.A(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout58 (.A(_0153_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout62 (.A(net63),
    ...
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout63 (.A(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout65 (.A(net66),
    ...
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout66 (.A(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout68 (.A(net69),
    ...
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout69 (.A(_0163_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout71 (.A(net73),
    ...
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout73 (.A(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout77 (.A(net78),
    ...
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout78 (.A(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout79 (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout80 (.A(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout81 (.A(net82),
    ...
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout82 (.A(\state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout84 (.A(net85),
    ...
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout85 (.A(\state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout86 (.A(net87),
    ...
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout87 (.A(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout88 (.A(\state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout92 (.A(net93),
    ...
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout93 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout96 (.A(net1),
    ...
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout97 (.A(net101),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout99 (.A(net100),
    ...
    .VPWR(VPWR),
    .X(net99));
 sky130_fd_sc_hd__dlygate4sd3_1 hold115 (.A(\wreg[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net115));
 sky130_fd_sc_hd__dlygate4sd3_1 hold116 (.A(\wreg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlygate4sd3_1 hold117 (.A(\wreg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net117));
 sky130_fd_sc_hd__dlygate4sd3_1 hold118 (.A(\wreg[22] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net118));
 sky130_fd_sc_hd__dlygate4sd3_1 hold119 (.A(\wreg[20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net119));
 sky130_fd_sc_hd__dlygate4sd3_1 hold120 (.A(\wreg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net120));
 sky130_fd_sc_hd__dlygate4sd3_1 hold121 (.A(\wreg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net121));
 sky130_fd_sc_hd__dlygate4sd3_1 hold122 (.A(\wreg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net122));
 sky130_fd_sc_hd__dlygate4sd3_1 hold123 (.A(\wreg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net123));
 sky130_fd_sc_hd__dlygate4sd3_1 hold124 (.A(\wreg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__dlygate4sd3_1 hold125 (.A(\wreg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net125));
 sky130_fd_sc_hd__dlygate4sd3_1 hold126 (.A(\wreg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net126));
 sky130_fd_sc_hd__dlygate4sd3_1 hold127 (.A(\wreg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net127));
 sky130_fd_sc_hd__dlygate4sd3_1 hold128 (.A(\wreg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net128));
 sky130_fd_sc_hd__dlygate4sd3_1 hold129 (.A(\wreg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net129));
 sky130_fd_sc_hd__dlygate4sd3_1 hold130 (.A(\wreg[21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__dlygate4sd3_1 hold131 (.A(\wreg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net131));
 sky130_fd_sc_hd__dlygate4sd3_1 hold132 (.A(\wreg[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net132));
 sky130_fd_sc_hd__dlygate4sd3_1 hold133 (.A(\wreg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net133));
 sky130_fd_sc_hd__dlygate4sd3_1 hold134 (.A(\wreg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net134));
 sky130_fd_sc_hd__dlygate4sd3_1 hold135 (.A(\wreg[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net135));
 sky130_fd_sc_hd__dlygate4sd3_1 hold136 (.A(\wreg[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net136));
 sky130_fd_sc_hd__dlygate4sd3_1 hold137 (.A(borrow),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net137));
 sky130_fd_sc_hd__dlygate4sd3_1 hold138 (.A(\areg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net138));
 sky130_fd_sc_hd__dlygate4sd3_1 hold139 (.A(\areg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net139));
 sky130_fd_sc_hd__dlygate4sd3_1 hold140 (.A(\cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net140));
 sky130_fd_sc_hd__dlygate4sd3_1 hold141 (.A(\areg[23] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net141));
 sky130_fd_sc_hd__dlygate4sd3_1 hold142 (.A(\areg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net142));
 sky130_fd_sc_hd__dlygate4sd3_1 hold143 (.A(\areg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net143));
 sky130_fd_sc_hd__dlygate4sd3_1 hold144 (.A(\areg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net144));
 sky130_fd_sc_hd__dlygate4sd3_1 hold145 (.A(\areg[21] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net145));
 sky130_fd_sc_hd__dlygate4sd3_1 hold146 (.A(\areg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net146));
 sky130_fd_sc_hd__dlygate4sd3_1 hold147 (.A(\areg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net147));
 sky130_fd_sc_hd__dlygate4sd3_1 hold148 (.A(\areg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net148));
 sky130_fd_sc_hd__dlygate4sd3_1 hold149 (.A(\sreg[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net149));
 sky130_fd_sc_hd__dlygate4sd3_1 hold150 (.A(\sreg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net150));
 sky130_fd_sc_hd__dlygate4sd3_1 hold151 (.A(\areg[22] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net151));
 sky130_fd_sc_hd__dlygate4sd3_1 hold152 (.A(\areg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net152));
 sky130_fd_sc_hd__dlygate4sd3_1 hold153 (.A(\sreg[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net153));
 sky130_fd_sc_hd__dlygate4sd3_1 hold154 (.A(\sreg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net154));
 sky130_fd_sc_hd__dlygate4sd3_1 hold155 (.A(\sreg[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net155));
 sky130_fd_sc_hd__dlygate4sd3_1 hold156 (.A(\areg[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net156));
 sky130_fd_sc_hd__dlygate4sd3_1 hold157 (.A(abit),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net157));
 sky130_fd_sc_hd__dlygate4sd3_1 hold158 (.A(\areg[20] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net158));
 sky130_fd_sc_hd__dlygate4sd3_1 hold159 (.A(\cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net159));
 sky130_fd_sc_hd__dlygate4sd3_1 hold160 (.A(_0102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net160));
 sky130_fd_sc_hd__dlygate4sd3_1 hold161 (.A(\cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net161));
 sky130_fd_sc_hd__dlygate4sd3_1 hold162 (.A(\sreg[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net162));
 sky130_fd_sc_hd__dlygate4sd3_1 hold163 (.A(\sreg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net163));
 sky130_fd_sc_hd__dlygate4sd3_1 hold164 (.A(\areg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net164));
 sky130_fd_sc_hd__dlygate4sd3_1 hold165 (.A(\sreg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net165));
 sky130_fd_sc_hd__dlygate4sd3_1 hold166 (.A(\sreg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net166));
 sky130_fd_sc_hd__dlygate4sd3_1 hold167 (.A(\areg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net167));
 sky130_fd_sc_hd__dlygate4sd3_1 hold168 (.A(\sreg[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net168));
 sky130_fd_sc_hd__dlygate4sd3_1 hold169 (.A(\sreg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net169));
 sky130_fd_sc_hd__dlygate4sd3_1 hold170 (.A(\areg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net170));
 sky130_fd_sc_hd__dlygate4sd3_1 hold171 (.A(\sreg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net171));
 sky130_fd_sc_hd__dlygate4sd3_1 hold172 (.A(\sreg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net172));
 sky130_fd_sc_hd__dlygate4sd3_1 hold173 (.A(\sreg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net173));
 sky130_fd_sc_hd__dlygate4sd3_1 hold174 (.A(\areg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net174));
 sky130_fd_sc_hd__dlygate4sd3_1 hold175 (.A(\sreg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net175));
 sky130_fd_sc_hd__dlygate4sd3_1 hold176 (.A(\areg[18] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net176));
 sky130_fd_sc_hd__dlygate4sd3_1 hold177 (.A(\areg[19] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net177));
 sky130_fd_sc_hd__dlygate4sd3_1 hold178 (.A(\cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net178));
 sky130_fd_sc_hd__dlygate4sd3_1 hold179 (.A(\areg[16] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net179));
 sky130_fd_sc_hd__dlygate4sd3_1 hold180 (.A(\areg[17] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net180));
 sky130_fd_sc_hd__dlygate4sd3_1 hold181 (.A(\areg[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net181));
 sky130_fd_sc_hd__dlygate4sd3_1 hold182 (.A(\areg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 load_slew50 (.A(net49),
    ...
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__buf_2 load_slew75 (.A(net73),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__clkbuf_2 max_cap25 (.A(_0465_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__buf_1 max_cap26 (.A(_0451_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkbuf_2 max_cap45 (.A(_0566_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__clkbuf_2 max_cap59 (.A(_0152_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__buf_6 max_cap70 (.A(_0162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_102 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net102));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_103 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net103));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_104 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net104));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_105 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net105));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_106 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net106));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_107 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net107));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_108 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net108));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_109 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net109));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_110 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net110));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_111 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net111));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_112 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net112));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_113 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net113));
 sky130_fd_sc_hd__conb_1 tt_um_pqc_ntt_bfly_114 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net114));
 sky130_fd_sc_hd__clkbuf_4 wire57 (.A(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 wire72 (.A(net71),
    ...
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__clkbuf_4 wire74 (.A(net75),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),

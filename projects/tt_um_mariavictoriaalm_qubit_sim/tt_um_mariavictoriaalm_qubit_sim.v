module tt_um_mariavictoriaalm_qubit_sim (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _045_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_013_));
 sky130_fd_sc_hd__inv_2 _046_ (.A(\c00_thresh[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_014_));
 sky130_fd_sc_hd__inv_2 _047_ (.A(\c00_thresh[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__inv_2 _048_ (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__inv_2 _049_ (.A(\q2_thresh[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__inv_2 _050_ (.A(net58),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__inv_2 _051_ (.A(\q1_thresh[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__xor2_2 _052_ (.A(\lfsr1[5] ),
    .B(\lfsr1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__xnor2_2 _053_ (.A(\lfsr1[7] ),
    .B(\lfsr1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__xnor2_2 _054_ (.A(_020_),
    .B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_000_));
 sky130_fd_sc_hd__xor2_2 _055_ (.A(\lfsr2[5] ),
    .B(\lfsr2[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__xnor2_2 _056_ (.A(\lfsr2[7] ),
    .B(\lfsr2[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__xnor2_2 _057_ (.A(_022_),
    .B(_023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_001_));
 sky130_fd_sc_hd__xor2_2 _058_ (.A(\lfsr3[5] ),
    .B(\lfsr3[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__xnor2_2 _059_ (.A(\lfsr3[7] ),
    .B(\lfsr3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_025_));
 sky130_fd_sc_hd__xnor2_2 _060_ (.A(_024_),
    .B(_025_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__and2b_2 _061_ (.A_N(net4),
    .B(init_done),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__or3_2 _062_ (.A(init_done),
    .B(net2),
    .C(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__a21bo_2 _063_ (.A1(net54),
    .A2(_026_),
    .B1_N(_027_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__o21ai_2 _064_ (.A1(net4),
    .A2(net55),
    .B1(init_done),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__nand2_2 _065_ (.A(_027_),
    .B(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__and4_2 _066_ (.A(\lfsr3[5] ),
    .B(\lfsr3[4] ),
    .C(\lfsr3[3] ),
    .D(\lfsr3[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__and3_2 _067_ (.A(\lfsr3[2] ),
    .B(\lfsr3[1] ),
    .C(\lfsr3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__a221o_2 _068_ (.A1(\lfsr3[7] ),
    .A2(_014_),
    .B1(_029_),
    .B2(_030_),
    .C1(_015_),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__o211a_2 _069_ (.A1(\lfsr3[7] ),
    .A2(_014_),
    .B1(_026_),
    .C1(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__o21a_2 _070_ (.A1(net4),
    .A2(_013_),
    .B1(init_done),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__and2b_2 _071_ (.A_N(init_done),
    .B(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a221o_2 _072_ (.A1(_031_),
    .A2(_032_),
    .B1(_033_),
    .B2(uo_out[2]),
    .C1(_034_),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__and2b_2 _073_ (.A_N(init_done),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__a221o_2 _074_ (.A1(_031_),
    .A2(_032_),
    .B1(_033_),
    .B2(uo_out[3]),
    .C1(_035_),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a2bb2o_2 _075_ (.A1_N(init_done),
    .A2_N(net3),
    .B1(net61),
    .B2(_026_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__a21oi_2 _076_ (.A1(_016_),
    .A2(_026_),
    .B1(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__and4_2 _077_ (.A(\lfsr2[5] ),
    .B(\lfsr2[4] ),
    .C(\lfsr2[3] ),
    .D(\lfsr2[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__and3_2 _078_ (.A(\lfsr2[2] ),
    .B(\lfsr2[1] ),
    .C(\lfsr2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__a221o_2 _079_ (.A1(\lfsr2[7] ),
    .A2(_016_),
    .B1(_036_),
    .B2(_037_),
    .C1(_017_),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__o211a_2 _080_ (.A1(\lfsr2[7] ),
    .A2(_016_),
    .B1(_026_),
    .C1(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__a221o_2 _081_ (.A1(net53),
    .A2(_033_),
    .B1(_038_),
    .B2(_039_),
    .C1(_035_),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a2bb2o_2 _082_ (.A1_N(init_done),
    .A2_N(net2),
    .B1(net60),
    .B2(_026_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__a21oi_2 _083_ (.A1(_018_),
    .A2(_026_),
    .B1(_034_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__and4_2 _084_ (.A(\lfsr1[5] ),
    .B(\lfsr1[4] ),
    .C(\lfsr1[3] ),
    .D(\lfsr1[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__and3_2 _085_ (.A(\lfsr1[2] ),
    .B(\lfsr1[1] ),
    .C(\lfsr1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__a221o_2 _086_ (.A1(\lfsr1[7] ),
    .A2(_018_),
    .B1(_040_),
    .B2(_041_),
    .C1(_019_),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__o211a_2 _087_ (.A1(\lfsr1[7] ),
    .A2(_018_),
    .B1(_026_),
    .C1(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__a221o_2 _088_ (.A1(net57),
    .A2(_033_),
    .B1(_042_),
    .B2(_043_),
    .C1(_034_),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__dfrtp_2 _089_ (.CLK(clknet_2_1__leaf_clk),
    .D(_003_),
    .RESET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c00_thresh[0] ));
 sky130_fd_sc_hd__dfrtp_2 _090_ (.CLK(clknet_2_3__leaf_clk),
    .D(_004_),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c00_thresh[7] ));
 sky130_fd_sc_hd__dfrtp_2 _091_ (.CLK(clknet_2_1__leaf_clk),
    .D(_005_),
    .RESET_B(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _092_ (.CLK(clknet_2_1__leaf_clk),
    .D(_006_),
    .RESET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfrtp_2 _093_ (.CLK(clknet_2_3__leaf_clk),
    .D(_007_),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\q2_thresh[0] ));
 sky130_fd_sc_hd__dfrtp_2 _094_ (.CLK(clknet_2_0__leaf_clk),
    .D(_008_),
    .RESET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\q2_thresh[7] ));
 sky130_fd_sc_hd__dfrtp_2 _095_ (.CLK(clknet_2_0__leaf_clk),
    .D(_009_),
    .RESET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(q2_measured));
 sky130_fd_sc_hd__dfrtp_2 _096_ (.CLK(clknet_2_3__leaf_clk),
    .D(_010_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _098_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(q1_measured));
 sky130_fd_sc_hd__dfstp_2 _099_ (.CLK(clknet_2_2__leaf_clk),
    .D(_000_),
    .SET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[0] ));
 sky130_fd_sc_hd__dfstp_2 _100_ (.CLK(clknet_2_2__leaf_clk),
    .D(net34),
    .SET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[1] ));
 sky130_fd_sc_hd__dfrtp_2 _101_ (.CLK(clknet_2_3__leaf_clk),
    .D(net41),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[2] ));
 sky130_fd_sc_hd__dfstp_2 _102_ (.CLK(clknet_2_2__leaf_clk),
    .D(net40),
    .SET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[3] ));
 sky130_fd_sc_hd__dfstp_2 _103_ (.CLK(clknet_2_3__leaf_clk),
    .D(net42),
    .SET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[4] ));
 sky130_fd_sc_hd__dfstp_2 _104_ (.CLK(clknet_2_2__leaf_clk),
    .D(net45),
    .SET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[5] ));
 sky130_fd_sc_hd__dfrtp_2 _105_ (.CLK(clknet_2_2__leaf_clk),
    .D(net50),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[6] ));
 sky130_fd_sc_hd__dfrtp_2 _106_ (.CLK(clknet_2_2__leaf_clk),
    .D(net35),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr1[7] ));
 sky130_fd_sc_hd__dfstp_2 _107_ (.CLK(clknet_2_0__leaf_clk),
    .D(_001_),
    .SET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[0] ));
 sky130_fd_sc_hd__dfrtp_2 _108_ (.CLK(clknet_2_2__leaf_clk),
    .D(net46),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[1] ));
 sky130_fd_sc_hd__dfrtp_2 _109_ (.CLK(clknet_2_2__leaf_clk),
    .D(net37),
    .RESET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[2] ));
 sky130_fd_sc_hd__dfstp_2 _110_ (.CLK(clknet_2_2__leaf_clk),
    .D(net39),
    .SET_B(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[3] ));
 sky130_fd_sc_hd__dfrtp_2 _111_ (.CLK(clknet_2_0__leaf_clk),
    .D(net52),
    .RESET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[4] ));
 sky130_fd_sc_hd__dfrtp_2 _112_ (.CLK(clknet_2_0__leaf_clk),
    .D(net47),
    .RESET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[5] ));
 sky130_fd_sc_hd__dfstp_2 _113_ (.CLK(clknet_2_0__leaf_clk),
    .D(net49),
    .SET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[6] ));
 sky130_fd_sc_hd__dfstp_2 _114_ (.CLK(clknet_2_0__leaf_clk),
    .D(net33),
    .SET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr2[7] ));
 sky130_fd_sc_hd__dfstp_2 _115_ (.CLK(clknet_2_1__leaf_clk),
    .D(_002_),
    .SET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[0] ));
 sky130_fd_sc_hd__dfstp_2 _116_ (.CLK(clknet_2_0__leaf_clk),
    .D(net38),
    .SET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[1] ));
 sky130_fd_sc_hd__dfstp_2 _117_ (.CLK(clknet_2_0__leaf_clk),
    .D(net36),
    .SET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[2] ));
 sky130_fd_sc_hd__dfstp_2 _118_ (.CLK(clknet_2_1__leaf_clk),
    .D(net32),
    .SET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[3] ));
 sky130_fd_sc_hd__dfrtp_2 _119_ (.CLK(clknet_2_1__leaf_clk),
    .D(net51),
    .RESET_B(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[4] ));
 sky130_fd_sc_hd__dfstp_2 _120_ (.CLK(clknet_2_1__leaf_clk),
    .D(net48),
    .SET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[5] ));
 sky130_fd_sc_hd__dfstp_2 _121_ (.CLK(clknet_2_1__leaf_clk),
    .D(net44),
    .SET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[6] ));
 sky130_fd_sc_hd__dfrtp_2 _122_ (.CLK(clknet_2_1__leaf_clk),
    .D(net43),
    .RESET_B(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lfsr3[7] ));
 sky130_fd_sc_hd__dfrtp_2 _123_ (.CLK(clknet_2_3__leaf_clk),
    .D(net31),
    .RESET_B(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(init_done));
 sky130_fd_sc_hd__conb_1 _123__31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net31));
 sky130_fd_sc_hd__buf_2 _145_ (.A(q1_measured),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _146_ (.A(q2_measured),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout6 (.A(net8),
    ...
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold32 (.A(\lfsr3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(\lfsr2[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(\lfsr1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__dlygate4sd3_1 hold35 (.A(\lfsr1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd3_1 hold36 (.A(\lfsr3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd3_1 hold37 (.A(\lfsr2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__dlygate4sd3_1 hold38 (.A(\lfsr3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\lfsr2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\lfsr1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\lfsr1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\lfsr1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\lfsr3[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(\lfsr3[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\lfsr1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\lfsr2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\lfsr2[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\lfsr3[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\lfsr2[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\lfsr1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\lfsr3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\lfsr2[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(q2_measured),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\c00_thresh[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\c00_thresh[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(q1_measured),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\q1_thresh[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\q2_thresh[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\q1_thresh[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\q2_thresh[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input5 (.A(ui_in[3]),
    ...
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__buf_2 load_slew10 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew7 (.A(net6),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_12 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net12));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net13));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net14));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_15 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net15));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_16 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net16));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_17 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net17));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_18 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net18));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_19 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net19));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_20 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net20));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_22 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_mariavictoriaalm_qubit_sim_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));

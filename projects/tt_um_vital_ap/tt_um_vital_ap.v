module tt_um_vital_ap (clk,
 ...
 sky130_fd_sc_hd__fill_1 FILLER_16_126 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_16_146 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_35_6 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_35_62 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _0525_ (.A(transition_d4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0511_));
 sky130_fd_sc_hd__inv_2 _0526_ (.A(\pixel_d1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0512_));
 sky130_fd_sc_hd__inv_2 _0527_ (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0513_));
 sky130_fd_sc_hd__inv_2 _0528_ (.A(\pixel_d1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0514_));
 sky130_fd_sc_hd__inv_2 _0529_ (.A(\pixel_d2[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0515_));
 sky130_fd_sc_hd__inv_2 _0530_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0516_));
 sky130_fd_sc_hd__inv_2 _0531_ (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0517_));
 sky130_fd_sc_hd__inv_2 _0532_ (.A(\pixel_d4[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0518_));
 sky130_fd_sc_hd__inv_2 _0533_ (.A(\pixel_d4[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0519_));
 sky130_fd_sc_hd__inv_2 _0534_ (.A(\pixel_d4[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0520_));
 sky130_fd_sc_hd__inv_2 _0535_ (.A(\pixel_d4[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0536_ (.A(net13),
    ...
    .VPWR(VPWR),
    .Y(_0522_));
 sky130_fd_sc_hd__and2_2 _0537_ (.A(transition_d2),
    .B(transition_d1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0523_));
 sky130_fd_sc_hd__xnor2_2 _0538_ (.A(transition_d2),
    .B(transition_d1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0524_));
 sky130_fd_sc_hd__o21bai_2 _0539_ (.A1(_0511_),
    .A2(_0524_),
    .B1_N(_0523_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0012_));
 sky130_fd_sc_hd__xnor2_2 _0540_ (.A(transition_d4),
    .B(_0524_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0013_));
 sky130_fd_sc_hd__a21o_2 _0541_ (.A1(transition_d3),
    .A2(_0013_),
    .B1(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uio_out[6]));
 sky130_fd_sc_hd__nor2_2 _0542_ (.A(transition_d3),
    .B(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0014_));
 sky130_fd_sc_hd__or2_2 _0543_ (.A(transition_d3),
    .B(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__and3b_2 _0544_ (.A_N(_0523_),
    .B(_0013_),
    .C(transition_d3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__nor2_2 _0545_ (.A(_0014_),
    .B(_0016_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net26));
 sky130_fd_sc_hd__and2b_2 _0546_ (.A_N(\pixel_d1[5] ),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__nand2b_2 _0547_ (.A_N(net29),
    .B(\pixel_d1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0018_));
 sky130_fd_sc_hd__and2b_2 _0548_ (.A_N(_0017_),
    .B(_0018_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__or2_2 _0549_ (.A(_0513_),
    .B(\pixel_d1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__inv_2 _0550_ (.A(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0021_));
 sky130_fd_sc_hd__and2b_2 _0551_ (.A_N(\pixel_d1[4] ),
    .B(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0022_));
 sky130_fd_sc_hd__and2b_2 _0552_ (.A_N(net7),
    .B(\pixel_d1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0023_));
 sky130_fd_sc_hd__nor2_2 _0553_ (.A(_0022_),
    .B(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0024_));
 sky130_fd_sc_hd__and2_2 _0554_ (.A(_0019_),
    .B(_0024_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0025_));
 sky130_fd_sc_hd__and2b_2 _0555_ (.A_N(net6),
    .B(\pixel_d1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0026_));
 sky130_fd_sc_hd__nand2b_2 _0556_ (.A_N(net6),
    .B(\pixel_d1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0027_));
 sky130_fd_sc_hd__and2b_2 _0557_ (.A_N(\pixel_d1[3] ),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0028_));
 sky130_fd_sc_hd__nand2_2 _0558_ (.A(net5),
    .B(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0029_));
 sky130_fd_sc_hd__or2_2 _0559_ (.A(net5),
    .B(_0514_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0030_));
 sky130_fd_sc_hd__and2b_2 _0560_ (.A_N(\pixel_d1[1] ),
    .B(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0031_));
 sky130_fd_sc_hd__nand2b_4 _0561_ (.A_N(net4),
    .B(\pixel_d1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0032_));
 sky130_fd_sc_hd__nand2b_4 _0562_ (.A_N(net3),
    .B(\pixel_d1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0033_));
 sky130_fd_sc_hd__a21oi_2 _0563_ (.A1(_0032_),
    .A2(_0033_),
    .B1(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0034_));
 sky130_fd_sc_hd__a221o_2 _0564_ (.A1(net5),
    .A2(_0514_),
    .B1(_0032_),
    .B2(_0033_),
    .C1(_0031_),
    ...
    .VPWR(VPWR),
    .X(_0035_));
 sky130_fd_sc_hd__nand2_2 _0565_ (.A(_0030_),
    .B(_0035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0036_));
 sky130_fd_sc_hd__a31o_4 _0566_ (.A1(_0027_),
    .A2(_0030_),
    .A3(_0035_),
    .B1(_0028_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__a21o_2 _0567_ (.A1(_0018_),
    .A2(_0022_),
    .B1(_0017_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0038_));
 sky130_fd_sc_hd__a21oi_2 _0568_ (.A1(_0025_),
    .A2(_0037_),
    .B1(_0038_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0039_));
 sky130_fd_sc_hd__a211o_2 _0569_ (.A1(_0025_),
    .A2(_0037_),
    .B1(_0038_),
    .C1(_0021_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0040_));
 sky130_fd_sc_hd__nand2_2 _0570_ (.A(_0513_),
    .B(\pixel_d1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0041_));
 sky130_fd_sc_hd__or2_2 _0571_ (.A(_0512_),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0042_));
 sky130_fd_sc_hd__and2_2 _0572_ (.A(_0041_),
    .B(_0042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__nand2_2 _0573_ (.A(_0040_),
    .B(_0043_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0044_));
 sky130_fd_sc_hd__nand2_2 _0574_ (.A(_0512_),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0045_));
 sky130_fd_sc_hd__a21boi_4 _0575_ (.A1(_0043_),
    .A2(_0040_),
    .B1_N(_0045_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0046_));
 sky130_fd_sc_hd__o21bai_2 _0576_ (.A1(_0022_),
    .A2(_0037_),
    .B1_N(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0047_));
 sky130_fd_sc_hd__nand2_2 _0577_ (.A(_0029_),
    .B(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0048_));
 sky130_fd_sc_hd__and2b_2 _0578_ (.A_N(net52),
    .B(_0032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0049_));
 sky130_fd_sc_hd__and2b_2 _0579_ (.A_N(\pixel_d1[0] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0050_));
 sky130_fd_sc_hd__nand2b_2 _0580_ (.A_N(\pixel_d1[0] ),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0051_));
 sky130_fd_sc_hd__a31o_2 _0581_ (.A1(_0032_),
    .A2(_0033_),
    .A3(_0050_),
    .B1(net52),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0052_));
 sky130_fd_sc_hd__o31ai_1 _0582_ (.A1(_0028_),
    .A2(_0048_),
    .A3(_0052_),
    .B1(_0037_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0053_));
 sky130_fd_sc_hd__a21oi_2 _0583_ (.A1(_0024_),
    .A2(net25),
    .B1(_0023_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0054_));
 sky130_fd_sc_hd__mux2_4 _0584_ (.A0(_0047_),
    .A1(_0054_),
    .S(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0055_));
 sky130_fd_sc_hd__nand2_2 _0585_ (.A(_0019_),
    .B(_0055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0056_));
 sky130_fd_sc_hd__a21oi_2 _0586_ (.A1(_0025_),
    .A2(net24),
    .B1(_0039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0057_));
 sky130_fd_sc_hd__mux2_4 _0587_ (.A0(_0039_),
    .A1(_0057_),
    .S(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0058_));
 sky130_fd_sc_hd__and3_2 _0588_ (.A(_0020_),
    .B(_0041_),
    .C(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0059_));
 sky130_fd_sc_hd__a21o_2 _0589_ (.A1(_0020_),
    .A2(_0041_),
    .B1(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0060_));
 sky130_fd_sc_hd__a211o_2 _0590_ (.A1(_0041_),
    .A2(_0057_),
    .B1(_0512_),
    .C1(_0021_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0061_));
 sky130_fd_sc_hd__a22o_2 _0591_ (.A1(_0042_),
    .A2(_0045_),
    .B1(_0061_),
    .B2(_0044_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0062_));
 sky130_fd_sc_hd__o21a_2 _0592_ (.A1(_0019_),
    .A2(_0055_),
    .B1(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0063_));
 sky130_fd_sc_hd__and4b_2 _0593_ (.A_N(_0059_),
    .B(_0063_),
    .C(_0060_),
    .D(_0056_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0064_));
 sky130_fd_sc_hd__mux2_4 _0594_ (.A0(_0037_),
    .A1(_0053_),
    .S(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0065_));
 sky130_fd_sc_hd__xnor2_4 _0595_ (.A(_0024_),
    .B(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0596_ (.A(_0066_),
    ...
    .VPWR(VPWR),
    .Y(_0067_));
 sky130_fd_sc_hd__nand2_2 _0597_ (.A(_0064_),
    .B(_0066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(strong_motion));
 sky130_fd_sc_hd__or2_2 _0598_ (.A(\motion_count[2] ),
    .B(\motion_count[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[7]));
 sky130_fd_sc_hd__nor2_2 _0599_ (.A(uio_out[6]),
    .B(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0068_));
 sky130_fd_sc_hd__or2_2 _0600_ (.A(uio_out[6]),
    .B(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0069_));
 sky130_fd_sc_hd__and2b_2 _0601_ (.A_N(net12),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0070_));
 sky130_fd_sc_hd__nor2_2 _0602_ (.A(net40),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__o21a_2 _0603_ (.A1(net40),
    .A2(_0513_),
    .B1(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0072_));
 sky130_fd_sc_hd__o31a_2 _0604_ (.A1(net40),
    .A2(_0513_),
    .A3(_0070_),
    .B1(net15),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0073_));
 sky130_fd_sc_hd__o21ai_2 _0605_ (.A1(net9),
    .A2(_0071_),
    .B1(_0073_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__xor2_4 _0606_ (.A(net11),
    .B(_0074_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0075_));
 sky130_fd_sc_hd__and2_2 _0607_ (.A(_0068_),
    .B(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__nor2_2 _0608_ (.A(uio_out[6]),
    .B(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__or2_2 _0609_ (.A(uio_out[6]),
    .B(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0078_));
 sky130_fd_sc_hd__and2b_2 _0610_ (.A_N(net40),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0079_));
 sky130_fd_sc_hd__xor2_2 _0611_ (.A(net49),
    .B(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__o21a_2 _0612_ (.A1(_0014_),
    .A2(_0016_),
    .B1(uio_out[6]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0081_));
 sky130_fd_sc_hd__nand2_2 _0613_ (.A(_0012_),
    .B(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0082_));
 sky130_fd_sc_hd__and2_2 _0614_ (.A(_0513_),
    .B(_0079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0083_));
 sky130_fd_sc_hd__mux2_1 _0615_ (.A0(_0070_),
    .A1(net9),
    .S(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__o2bb2a_4 _0616_ (.A1_N(_0072_),
    .A2_N(_0084_),
    .B1(_0083_),
    .B2(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0085_));
 sky130_fd_sc_hd__inv_2 _0617_ (.A(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0086_));
 sky130_fd_sc_hd__a21oi_2 _0618_ (.A1(net11),
    .A2(_0083_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0087_));
 sky130_fd_sc_hd__a21o_2 _0619_ (.A1(_0086_),
    .A2(_0087_),
    .B1(_0082_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0088_));
 sky130_fd_sc_hd__a21oi_2 _0620_ (.A1(_0077_),
    .A2(_0080_),
    .B1(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0089_));
 sky130_fd_sc_hd__a21bo_2 _0621_ (.A1(_0088_),
    .A2(_0089_),
    .B1_N(net54),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__or3_2 _0622_ (.A(uio_out[6]),
    .B(_0014_),
    .C(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__nor2_2 _0623_ (.A(net53),
    .B(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0092_));
 sky130_fd_sc_hd__o21a_2 _0624_ (.A1(net54),
    .A2(_0091_),
    .B1(_0069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__a21oi_2 _0625_ (.A1(_0090_),
    .A2(_0093_),
    .B1(_0076_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0094_));
 sky130_fd_sc_hd__or2_2 _0626_ (.A(net16),
    .B(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0095_));
 sky130_fd_sc_hd__nand2_2 _0627_ (.A(_0514_),
    .B(\pixel_d2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0096_));
 sky130_fd_sc_hd__and2b_2 _0628_ (.A_N(\pixel_d2[2] ),
    .B(\pixel_d1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0097_));
 sky130_fd_sc_hd__xor2_2 _0629_ (.A(\pixel_d1[2] ),
    .B(\pixel_d2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__and2b_2 _0630_ (.A_N(\pixel_d2[1] ),
    .B(\pixel_d1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0099_));
 sky130_fd_sc_hd__nand2b_2 _0631_ (.A_N(\pixel_d1[1] ),
    .B(\pixel_d2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0100_));
 sky130_fd_sc_hd__nand2b_2 _0632_ (.A_N(\pixel_d1[0] ),
    .B(\pixel_d2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__a21oi_2 _0633_ (.A1(_0100_),
    .A2(_0101_),
    .B1(_0099_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0102_));
 sky130_fd_sc_hd__nor2_2 _0634_ (.A(_0512_),
    .B(\pixel_d2[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0103_));
 sky130_fd_sc_hd__nand2_2 _0635_ (.A(_0512_),
    .B(\pixel_d2[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0104_));
 sky130_fd_sc_hd__nand2b_2 _0636_ (.A_N(\pixel_d1[6] ),
    .B(\pixel_d2[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0105_));
 sky130_fd_sc_hd__and2b_2 _0637_ (.A_N(\pixel_d2[6] ),
    .B(\pixel_d1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__nand2b_2 _0638_ (.A_N(\pixel_d2[6] ),
    .B(\pixel_d1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__and2b_2 _0639_ (.A_N(\pixel_d2[3] ),
    .B(\pixel_d1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0108_));
 sky130_fd_sc_hd__nand2_2 _0640_ (.A(\pixel_d1[3] ),
    .B(\pixel_d2[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0109_));
 sky130_fd_sc_hd__or2_2 _0641_ (.A(\pixel_d1[3] ),
    .B(\pixel_d2[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__and2_2 _0642_ (.A(_0109_),
    .B(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__nand2_2 _0643_ (.A(_0109_),
    .B(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0112_));
 sky130_fd_sc_hd__a211o_2 _0644_ (.A1(_0100_),
    .A2(_0101_),
    .B1(_0097_),
    .C1(_0099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__nand2_2 _0645_ (.A(_0096_),
    .B(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0114_));
 sky130_fd_sc_hd__a31o_2 _0646_ (.A1(_0096_),
    .A2(_0112_),
    .A3(_0113_),
    .B1(_0108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0115_));
 sky130_fd_sc_hd__and2b_2 _0647_ (.A_N(\pixel_d2[4] ),
    .B(\pixel_d1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0116_));
 sky130_fd_sc_hd__inv_2 _0648_ (.A(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0117_));
 sky130_fd_sc_hd__and2b_2 _0649_ (.A_N(\pixel_d1[4] ),
    .B(\pixel_d2[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__or2_2 _0650_ (.A(_0116_),
    .B(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__nand2_2 _0651_ (.A(\pixel_d1[5] ),
    .B(\pixel_d2[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0120_));
 sky130_fd_sc_hd__or2_2 _0652_ (.A(\pixel_d1[5] ),
    .B(\pixel_d2[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0121_));
 sky130_fd_sc_hd__nand2_2 _0653_ (.A(_0120_),
    .B(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0122_));
 sky130_fd_sc_hd__and2b_2 _0654_ (.A_N(_0119_),
    .B(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0123_));
 sky130_fd_sc_hd__and2b_2 _0655_ (.A_N(\pixel_d2[5] ),
    .B(\pixel_d1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0124_));
 sky130_fd_sc_hd__a21o_2 _0656_ (.A1(_0116_),
    .A2(_0122_),
    .B1(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0125_));
 sky130_fd_sc_hd__a21oi_2 _0657_ (.A1(_0115_),
    .A2(_0123_),
    .B1(_0125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__a211o_2 _0658_ (.A1(_0115_),
    .A2(_0123_),
    .B1(_0125_),
    .C1(_0106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__nand2_2 _0659_ (.A(_0105_),
    .B(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__a31o_2 _0660_ (.A1(_0104_),
    .A2(_0105_),
    .A3(_0127_),
    .B1(_0103_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0129_));
 sky130_fd_sc_hd__and2_2 _0661_ (.A(\pixel_d1[1] ),
    .B(\pixel_d2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0130_));
 sky130_fd_sc_hd__xor2_2 _0662_ (.A(\pixel_d1[1] ),
    .B(\pixel_d2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0131_));
 sky130_fd_sc_hd__and2b_2 _0663_ (.A_N(\pixel_d2[0] ),
    .B(\pixel_d1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0132_));
 sky130_fd_sc_hd__o21a_2 _0664_ (.A1(_0131_),
    .A2(_0132_),
    .B1(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__mux2_1 _0665_ (.A0(_0133_),
    .A1(_0102_),
    .S(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0134_));
 sky130_fd_sc_hd__xor2_2 _0666_ (.A(net28),
    .B(_0134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0135_));
 sky130_fd_sc_hd__xnor2_2 _0667_ (.A(net28),
    .B(_0134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0136_));
 sky130_fd_sc_hd__mux2_4 _0668_ (.A0(_0034_),
    .A1(_0052_),
    .S(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0137_));
 sky130_fd_sc_hd__xor2_2 _0669_ (.A(_0048_),
    .B(_0137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0138_));
 sky130_fd_sc_hd__xnor2_2 _0670_ (.A(_0049_),
    .B(_0050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0139_));
 sky130_fd_sc_hd__nand2_2 _0671_ (.A(_0033_),
    .B(_0051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0140_));
 sky130_fd_sc_hd__nand2b_2 _0672_ (.A_N(_0046_),
    .B(_0140_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0141_));
 sky130_fd_sc_hd__xnor2_2 _0673_ (.A(_0139_),
    .B(_0141_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0142_));
 sky130_fd_sc_hd__and2_2 _0674_ (.A(\pixel_d1[0] ),
    .B(\pixel_d2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0143_));
 sky130_fd_sc_hd__xor2_2 _0675_ (.A(\pixel_d1[0] ),
    .B(\pixel_d2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0144_));
 sky130_fd_sc_hd__xor2_2 _0676_ (.A(_0131_),
    .B(_0132_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0145_));
 sky130_fd_sc_hd__nand2_2 _0677_ (.A(_0129_),
    .B(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0146_));
 sky130_fd_sc_hd__xnor2_2 _0678_ (.A(_0145_),
    .B(_0146_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__o211a_2 _0679_ (.A1(_0142_),
    .A2(_0147_),
    .B1(_0144_),
    .C1(_0140_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0148_));
 sky130_fd_sc_hd__a22o_2 _0680_ (.A1(_0135_),
    .A2(_0138_),
    .B1(_0142_),
    .B2(_0147_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0149_));
 sky130_fd_sc_hd__o31ai_1 _0681_ (.A1(net28),
    .A2(_0111_),
    .A3(_0133_),
    .B1(_0115_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0150_));
 sky130_fd_sc_hd__mux2_1 _0682_ (.A0(_0150_),
    .A1(_0115_),
    .S(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0151_));
 sky130_fd_sc_hd__xor2_2 _0683_ (.A(_0119_),
    .B(_0151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0152_));
 sky130_fd_sc_hd__a21o_2 _0684_ (.A1(_0096_),
    .A2(_0133_),
    .B1(_0097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0153_));
 sky130_fd_sc_hd__mux2_1 _0685_ (.A0(_0153_),
    .A1(_0114_),
    .S(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0154_));
 sky130_fd_sc_hd__xnor2_2 _0686_ (.A(_0111_),
    .B(_0154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__nor2_2 _0687_ (.A(_0026_),
    .B(_0028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0156_));
 sky130_fd_sc_hd__o21a_2 _0688_ (.A1(_0048_),
    .A2(_0052_),
    .B1(_0030_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0157_));
 sky130_fd_sc_hd__mux2_4 _0689_ (.A0(_0036_),
    .A1(_0157_),
    .S(_0046_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0158_));
 sky130_fd_sc_hd__xor2_2 _0690_ (.A(_0156_),
    .B(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0159_));
 sky130_fd_sc_hd__xnor2_2 _0691_ (.A(_0156_),
    .B(net50),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0160_));
 sky130_fd_sc_hd__o211ai_2 _0692_ (.A1(_0155_),
    .A2(_0159_),
    .B1(_0066_),
    .C1(_0152_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0161_));
 sky130_fd_sc_hd__o221ai_2 _0693_ (.A1(_0135_),
    .A2(net48),
    .B1(_0148_),
    .B2(_0149_),
    .C1(_0161_),
    ...
    .VPWR(VPWR),
    .Y(_0162_));
 sky130_fd_sc_hd__a22o_2 _0694_ (.A1(_0066_),
    .A2(_0152_),
    .B1(_0155_),
    .B2(_0159_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0163_));
 sky130_fd_sc_hd__and3_2 _0695_ (.A(_0103_),
    .B(_0105_),
    .C(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0164_));
 sky130_fd_sc_hd__a21oi_2 _0696_ (.A1(_0123_),
    .A2(net22),
    .B1(_0126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0165_));
 sky130_fd_sc_hd__a21oi_2 _0697_ (.A1(_0105_),
    .A2(_0165_),
    .B1(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0166_));
 sky130_fd_sc_hd__nand2_2 _0698_ (.A(\pixel_d1[7] ),
    .B(\pixel_d2[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0167_));
 sky130_fd_sc_hd__or2_2 _0699_ (.A(\pixel_d1[7] ),
    .B(\pixel_d2[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0168_));
 sky130_fd_sc_hd__and2_2 _0700_ (.A(_0167_),
    .B(_0168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0169_));
 sky130_fd_sc_hd__a31o_2 _0701_ (.A1(_0512_),
    .A2(\pixel_d2[7] ),
    .A3(_0166_),
    .B1(_0164_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0170_));
 sky130_fd_sc_hd__o21bai_2 _0702_ (.A1(_0115_),
    .A2(_0116_),
    .B1_N(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0171_));
 sky130_fd_sc_hd__a21oi_2 _0703_ (.A1(_0117_),
    .A2(net23),
    .B1(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0172_));
 sky130_fd_sc_hd__mux2_1 _0704_ (.A0(_0172_),
    .A1(_0171_),
    .S(_0129_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0173_));
 sky130_fd_sc_hd__and2_2 _0705_ (.A(_0122_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _0706_ (.A0(_0165_),
    ...
    .VPWR(VPWR),
    .X(_0175_));
 sky130_fd_sc_hd__nor2_2 _0707_ (.A(_0122_),
    .B(_0173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__xor2_2 _0708_ (.A(_0128_),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__or4_2 _0709_ (.A(_0170_),
    .B(_0174_),
    .C(_0176_),
    .D(_0177_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0178_));
 sky130_fd_sc_hd__o21ba_2 _0710_ (.A1(_0066_),
    .A2(_0152_),
    .B1_N(_0178_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0179_));
 sky130_fd_sc_hd__and4_4 _0711_ (.A(_0064_),
    .B(_0162_),
    .C(_0163_),
    .D(_0179_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__inv_2 _0712_ (.A(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(strong_edge));
 sky130_fd_sc_hd__and2b_2 _0713_ (.A_N(\pixel_d3[2] ),
    .B(\pixel_d2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0181_));
 sky130_fd_sc_hd__inv_2 _0714_ (.A(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0182_));
 sky130_fd_sc_hd__nand2b_2 _0715_ (.A_N(\pixel_d2[2] ),
    .B(\pixel_d3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0183_));
 sky130_fd_sc_hd__nand2b_2 _0716_ (.A_N(_0181_),
    .B(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0184_));
 sky130_fd_sc_hd__and2b_2 _0717_ (.A_N(\pixel_d3[1] ),
    .B(\pixel_d2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0185_));
 sky130_fd_sc_hd__nand2b_2 _0718_ (.A_N(\pixel_d2[1] ),
    .B(\pixel_d3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0186_));
 sky130_fd_sc_hd__nand2b_2 _0719_ (.A_N(\pixel_d2[0] ),
    .B(\pixel_d3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0187_));
 sky130_fd_sc_hd__inv_2 _0720_ (.A(_0187_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0188_));
 sky130_fd_sc_hd__a21oi_2 _0721_ (.A1(_0186_),
    .A2(_0187_),
    .B1(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0189_));
 sky130_fd_sc_hd__and2b_2 _0722_ (.A_N(\pixel_d2[3] ),
    .B(\pixel_d3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0190_));
 sky130_fd_sc_hd__nand2b_2 _0723_ (.A_N(\pixel_d3[3] ),
    .B(\pixel_d2[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0191_));
 sky130_fd_sc_hd__o21a_2 _0724_ (.A1(_0184_),
    .A2(_0189_),
    .B1(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0192_));
 sky130_fd_sc_hd__o211a_2 _0725_ (.A1(_0184_),
    .A2(_0189_),
    .B1(_0191_),
    .C1(_0182_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0193_));
 sky130_fd_sc_hd__or2_2 _0726_ (.A(_0190_),
    .B(_0193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__and2b_2 _0727_ (.A_N(\pixel_d3[5] ),
    .B(\pixel_d2[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0195_));
 sky130_fd_sc_hd__nand2b_2 _0728_ (.A_N(\pixel_d2[5] ),
    .B(\pixel_d3[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0196_));
 sky130_fd_sc_hd__and2b_2 _0729_ (.A_N(_0195_),
    .B(_0196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0197_));
 sky130_fd_sc_hd__and2b_2 _0730_ (.A_N(\pixel_d3[4] ),
    .B(\pixel_d2[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__nand2b_2 _0731_ (.A_N(\pixel_d3[4] ),
    .B(\pixel_d2[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0199_));
 sky130_fd_sc_hd__and2b_2 _0732_ (.A_N(\pixel_d2[4] ),
    .B(\pixel_d3[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0200_));
 sky130_fd_sc_hd__nor2_2 _0733_ (.A(_0198_),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0201_));
 sky130_fd_sc_hd__or2_2 _0734_ (.A(_0198_),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0202_));
 sky130_fd_sc_hd__or4b_2 _0735_ (.A(_0190_),
    .B(_0202_),
    .C(_0193_),
    .D_N(_0197_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0203_));
 sky130_fd_sc_hd__a21oi_2 _0736_ (.A1(_0196_),
    .A2(_0198_),
    .B1(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0204_));
 sky130_fd_sc_hd__xnor2_2 _0737_ (.A(\pixel_d2[7] ),
    .B(\pixel_d3[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0205_));
 sky130_fd_sc_hd__nand2b_2 _0738_ (.A_N(\pixel_d3[6] ),
    .B(\pixel_d2[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0206_));
 sky130_fd_sc_hd__inv_2 _0739_ (.A(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0207_));
 sky130_fd_sc_hd__and2b_2 _0740_ (.A_N(\pixel_d2[6] ),
    .B(\pixel_d3[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0208_));
 sky130_fd_sc_hd__nor2_2 _0741_ (.A(_0207_),
    .B(_0208_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__nand2_2 _0742_ (.A(_0205_),
    .B(_0209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0210_));
 sky130_fd_sc_hd__a21o_2 _0743_ (.A1(_0203_),
    .A2(_0204_),
    .B1(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__o21ai_2 _0744_ (.A1(_0515_),
    .A2(\pixel_d3[7] ),
    .B1(_0206_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0212_));
 sky130_fd_sc_hd__a21bo_2 _0745_ (.A1(_0515_),
    .A2(\pixel_d3[7] ),
    .B1_N(_0212_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0213_));
 sky130_fd_sc_hd__inv_2 _0746_ (.A(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0214_));
 sky130_fd_sc_hd__nand2_2 _0747_ (.A(_0211_),
    .B(_0213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0215_));
 sky130_fd_sc_hd__nand2b_2 _0748_ (.A_N(_0185_),
    .B(_0186_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0216_));
 sky130_fd_sc_hd__and2b_2 _0749_ (.A_N(\pixel_d3[0] ),
    .B(\pixel_d2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0217_));
 sky130_fd_sc_hd__a31o_2 _0750_ (.A1(_0186_),
    .A2(_0187_),
    .A3(_0217_),
    .B1(_0185_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0218_));
 sky130_fd_sc_hd__mux2_1 _0751_ (.A0(_0218_),
    .A1(_0189_),
    .S(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0219_));
 sky130_fd_sc_hd__xnor2_2 _0752_ (.A(_0184_),
    .B(_0219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0220_));
 sky130_fd_sc_hd__o21ai_2 _0753_ (.A1(_0188_),
    .A2(_0217_),
    .B1(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0221_));
 sky130_fd_sc_hd__xor2_2 _0754_ (.A(_0216_),
    .B(_0217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0222_));
 sky130_fd_sc_hd__o2bb2a_2 _0755_ (.A1_N(_0211_),
    .A2_N(_0213_),
    .B1(_0217_),
    .B2(_0188_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0223_));
 sky130_fd_sc_hd__xnor2_2 _0756_ (.A(_0222_),
    .B(_0223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0224_));
 sky130_fd_sc_hd__a21bo_2 _0757_ (.A1(_0221_),
    .A2(_0224_),
    .B1_N(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0225_));
 sky130_fd_sc_hd__o221ai_2 _0758_ (.A1(_0136_),
    .A2(_0220_),
    .B1(_0221_),
    .B2(_0224_),
    .C1(_0225_),
    ...
    .VPWR(VPWR),
    .Y(_0226_));
 sky130_fd_sc_hd__nand2b_2 _0759_ (.A_N(_0190_),
    .B(_0191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0227_));
 sky130_fd_sc_hd__nor2_2 _0760_ (.A(_0184_),
    .B(_0218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0228_));
 sky130_fd_sc_hd__o21a_2 _0761_ (.A1(_0184_),
    .A2(_0218_),
    .B1(_0183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0229_));
 sky130_fd_sc_hd__mux2_1 _0762_ (.A0(_0229_),
    .A1(_0192_),
    .S(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0230_));
 sky130_fd_sc_hd__xnor2_2 _0763_ (.A(_0227_),
    .B(_0230_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0231_));
 sky130_fd_sc_hd__a22oi_2 _0764_ (.A1(_0136_),
    .A2(_0220_),
    .B1(_0231_),
    .B2(_0155_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0232_));
 sky130_fd_sc_hd__o31a_2 _0765_ (.A1(_0190_),
    .A2(_0192_),
    .A3(_0228_),
    .B1(_0191_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0233_));
 sky130_fd_sc_hd__and3_2 _0766_ (.A(_0211_),
    .B(_0213_),
    .C(_0233_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__a21oi_2 _0767_ (.A1(_0211_),
    .A2(_0213_),
    .B1(_0194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0235_));
 sky130_fd_sc_hd__o21ai_2 _0768_ (.A1(_0234_),
    .A2(_0235_),
    .B1(_0202_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0236_));
 sky130_fd_sc_hd__and3_2 _0769_ (.A(_0203_),
    .B(_0204_),
    .C(_0214_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0237_));
 sky130_fd_sc_hd__a32oi_2 _0770_ (.A1(_0197_),
    .A2(_0201_),
    .A3(_0233_),
    .B1(_0204_),
    .B2(_0203_),
    ...
    .VPWR(VPWR),
    .Y(_0238_));
 sky130_fd_sc_hd__a31o_2 _0771_ (.A1(_0211_),
    .A2(_0213_),
    .A3(_0238_),
    .B1(_0237_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0239_));
 sky130_fd_sc_hd__nand2_2 _0772_ (.A(_0209_),
    .B(_0239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0240_));
 sky130_fd_sc_hd__or3_2 _0773_ (.A(_0202_),
    .B(_0234_),
    .C(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0241_));
 sky130_fd_sc_hd__nor2_2 _0774_ (.A(_0194_),
    .B(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0242_));
 sky130_fd_sc_hd__a21o_2 _0775_ (.A1(_0199_),
    .A2(_0233_),
    .B1(_0200_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0243_));
 sky130_fd_sc_hd__or3b_2 _0776_ (.A(_0243_),
    .B(_0214_),
    .C_N(_0211_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0244_));
 sky130_fd_sc_hd__a211o_2 _0777_ (.A1(_0211_),
    .A2(_0213_),
    .B1(_0242_),
    .C1(_0198_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0245_));
 sky130_fd_sc_hd__a21oi_2 _0778_ (.A1(_0244_),
    .A2(_0245_),
    .B1(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0246_));
 sky130_fd_sc_hd__and3_2 _0779_ (.A(_0197_),
    .B(_0244_),
    .C(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0247_));
 sky130_fd_sc_hd__a32o_2 _0780_ (.A1(_0203_),
    .A2(_0204_),
    .A3(_0206_),
    .B1(_0211_),
    .B2(_0213_),
    ...
    .VPWR(VPWR),
    .X(_0248_));
 sky130_fd_sc_hd__and2b_2 _0781_ (.A_N(_0208_),
    .B(_0238_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__o32a_2 _0782_ (.A1(_0207_),
    .A2(_0215_),
    .A3(_0249_),
    .B1(_0248_),
    .B2(_0208_),
    ...
    .VPWR(VPWR),
    .X(_0250_));
 sky130_fd_sc_hd__or2_2 _0783_ (.A(_0209_),
    .B(_0239_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0251_));
 sky130_fd_sc_hd__o211a_2 _0784_ (.A1(_0205_),
    .A2(_0250_),
    .B1(_0241_),
    .C1(_0236_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0252_));
 sky130_fd_sc_hd__o211a_2 _0785_ (.A1(_0246_),
    .A2(_0247_),
    .B1(_0251_),
    .C1(_0240_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0253_));
 sky130_fd_sc_hd__o2111ai_2 _0786_ (.A1(_0155_),
    .A2(_0231_),
    .B1(_0252_),
    .C1(_0253_),
    .D1(_0152_),
    ...
    .VPWR(VPWR),
    .Y(_0254_));
 sky130_fd_sc_hd__a211oi_4 _0787_ (.A1(_0226_),
    .A2(_0232_),
    .B1(_0254_),
    .C1(_0178_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0255_));
 sky130_fd_sc_hd__or2_2 _0788_ (.A(net53),
    .B(_0085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0256_));
 sky130_fd_sc_hd__o21bai_2 _0789_ (.A1(_0075_),
    .A2(_0091_),
    .B1_N(_0081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0257_));
 sky130_fd_sc_hd__or3_2 _0790_ (.A(_0076_),
    .B(_0086_),
    .C(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0258_));
 sky130_fd_sc_hd__o211ai_2 _0791_ (.A1(_0078_),
    .A2(_0092_),
    .B1(_0088_),
    .C1(_0086_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0259_));
 sky130_fd_sc_hd__a2bb2o_4 _0792_ (.A1_N(_0069_),
    .A2_N(_0256_),
    .B1(_0258_),
    .B2(_0259_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0260_));
 sky130_fd_sc_hd__a21oi_2 _0793_ (.A1(net12),
    .A2(net11),
    .B1(_0087_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0261_));
 sky130_fd_sc_hd__or2_2 _0794_ (.A(_0085_),
    .B(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0262_));
 sky130_fd_sc_hd__nand3_2 _0795_ (.A(_0068_),
    .B(_0256_),
    .C(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0263_));
 sky130_fd_sc_hd__nand2_2 _0796_ (.A(_0085_),
    .B(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0264_));
 sky130_fd_sc_hd__o2bb2a_2 _0797_ (.A1_N(net12),
    .A2_N(net11),
    .B1(_0078_),
    .B2(_0264_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0265_));
 sky130_fd_sc_hd__o2bb2a_2 _0798_ (.A1_N(_0263_),
    .A2_N(_0265_),
    .B1(_0082_),
    .B2(_0262_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0266_));
 sky130_fd_sc_hd__inv_2 _0799_ (.A(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0267_));
 sky130_fd_sc_hd__o21ai_2 _0800_ (.A1(_0078_),
    .A2(_0085_),
    .B1(_0261_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__o211a_2 _0801_ (.A1(_0075_),
    .A2(_0080_),
    .B1(_0085_),
    .C1(_0077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0269_));
 sky130_fd_sc_hd__o22a_2 _0802_ (.A1(_0257_),
    .A2(_0268_),
    .B1(_0269_),
    .B2(_0261_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__a21oi_2 _0803_ (.A1(_0262_),
    .A2(_0264_),
    .B1(_0088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0271_));
 sky130_fd_sc_hd__or3_2 _0804_ (.A(_0068_),
    .B(_0270_),
    .C(_0271_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0272_));
 sky130_fd_sc_hd__o311a_4 _0805_ (.A1(_0069_),
    .A2(_0256_),
    .A3(_0261_),
    .B1(_0263_),
    .C1(_0272_),
    ...
    .VPWR(VPWR),
    .X(_0273_));
 sky130_fd_sc_hd__inv_2 _0806_ (.A(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__nor2_2 _0807_ (.A(_0266_),
    .B(_0273_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__a21bo_2 _0808_ (.A1(net26),
    .A2(_0088_),
    .B1_N(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0276_));
 sky130_fd_sc_hd__nand2_2 _0809_ (.A(_0091_),
    .B(_0276_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0277_));
 sky130_fd_sc_hd__and2_2 _0810_ (.A(net21),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0278_));
 sky130_fd_sc_hd__or4_2 _0811_ (.A(_0260_),
    .B(_0266_),
    .C(_0273_),
    .D(_0278_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0279_));
 sky130_fd_sc_hd__o21a_2 _0812_ (.A1(_0255_),
    .A2(_0279_),
    .B1(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0280_));
 sky130_fd_sc_hd__xnor2_2 _0813_ (.A(_0094_),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0281_));
 sky130_fd_sc_hd__a21boi_2 _0814_ (.A1(net21),
    .A2(_0260_),
    .B1_N(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0282_));
 sky130_fd_sc_hd__nor2_2 _0815_ (.A(net21),
    .B(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0283_));
 sky130_fd_sc_hd__o21ba_2 _0816_ (.A1(_0278_),
    .A2(_0283_),
    .B1_N(_0282_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__a221o_2 _0817_ (.A1(_0280_),
    .A2(_0281_),
    .B1(_0284_),
    .B2(strong_edge),
    .C1(_0516_),
    ...
    .VPWR(VPWR),
    .X(_0285_));
 sky130_fd_sc_hd__nand2_2 _0818_ (.A(_0095_),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0286_));
 sky130_fd_sc_hd__or2_2 _0819_ (.A(net16),
    .B(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0287_));
 sky130_fd_sc_hd__or2_2 _0820_ (.A(_0516_),
    .B(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0288_));
 sky130_fd_sc_hd__o21a_2 _0821_ (.A1(net21),
    .A2(_0277_),
    .B1(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__and2b_2 _0822_ (.A_N(_0260_),
    .B(_0283_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0290_));
 sky130_fd_sc_hd__nor3_2 _0823_ (.A(_0275_),
    .B(_0289_),
    .C(_0290_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0291_));
 sky130_fd_sc_hd__o31ai_2 _0824_ (.A1(_0516_),
    .A2(_0180_),
    .A3(_0291_),
    .B1(_0287_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0292_));
 sky130_fd_sc_hd__or4_2 _0825_ (.A(net21),
    .B(net20),
    .C(_0260_),
    .D(_0275_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0293_));
 sky130_fd_sc_hd__and2_2 _0826_ (.A(net16),
    .B(_0180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0294_));
 sky130_fd_sc_hd__o21ai_2 _0827_ (.A1(net21),
    .A2(net20),
    .B1(_0260_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0295_));
 sky130_fd_sc_hd__a31o_2 _0828_ (.A1(_0293_),
    .A2(_0294_),
    .A3(_0295_),
    .B1(_0292_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__nor4_2 _0829_ (.A(_0094_),
    .B(net20),
    .C(_0260_),
    .D(_0273_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0297_));
 sky130_fd_sc_hd__nor4_2 _0830_ (.A(_0516_),
    .B(_0180_),
    .C(_0273_),
    .D(_0289_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0298_));
 sky130_fd_sc_hd__a211o_2 _0831_ (.A1(_0294_),
    .A2(_0297_),
    .B1(_0298_),
    .C1(_0267_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0299_));
 sky130_fd_sc_hd__xor2_2 _0832_ (.A(_0273_),
    .B(_0289_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__o32a_2 _0833_ (.A1(_0282_),
    .A2(_0288_),
    .A3(_0300_),
    .B1(_0274_),
    .B2(net16),
    ...
    .VPWR(VPWR),
    .X(_0301_));
 sky130_fd_sc_hd__o31a_2 _0834_ (.A1(_0094_),
    .A2(net20),
    .A3(_0260_),
    .B1(_0273_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0302_));
 sky130_fd_sc_hd__o211ai_2 _0835_ (.A1(_0297_),
    .A2(_0302_),
    .B1(net16),
    .C1(_0280_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0303_));
 sky130_fd_sc_hd__and2_2 _0836_ (.A(_0301_),
    .B(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__and3_2 _0837_ (.A(_0299_),
    .B(_0301_),
    .C(_0303_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0305_));
 sky130_fd_sc_hd__and4_2 _0838_ (.A(_0296_),
    .B(_0299_),
    .C(_0301_),
    .D(_0303_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__or2_2 _0839_ (.A(\motion_count[0] ),
    .B(\motion_count[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0307_));
 sky130_fd_sc_hd__a21o_2 _0840_ (.A1(\motion_count[2] ),
    .A2(_0307_),
    .B1(\motion_count[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0308_));
 sky130_fd_sc_hd__a21oi_2 _0841_ (.A1(\motion_count[2] ),
    .A2(_0307_),
    .B1(\motion_count[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0309_));
 sky130_fd_sc_hd__a21oi_2 _0842_ (.A1(_0095_),
    .A2(_0285_),
    .B1(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0310_));
 sky130_fd_sc_hd__o21ai_2 _0843_ (.A1(_0516_),
    .A2(_0280_),
    .B1(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0311_));
 sky130_fd_sc_hd__o31a_2 _0844_ (.A1(_0277_),
    .A2(_0282_),
    .A3(_0288_),
    .B1(_0311_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0312_));
 sky130_fd_sc_hd__a311o_2 _0845_ (.A1(_0305_),
    .A2(_0310_),
    .A3(_0312_),
    .B1(_0306_),
    .C1(_0309_),
    ...
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__a21o_2 _0846_ (.A1(\motion_count[0] ),
    .A2(\motion_count[1] ),
    .B1(uio_out[7]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0314_));
 sky130_fd_sc_hd__a31o_2 _0847_ (.A1(net17),
    .A2(_0313_),
    .A3(_0314_),
    .B1(_0286_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0315_));
 sky130_fd_sc_hd__a41o_2 _0848_ (.A1(_0296_),
    .A2(_0299_),
    .A3(_0301_),
    .A4(_0303_),
    .B1(_0308_),
    ...
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__nand2_2 _0849_ (.A(_0286_),
    .B(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0317_));
 sky130_fd_sc_hd__or3_2 _0850_ (.A(_0517_),
    .B(_0316_),
    .C(_0317_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0318_));
 sky130_fd_sc_hd__and2_2 _0851_ (.A(_0315_),
    .B(_0318_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0319_));
 sky130_fd_sc_hd__o21a_2 _0852_ (.A1(_0286_),
    .A2(_0312_),
    .B1(_0306_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0320_));
 sky130_fd_sc_hd__o311a_2 _0853_ (.A1(_0286_),
    .A2(_0308_),
    .A3(_0312_),
    .B1(_0314_),
    .C1(_0316_),
    ...
    .VPWR(VPWR),
    .X(_0321_));
 sky130_fd_sc_hd__a31o_2 _0854_ (.A1(net17),
    .A2(_0313_),
    .A3(_0321_),
    .B1(_0312_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0322_));
 sky130_fd_sc_hd__xnor2_2 _0855_ (.A(\pixel_d3[2] ),
    .B(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__a21oi_2 _0856_ (.A1(\pixel_d3[1] ),
    .A2(_0131_),
    .B1(_0130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0324_));
 sky130_fd_sc_hd__nor2_2 _0857_ (.A(_0323_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0325_));
 sky130_fd_sc_hd__xor2_2 _0858_ (.A(_0323_),
    .B(_0324_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0326_));
 sky130_fd_sc_hd__xnor2_2 _0859_ (.A(\pixel_d4[2] ),
    .B(_0326_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0327_));
 sky130_fd_sc_hd__xnor2_2 _0860_ (.A(\pixel_d3[1] ),
    .B(_0131_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0328_));
 sky130_fd_sc_hd__a21oi_2 _0861_ (.A1(\pixel_d3[0] ),
    .A2(net27),
    .B1(_0143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0329_));
 sky130_fd_sc_hd__or2_2 _0862_ (.A(_0328_),
    .B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0330_));
 sky130_fd_sc_hd__xnor2_2 _0863_ (.A(_0328_),
    .B(_0329_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0331_));
 sky130_fd_sc_hd__o21a_2 _0864_ (.A1(_0518_),
    .A2(_0331_),
    .B1(_0330_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0332_));
 sky130_fd_sc_hd__xnor2_2 _0865_ (.A(_0327_),
    .B(_0332_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0333_));
 sky130_fd_sc_hd__a21boi_2 _0866_ (.A1(\pixel_d3[0] ),
    .A2(net27),
    .B1_N(\pixel_d4[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0334_));
 sky130_fd_sc_hd__xnor2_2 _0867_ (.A(\pixel_d4[1] ),
    .B(_0331_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0335_));
 sky130_fd_sc_hd__o211ai_2 _0868_ (.A1(\pixel_d3[0] ),
    .A2(net27),
    .B1(_0334_),
    .C1(_0335_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0336_));
 sky130_fd_sc_hd__xor2_2 _0869_ (.A(_0333_),
    .B(_0336_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0337_));
 sky130_fd_sc_hd__and2b_2 _0870_ (.A_N(net3),
    .B(_0337_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__inv_2 _0871_ (.A(_0338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0339_));
 sky130_fd_sc_hd__nand2b_2 _0872_ (.A_N(_0337_),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0340_));
 sky130_fd_sc_hd__a21boi_2 _0873_ (.A1(_0339_),
    .A2(_0340_),
    .B1_N(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0341_));
 sky130_fd_sc_hd__xnor2_2 _0874_ (.A(\pixel_d3[3] ),
    .B(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0342_));
 sky130_fd_sc_hd__and2_2 _0875_ (.A(\pixel_d1[2] ),
    .B(\pixel_d2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0343_));
 sky130_fd_sc_hd__a21o_2 _0876_ (.A1(\pixel_d3[2] ),
    .A2(net28),
    .B1(_0343_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0344_));
 sky130_fd_sc_hd__and2b_2 _0877_ (.A_N(_0342_),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0345_));
 sky130_fd_sc_hd__xor2_2 _0878_ (.A(_0342_),
    .B(_0344_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0346_));
 sky130_fd_sc_hd__nor2_2 _0879_ (.A(_0521_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0347_));
 sky130_fd_sc_hd__xnor2_2 _0880_ (.A(_0521_),
    .B(_0346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0348_));
 sky130_fd_sc_hd__a21o_2 _0881_ (.A1(\pixel_d4[2] ),
    .A2(_0326_),
    .B1(_0325_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0349_));
 sky130_fd_sc_hd__and2b_2 _0882_ (.A_N(_0348_),
    .B(_0349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0350_));
 sky130_fd_sc_hd__xor2_2 _0883_ (.A(_0348_),
    .B(_0349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0351_));
 sky130_fd_sc_hd__o22a_2 _0884_ (.A1(_0327_),
    .A2(_0332_),
    .B1(_0333_),
    .B2(_0336_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0352_));
 sky130_fd_sc_hd__xnor2_2 _0885_ (.A(_0351_),
    .B(_0352_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0353_));
 sky130_fd_sc_hd__nor2_2 _0886_ (.A(net4),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0354_));
 sky130_fd_sc_hd__nand2_2 _0887_ (.A(net4),
    .B(_0353_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0355_));
 sky130_fd_sc_hd__nand2b_2 _0888_ (.A_N(_0354_),
    .B(_0355_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0356_));
 sky130_fd_sc_hd__nand2_2 _0889_ (.A(\pixel_d3[7] ),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__or2_2 _0890_ (.A(\pixel_d3[7] ),
    .B(_0169_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0358_));
 sky130_fd_sc_hd__nand2_2 _0891_ (.A(_0357_),
    .B(_0358_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0359_));
 sky130_fd_sc_hd__nand2_2 _0892_ (.A(\pixel_d3[6] ),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0360_));
 sky130_fd_sc_hd__nand2_2 _0893_ (.A(\pixel_d1[6] ),
    .B(\pixel_d2[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0361_));
 sky130_fd_sc_hd__a21o_2 _0894_ (.A1(_0360_),
    .A2(_0361_),
    .B1(_0359_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0362_));
 sky130_fd_sc_hd__nand3_2 _0895_ (.A(_0359_),
    .B(_0360_),
    .C(_0361_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0363_));
 sky130_fd_sc_hd__nand2_2 _0896_ (.A(_0362_),
    .B(_0363_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0364_));
 sky130_fd_sc_hd__o21a_2 _0897_ (.A1(_0519_),
    .A2(_0364_),
    .B1(_0362_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0365_));
 sky130_fd_sc_hd__a21o_2 _0898_ (.A1(_0167_),
    .A2(_0357_),
    .B1(_0365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0366_));
 sky130_fd_sc_hd__nand3_2 _0899_ (.A(_0167_),
    .B(_0357_),
    .C(_0365_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0367_));
 sky130_fd_sc_hd__and2_2 _0900_ (.A(_0366_),
    .B(_0367_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__inv_2 _0901_ (.A(_0368_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0369_));
 sky130_fd_sc_hd__xnor2_2 _0902_ (.A(_0519_),
    .B(_0364_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0370_));
 sky130_fd_sc_hd__or2_2 _0903_ (.A(\pixel_d3[6] ),
    .B(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__nand2_2 _0904_ (.A(_0360_),
    .B(_0371_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0372_));
 sky130_fd_sc_hd__nand3_2 _0905_ (.A(\pixel_d3[5] ),
    .B(_0120_),
    .C(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0373_));
 sky130_fd_sc_hd__nand2_2 _0906_ (.A(_0120_),
    .B(_0373_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0374_));
 sky130_fd_sc_hd__nand2b_2 _0907_ (.A_N(_0372_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0375_));
 sky130_fd_sc_hd__xnor2_2 _0908_ (.A(_0372_),
    .B(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0376_));
 sky130_fd_sc_hd__nand2_2 _0909_ (.A(\pixel_d4[6] ),
    .B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0377_));
 sky130_fd_sc_hd__a21oi_2 _0910_ (.A1(_0375_),
    .A2(_0377_),
    .B1(_0370_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__nand3_2 _0911_ (.A(_0370_),
    .B(_0375_),
    .C(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0379_));
 sky130_fd_sc_hd__and2b_2 _0912_ (.A_N(_0378_),
    .B(_0379_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0380_));
 sky130_fd_sc_hd__or2_2 _0913_ (.A(\pixel_d4[6] ),
    .B(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0381_));
 sky130_fd_sc_hd__nand2_2 _0914_ (.A(_0377_),
    .B(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0382_));
 sky130_fd_sc_hd__a21o_2 _0915_ (.A1(_0120_),
    .A2(_0121_),
    .B1(\pixel_d3[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0383_));
 sky130_fd_sc_hd__nand2_2 _0916_ (.A(_0373_),
    .B(_0383_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0384_));
 sky130_fd_sc_hd__and2_2 _0917_ (.A(\pixel_d3[4] ),
    .B(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__a21oi_2 _0918_ (.A1(\pixel_d1[4] ),
    .A2(\pixel_d2[4] ),
    .B1(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0386_));
 sky130_fd_sc_hd__xnor2_2 _0919_ (.A(_0384_),
    .B(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0387_));
 sky130_fd_sc_hd__nor2_2 _0920_ (.A(_0520_),
    .B(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0388_));
 sky130_fd_sc_hd__o21ba_2 _0921_ (.A1(_0384_),
    .A2(_0386_),
    .B1_N(_0388_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0389_));
 sky130_fd_sc_hd__nor2_2 _0922_ (.A(_0382_),
    .B(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0390_));
 sky130_fd_sc_hd__nand2_2 _0923_ (.A(_0382_),
    .B(_0389_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0391_));
 sky130_fd_sc_hd__nand2b_2 _0924_ (.A_N(_0390_),
    .B(_0391_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0392_));
 sky130_fd_sc_hd__and2_2 _0925_ (.A(_0520_),
    .B(_0387_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0393_));
 sky130_fd_sc_hd__or2_2 _0926_ (.A(_0388_),
    .B(_0393_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0394_));
 sky130_fd_sc_hd__nor2_2 _0927_ (.A(\pixel_d3[4] ),
    .B(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0395_));
 sky130_fd_sc_hd__or2_2 _0928_ (.A(_0385_),
    .B(_0395_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0396_));
 sky130_fd_sc_hd__a21bo_2 _0929_ (.A1(\pixel_d3[3] ),
    .A2(_0110_),
    .B1_N(_0109_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0397_));
 sky130_fd_sc_hd__nand2b_2 _0930_ (.A_N(_0396_),
    .B(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0398_));
 sky130_fd_sc_hd__xnor2_2 _0931_ (.A(_0396_),
    .B(_0397_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0399_));
 sky130_fd_sc_hd__nand2_2 _0932_ (.A(\pixel_d4[4] ),
    .B(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0400_));
 sky130_fd_sc_hd__a21oi_2 _0933_ (.A1(_0398_),
    .A2(_0400_),
    .B1(_0394_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0401_));
 sky130_fd_sc_hd__nand3_2 _0934_ (.A(_0394_),
    .B(_0398_),
    .C(_0400_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0402_));
 sky130_fd_sc_hd__and2b_2 _0935_ (.A_N(_0401_),
    .B(_0402_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0403_));
 sky130_fd_sc_hd__xnor2_2 _0936_ (.A(\pixel_d4[4] ),
    .B(_0399_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0404_));
 sky130_fd_sc_hd__o21ba_2 _0937_ (.A1(_0345_),
    .A2(_0347_),
    .B1_N(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0405_));
 sky130_fd_sc_hd__o21bai_2 _0938_ (.A1(_0351_),
    .A2(_0352_),
    .B1_N(_0350_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0406_));
 sky130_fd_sc_hd__or3b_2 _0939_ (.A(_0345_),
    .B(_0347_),
    .C_N(_0404_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0407_));
 sky130_fd_sc_hd__nand2b_2 _0940_ (.A_N(_0405_),
    .B(_0407_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0408_));
 sky130_fd_sc_hd__a21o_2 _0941_ (.A1(_0406_),
    .A2(_0407_),
    .B1(_0405_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0409_));
 sky130_fd_sc_hd__a21o_2 _0942_ (.A1(_0402_),
    .A2(_0409_),
    .B1(_0401_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0410_));
 sky130_fd_sc_hd__a21o_2 _0943_ (.A1(_0391_),
    .A2(_0410_),
    .B1(_0390_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0411_));
 sky130_fd_sc_hd__a21oi_2 _0944_ (.A1(_0379_),
    .A2(_0411_),
    .B1(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0412_));
 sky130_fd_sc_hd__o21a_2 _0945_ (.A1(_0369_),
    .A2(_0412_),
    .B1(_0366_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0413_));
 sky130_fd_sc_hd__or2_2 _0946_ (.A(net40),
    .B(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0414_));
 sky130_fd_sc_hd__inv_2 _0947_ (.A(_0414_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0415_));
 sky130_fd_sc_hd__and2_2 _0948_ (.A(net10),
    .B(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0416_));
 sky130_fd_sc_hd__xnor2_2 _0949_ (.A(_0369_),
    .B(_0412_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0417_));
 sky130_fd_sc_hd__nor2_2 _0950_ (.A(net9),
    .B(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0418_));
 sky130_fd_sc_hd__nand2_2 _0951_ (.A(net9),
    .B(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0419_));
 sky130_fd_sc_hd__xnor2_2 _0952_ (.A(_0380_),
    .B(_0411_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0420_));
 sky130_fd_sc_hd__nor2_2 _0953_ (.A(net29),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0421_));
 sky130_fd_sc_hd__or2_2 _0954_ (.A(net29),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0422_));
 sky130_fd_sc_hd__xor2_2 _0955_ (.A(net8),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0423_));
 sky130_fd_sc_hd__xor2_2 _0956_ (.A(_0392_),
    .B(_0410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0424_));
 sky130_fd_sc_hd__nor2_2 _0957_ (.A(net7),
    .B(_0424_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0425_));
 sky130_fd_sc_hd__nand2_2 _0958_ (.A(net7),
    .B(_0424_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0426_));
 sky130_fd_sc_hd__and2b_2 _0959_ (.A_N(_0425_),
    .B(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0427_));
 sky130_fd_sc_hd__xnor2_2 _0960_ (.A(_0403_),
    .B(_0409_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0428_));
 sky130_fd_sc_hd__nor2_2 _0961_ (.A(net6),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0429_));
 sky130_fd_sc_hd__nand2_2 _0962_ (.A(net6),
    .B(_0428_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0430_));
 sky130_fd_sc_hd__xor2_2 _0963_ (.A(_0406_),
    .B(_0408_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__nand2_2 _0964_ (.A(net5),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0432_));
 sky130_fd_sc_hd__inv_2 _0965_ (.A(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0433_));
 sky130_fd_sc_hd__nor2_2 _0966_ (.A(net5),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0434_));
 sky130_fd_sc_hd__a21o_2 _0967_ (.A1(_0338_),
    .A2(_0355_),
    .B1(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0435_));
 sky130_fd_sc_hd__inv_2 _0968_ (.A(_0435_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0436_));
 sky130_fd_sc_hd__a21o_2 _0969_ (.A1(_0432_),
    .A2(_0435_),
    .B1(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0437_));
 sky130_fd_sc_hd__or2_2 _0970_ (.A(_0429_),
    .B(_0437_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0438_));
 sky130_fd_sc_hd__o21ai_2 _0971_ (.A1(_0429_),
    .A2(_0437_),
    .B1(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0439_));
 sky130_fd_sc_hd__a21bo_2 _0972_ (.A1(net29),
    .A2(net19),
    .B1_N(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0440_));
 sky130_fd_sc_hd__a32o_2 _0973_ (.A1(_0423_),
    .A2(_0427_),
    .A3(_0439_),
    .B1(_0440_),
    .B2(_0422_),
    ...
    .VPWR(VPWR),
    .X(_0441_));
 sky130_fd_sc_hd__inv_2 _0974_ (.A(_0441_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0442_));
 sky130_fd_sc_hd__a21oi_2 _0975_ (.A1(_0419_),
    .A2(_0442_),
    .B1(_0418_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0443_));
 sky130_fd_sc_hd__xnor2_2 _0976_ (.A(_0513_),
    .B(_0417_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0444_));
 sky130_fd_sc_hd__nand2b_2 _0977_ (.A_N(_0418_),
    .B(_0419_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0445_));
 sky130_fd_sc_hd__o211a_2 _0978_ (.A1(net10),
    .A2(_0413_),
    .B1(_0417_),
    .C1(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0446_));
 sky130_fd_sc_hd__a311o_2 _0979_ (.A1(_0414_),
    .A2(_0441_),
    .A3(_0444_),
    .B1(_0446_),
    .C1(_0416_),
    ...
    .VPWR(VPWR),
    .X(_0447_));
 sky130_fd_sc_hd__mux2_1 _0980_ (.A0(_0340_),
    .A1(_0339_),
    .S(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__and2_2 _0981_ (.A(_0356_),
    .B(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0449_));
 sky130_fd_sc_hd__nor2_2 _0982_ (.A(_0356_),
    .B(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0450_));
 sky130_fd_sc_hd__a211o_2 _0983_ (.A1(_0319_),
    .A2(_0341_),
    .B1(_0449_),
    .C1(_0450_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0451_));
 sky130_fd_sc_hd__o311a_2 _0984_ (.A1(_0308_),
    .A2(_0310_),
    .A3(_0320_),
    .B1(_0314_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0452_));
 sky130_fd_sc_hd__o21a_2 _0985_ (.A1(_0517_),
    .A2(_0317_),
    .B1(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0453_));
 sky130_fd_sc_hd__nand2_2 _0986_ (.A(net17),
    .B(_0296_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0454_));
 sky130_fd_sc_hd__o32a_2 _0987_ (.A1(_0306_),
    .A2(_0309_),
    .A3(_0454_),
    .B1(_0453_),
    .B2(_0452_),
    ...
    .VPWR(VPWR),
    .X(_0455_));
 sky130_fd_sc_hd__or2_2 _0988_ (.A(_0433_),
    .B(_0434_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0456_));
 sky130_fd_sc_hd__a21o_2 _0989_ (.A1(_0340_),
    .A2(_0355_),
    .B1(_0354_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0457_));
 sky130_fd_sc_hd__mux2_1 _0990_ (.A0(_0457_),
    .A1(_0436_),
    .S(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0458_));
 sky130_fd_sc_hd__xnor2_2 _0991_ (.A(_0456_),
    .B(_0458_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0459_));
 sky130_fd_sc_hd__o22a_2 _0992_ (.A1(_0319_),
    .A2(_0341_),
    .B1(_0455_),
    .B2(_0459_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0460_));
 sky130_fd_sc_hd__and3_2 _0993_ (.A(_0286_),
    .B(_0296_),
    .C(_0314_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0461_));
 sky130_fd_sc_hd__o221a_2 _0994_ (.A1(_0296_),
    .A2(_0313_),
    .B1(_0321_),
    .B2(_0461_),
    .C1(net17),
    ...
    .VPWR(VPWR),
    .X(_0462_));
 sky130_fd_sc_hd__and3_2 _0995_ (.A(net17),
    .B(_0296_),
    .C(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0463_));
 sky130_fd_sc_hd__inv_2 _0996_ (.A(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__o31a_2 _0997_ (.A1(_0308_),
    .A2(_0317_),
    .A3(_0320_),
    .B1(_0313_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__o22a_2 _0998_ (.A1(_0304_),
    .A2(_0462_),
    .B1(_0464_),
    .B2(_0465_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__and2b_2 _0999_ (.A_N(_0429_),
    .B(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0467_));
 sky130_fd_sc_hd__o21a_2 _1000_ (.A1(_0434_),
    .A2(_0457_),
    .B1(_0432_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0468_));
 sky130_fd_sc_hd__inv_2 _1001_ (.A(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0469_));
 sky130_fd_sc_hd__mux2_1 _1002_ (.A0(_0469_),
    .A1(_0437_),
    .S(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0470_));
 sky130_fd_sc_hd__xnor2_2 _1003_ (.A(_0467_),
    .B(_0470_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0471_));
 sky130_fd_sc_hd__a22o_2 _1004_ (.A1(_0455_),
    .A2(_0459_),
    .B1(_0466_),
    .B2(_0471_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0472_));
 sky130_fd_sc_hd__a21oi_2 _1005_ (.A1(_0451_),
    .A2(_0460_),
    .B1(_0472_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0473_));
 sky130_fd_sc_hd__a21o_2 _1006_ (.A1(net17),
    .A2(_0313_),
    .B1(_0463_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0474_));
 sky130_fd_sc_hd__a21o_2 _1007_ (.A1(_0304_),
    .A2(_0461_),
    .B1(_0321_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0475_));
 sky130_fd_sc_hd__a21o_2 _1008_ (.A1(_0474_),
    .A2(_0475_),
    .B1(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0476_));
 sky130_fd_sc_hd__a21o_2 _1009_ (.A1(_0430_),
    .A2(_0468_),
    .B1(_0429_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0477_));
 sky130_fd_sc_hd__mux2_1 _1010_ (.A0(_0477_),
    .A1(_0439_),
    .S(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0478_));
 sky130_fd_sc_hd__xor2_2 _1011_ (.A(_0427_),
    .B(_0478_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0479_));
 sky130_fd_sc_hd__o22ai_2 _1012_ (.A1(_0466_),
    .A2(_0471_),
    .B1(_0476_),
    .B2(_0479_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0480_));
 sky130_fd_sc_hd__a21boi_2 _1013_ (.A1(net29),
    .A2(net19),
    .B1_N(_0425_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0481_));
 sky130_fd_sc_hd__a311o_2 _1014_ (.A1(_0423_),
    .A2(_0427_),
    .A3(_0477_),
    .B1(_0481_),
    .C1(_0421_),
    ...
    .VPWR(VPWR),
    .X(_0482_));
 sky130_fd_sc_hd__or2_2 _1015_ (.A(_0418_),
    .B(_0482_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0483_));
 sky130_fd_sc_hd__a32o_2 _1016_ (.A1(_0415_),
    .A2(_0419_),
    .A3(_0483_),
    .B1(_0443_),
    .B2(_0416_),
    ...
    .VPWR(VPWR),
    .X(_0484_));
 sky130_fd_sc_hd__o21ai_2 _1017_ (.A1(_0425_),
    .A2(_0477_),
    .B1(_0426_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0485_));
 sky130_fd_sc_hd__a31o_2 _1018_ (.A1(_0426_),
    .A2(_0430_),
    .A3(_0438_),
    .B1(_0425_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0486_));
 sky130_fd_sc_hd__mux2_1 _1019_ (.A0(_0485_),
    .A1(_0486_),
    .S(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0487_));
 sky130_fd_sc_hd__mux2_1 _1020_ (.A0(_0482_),
    .A1(_0441_),
    .S(_0447_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0488_));
 sky130_fd_sc_hd__xnor2_2 _1021_ (.A(_0423_),
    .B(_0487_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0489_));
 sky130_fd_sc_hd__a211o_2 _1022_ (.A1(_0476_),
    .A2(_0479_),
    .B1(_0484_),
    .C1(_0489_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0490_));
 sky130_fd_sc_hd__a21oi_2 _1023_ (.A1(_0445_),
    .A2(_0488_),
    .B1(_0490_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0491_));
 sky130_fd_sc_hd__o221a_2 _1024_ (.A1(_0473_),
    .A2(_0480_),
    .B1(_0488_),
    .B2(_0445_),
    .C1(_0491_),
 ...
 sky130_fd_sc_hd__o2bb2a_2 _1025_ (.A1_N(_0517_),
    .A2_N(_0064_),
    .B1(strong_motion),
    .B2(uio_out[7]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0492_));
 sky130_fd_sc_hd__a21o_2 _1026_ (.A1(_0067_),
    .A2(_0476_),
    .B1(_0492_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0493_));
 sky130_fd_sc_hd__a32o_2 _1027_ (.A1(_0142_),
    .A2(_0315_),
    .A3(_0318_),
    .B1(_0322_),
    .B2(_0140_),
    ...
    .VPWR(VPWR),
    .X(_0494_));
 sky130_fd_sc_hd__o221a_2 _1028_ (.A1(_0142_),
    .A2(_0319_),
    .B1(_0455_),
    .B2(net48),
    .C1(_0494_),
    ...
    .VPWR(VPWR),
    .X(_0495_));
 sky130_fd_sc_hd__a221o_2 _1029_ (.A1(net48),
    .A2(_0455_),
    .B1(_0466_),
    .B2(_0160_),
    .C1(_0495_),
    ...
    .VPWR(VPWR),
    .X(_0496_));
 sky130_fd_sc_hd__o22a_2 _1030_ (.A1(_0160_),
    .A2(_0466_),
    .B1(_0476_),
    .B2(_0067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0497_));
 sky130_fd_sc_hd__a221oi_2 _1031_ (.A1(net16),
    .A2(strong_edge),
    .B1(_0496_),
    .B2(_0497_),
    .C1(_0493_),
    ...
    .VPWR(VPWR),
    .Y(_0498_));
 sky130_fd_sc_hd__o21ai_2 _1032_ (.A1(_0522_),
    .A2(prediction_confidence),
    .B1(_0498_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0499_));
 sky130_fd_sc_hd__a21oi_4 _1033_ (.A1(_0499_),
    .A2(net1),
    .B1(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0500_));
 sky130_fd_sc_hd__inv_2 _1034_ (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(update_decision));
 sky130_fd_sc_hd__or2_2 _1035_ (.A(strong_motion),
    .B(_0160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(significant_transition));
 sky130_fd_sc_hd__and2_2 _1036_ (.A(net1),
    .B(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(hold_decision));
 sky130_fd_sc_hd__mux2_1 _1037_ (.A0(net3),
    .A1(uo_out[0]),
    .S(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0000_));
 sky130_fd_sc_hd__mux2_1 _1038_ (.A0(net4),
    .A1(uo_out[1]),
    .S(net51),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _1040_ (.A0(net6),
    ...
    .VPWR(VPWR),
    .X(_0003_));
 sky130_fd_sc_hd__mux2_1 _1041_ (.A0(net7),
    .A1(uo_out[4]),
    .S(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0004_));
 sky130_fd_sc_hd__mux2_1 _1042_ (.A0(net29),
    .A1(uo_out[5]),
    .S(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0005_));
 sky130_fd_sc_hd__mux2_1 _1043_ (.A0(net9),
    .A1(uo_out[6]),
    .S(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0006_));
 sky130_fd_sc_hd__mux2_1 _1044_ (.A0(net40),
    .A1(uo_out[7]),
    .S(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0007_));
 sky130_fd_sc_hd__and3_2 _1045_ (.A(\motion_count[0] ),
    .B(\motion_count[1] ),
    .C(strong_motion),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0501_));
 sky130_fd_sc_hd__and2_2 _1046_ (.A(\motion_count[2] ),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0502_));
 sky130_fd_sc_hd__inv_2 _1047_ (.A(_0502_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0503_));
 sky130_fd_sc_hd__or2_2 _1048_ (.A(strong_motion),
    .B(_0307_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0504_));
 sky130_fd_sc_hd__or2_2 _1049_ (.A(\motion_count[2] ),
    .B(_0504_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0505_));
 sky130_fd_sc_hd__inv_2 _1050_ (.A(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0506_));
 sky130_fd_sc_hd__nor2_2 _1051_ (.A(\motion_count[3] ),
    .B(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0507_));
 sky130_fd_sc_hd__a2bb2o_2 _1052_ (.A1_N(\motion_count[0] ),
    .A2_N(_0507_),
    .B1(_0502_),
    .B2(\motion_count[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0008_));
 sky130_fd_sc_hd__xnor2_2 _1053_ (.A(\motion_count[1] ),
    .B(strong_motion),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0508_));
 sky130_fd_sc_hd__xnor2_2 _1054_ (.A(_0008_),
    .B(_0508_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0009_));
 sky130_fd_sc_hd__o21a_2 _1055_ (.A1(_0501_),
    .A2(_0506_),
    .B1(\motion_count[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0509_));
 sky130_fd_sc_hd__or2_2 _1056_ (.A(\motion_count[2] ),
    .B(_0501_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0510_));
 sky130_fd_sc_hd__a31o_2 _1057_ (.A1(_0503_),
    .A2(_0504_),
    .A3(_0510_),
    .B1(_0509_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0010_));
 sky130_fd_sc_hd__o21a_2 _1058_ (.A1(\motion_count[3] ),
    .A2(_0502_),
    .B1(_0505_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0011_));
 sky130_fd_sc_hd__dfrtp_2 _1059_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0000_),
    .RESET_B(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _1060_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0001_),
    .RESET_B(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _1061_ (.CLK(clknet_3_7__leaf_clk),
    .D(_0002_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _1062_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0003_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfrtp_2 _1063_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0004_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfrtp_2 _1064_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0005_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfrtp_2 _1065_ (.CLK(clknet_3_6__leaf_clk),
    .D(_0006_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfrtp_2 _1066_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0007_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[7]));
 sky130_fd_sc_hd__dfrtp_2 _1067_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0008_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\motion_count[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1068_ (.CLK(clknet_3_2__leaf_clk),
    .D(_0009_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\motion_count[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1069_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0010_),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\motion_count[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1070_ (.CLK(clknet_3_3__leaf_clk),
    .D(_0011_),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\motion_count[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1071_ (.CLK(clknet_3_7__leaf_clk),
    .D(net3),
    .RESET_B(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1072_ (.CLK(clknet_3_7__leaf_clk),
    .D(net4),
    .RESET_B(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1073_ (.CLK(clknet_3_7__leaf_clk),
    .D(net5),
    .RESET_B(net34),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1074_ (.CLK(clknet_3_6__leaf_clk),
    .D(net6),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1075_ (.CLK(clknet_3_1__leaf_clk),
    .D(net7),
    .RESET_B(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1076_ (.CLK(clknet_3_1__leaf_clk),
    .D(net29),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1077_ (.CLK(clknet_3_6__leaf_clk),
    .D(net9),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1078_ (.CLK(clknet_3_1__leaf_clk),
    .D(net40),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d1[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1079_ (.CLK(clknet_3_4__leaf_clk),
    .D(net80),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1080_ (.CLK(clknet_3_5__leaf_clk),
    .D(net79),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1081_ (.CLK(clknet_3_5__leaf_clk),
    .D(net68),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1082_ (.CLK(clknet_3_4__leaf_clk),
    .D(net70),
    .RESET_B(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1083_ (.CLK(clknet_3_1__leaf_clk),
    .D(net59),
    .RESET_B(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1084_ (.CLK(clknet_3_0__leaf_clk),
    .D(net67),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1085_ (.CLK(clknet_3_0__leaf_clk),
    .D(net78),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1086_ (.CLK(clknet_3_2__leaf_clk),
    .D(net61),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d2[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1087_ (.CLK(clknet_3_5__leaf_clk),
    .D(net73),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1088_ (.CLK(clknet_3_5__leaf_clk),
    .D(net76),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1089_ (.CLK(clknet_3_5__leaf_clk),
    .D(net74),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1090_ (.CLK(clknet_3_4__leaf_clk),
    .D(net64),
    .RESET_B(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1091_ (.CLK(clknet_3_4__leaf_clk),
    .D(net66),
    .RESET_B(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1092_ (.CLK(clknet_3_0__leaf_clk),
    .D(net60),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1093_ (.CLK(clknet_3_0__leaf_clk),
    .D(net71),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1094_ (.CLK(clknet_3_0__leaf_clk),
    .D(net81),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d3[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1095_ (.CLK(clknet_3_4__leaf_clk),
    .D(net72),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[0] ));
 sky130_fd_sc_hd__dfrtp_2 _1096_ (.CLK(clknet_3_4__leaf_clk),
    .D(net75),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[1] ));
 sky130_fd_sc_hd__dfrtp_2 _1097_ (.CLK(clknet_3_5__leaf_clk),
    .D(net69),
    .RESET_B(net35),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[2] ));
 sky130_fd_sc_hd__dfrtp_2 _1098_ (.CLK(clknet_3_6__leaf_clk),
    .D(net65),
    .RESET_B(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[3] ));
 sky130_fd_sc_hd__dfrtp_2 _1099_ (.CLK(clknet_3_1__leaf_clk),
    .D(net63),
    .RESET_B(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[4] ));
 sky130_fd_sc_hd__dfrtp_2 _1100_ (.CLK(clknet_3_1__leaf_clk),
    .D(net62),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[5] ));
 sky130_fd_sc_hd__dfrtp_2 _1101_ (.CLK(clknet_3_3__leaf_clk),
    .D(net55),
    .RESET_B(net33),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[6] ));
 sky130_fd_sc_hd__dfrtp_2 _1102_ (.CLK(clknet_3_0__leaf_clk),
    .D(net77),
    .RESET_B(net31),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\pixel_d4[7] ));
 sky130_fd_sc_hd__dfrtp_2 _1103_ (.CLK(clknet_3_2__leaf_clk),
    .D(significant_transition),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(transition_d1));
 sky130_fd_sc_hd__dfrtp_2 _1104_ (.CLK(clknet_3_2__leaf_clk),
    .D(net56),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(transition_d2));
 sky130_fd_sc_hd__dfrtp_2 _1105_ (.CLK(clknet_3_2__leaf_clk),
    .D(net57),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(transition_d3));
 sky130_fd_sc_hd__dfrtp_2 _1106_ (.CLK(clknet_3_2__leaf_clk),
    .D(net58),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(transition_d4));
 sky130_fd_sc_hd__buf_2 _1115_ (.A(update_decision),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[0]));
 sky130_fd_sc_hd__buf_4 _1116_ (.A(hold_decision),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__buf_2 _1117_ (.A(prediction_confidence),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[2]));
 sky130_fd_sc_hd__buf_2 _1118_ (.A(strong_edge),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[3]));
 sky130_fd_sc_hd__buf_2 _1119_ (.A(strong_motion),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout37 (.A(net39),
    ...
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout39 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__buf_6 fanout40 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\pixel_d3[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(transition_d1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(transition_d2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(transition_d3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\pixel_d1[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\pixel_d2[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\pixel_d1[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\pixel_d3[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\pixel_d3[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\pixel_d2[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\pixel_d3[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\pixel_d2[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\pixel_d1[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\pixel_d1[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\pixel_d3[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\pixel_d1[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\pixel_d2[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\pixel_d3[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\pixel_d2[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\pixel_d2[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\pixel_d3[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\pixel_d2[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\pixel_d3[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\pixel_d1[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\pixel_d1[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\pixel_d1[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\pixel_d2[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 input11 (.A(uio_in[0]),
    ...
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__dlymetal6s4s_1 input12 (.A(uio_in[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input2 (.A(rst_n),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__dlygate4sd1_1 input3 (.A(ui_in[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__dlygate4sd1_1 input4 (.A(ui_in[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 input8 (.A(ui_in[5]),
    ...
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__dlymetal6s4s_1 input9 (.A(ui_in[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_4 load_slew31 (.A(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 load_slew38 (.A(net37),
    ...
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__buf_6 max_cap18 (.A(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__buf_2 max_cap20 (.A(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkbuf_2 max_cap21 (.A(_0094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap23 (.A(_0150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap24 (.A(net25),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__dlymetal6s2s_1 max_cap25 (.A(_0053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkbuf_2 max_cap27 (.A(_0144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__buf_2 max_cap28 (.A(_0098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__buf_2 max_cap29 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__buf_2 rebuffer48 (.A(_0138_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__buf_2 rebuffer49 (.A(_0070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__buf_2 rebuffer50 (.A(_0158_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__buf_2 rebuffer51 (.A(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__buf_2 rebuffer52 (.A(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__buf_2 rebuffer53 (.A(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__buf_2 rebuffer54 (.A(_0075_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_vital_ap_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
 sky130_fd_sc_hd__buf_2 wire19 (.A(_0420_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),

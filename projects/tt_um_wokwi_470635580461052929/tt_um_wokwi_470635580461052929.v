module tt_um_wokwi_470635580461052929 (clk,
 ...
 sky130_fd_sc_hd__buf_2 _23_ (.A(net10),
    ...
    .VPWR(VPWR),
    .X(uo_out[7]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input1 (.A(ui_in[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input2 (.A(ui_in[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__conb_1 tt_um_wokwi_470635580461052929_18 (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_wokwi_470635580461052929_19 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));

module tt_um_ahlana_nova_cpu (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire _146_;
 wire _147_;
 wire \cpu_core.exec_cycle[0] ;
 wire \cpu_core.exec_cycle[1] ;
 wire \cpu_core.ir[0] ;
 wire \cpu_core.ir[15] ;
 wire \cpu_core.ir[1] ;
 wire \cpu_core.ir[2] ;
 wire \cpu_core.ir[3] ;
 wire \cpu_core.mem_addr[0] ;
 wire \cpu_core.mem_addr[10] ;
 wire \cpu_core.mem_addr[11] ;
 wire \cpu_core.mem_addr[12] ;
 wire \cpu_core.mem_addr[13] ;
 wire \cpu_core.mem_addr[14] ;
 wire \cpu_core.mem_addr[1] ;
 wire \cpu_core.mem_addr[2] ;
 wire \cpu_core.mem_addr[3] ;
 wire \cpu_core.mem_addr[4] ;
 wire \cpu_core.mem_addr[5] ;
 wire \cpu_core.mem_addr[6] ;
 wire \cpu_core.mem_addr[7] ;
 wire \cpu_core.mem_addr[8] ;
 wire \cpu_core.mem_addr[9] ;
 ...
 wire \cpu_core.mem_read_req ;
 wire \cpu_core.meow_busy ;
 wire \cpu_core.meow_inst.bit_cnt[0] ;
 wire \cpu_core.meow_inst.bit_cnt[1] ;
 wire \cpu_core.meow_inst.bit_cnt[2] ;
 wire \cpu_core.meow_inst.bit_cnt[3] ;
 wire \cpu_core.meow_inst.bit_cnt[4] ;
 wire \cpu_core.meow_inst.rx_shift[0] ;
 wire \cpu_core.meow_inst.rx_shift[10] ;
 wire \cpu_core.meow_inst.rx_shift[11] ;
 wire \cpu_core.meow_inst.rx_shift[12] ;
 wire \cpu_core.meow_inst.rx_shift[13] ;
 wire \cpu_core.meow_inst.rx_shift[14] ;
 wire \cpu_core.meow_inst.rx_shift[15] ;
 wire \cpu_core.meow_inst.rx_shift[1] ;
 wire \cpu_core.meow_inst.rx_shift[2] ;
 wire \cpu_core.meow_inst.rx_shift[3] ;
 wire \cpu_core.meow_inst.rx_shift[4] ;
 wire \cpu_core.meow_inst.rx_shift[5] ;
 wire \cpu_core.meow_inst.rx_shift[6] ;
 wire \cpu_core.meow_inst.rx_shift[7] ;
 wire \cpu_core.meow_inst.rx_shift[8] ;
 wire \cpu_core.meow_inst.rx_shift[9] ;
 wire \cpu_core.meow_inst.spi_cs_n ;
 ...
 wire \cpu_core.meow_inst.state[2] ;
 wire \cpu_core.meow_inst.state[3] ;
 wire \cpu_core.meow_inst.tx_shift[0] ;
 wire \cpu_core.meow_inst.tx_shift[10] ;
 wire \cpu_core.meow_inst.tx_shift[11] ;
 wire \cpu_core.meow_inst.tx_shift[12] ;
 wire \cpu_core.meow_inst.tx_shift[13] ;
 wire \cpu_core.meow_inst.tx_shift[14] ;
 wire \cpu_core.meow_inst.tx_shift[15] ;
 wire \cpu_core.meow_inst.tx_shift[1] ;
 wire \cpu_core.meow_inst.tx_shift[2] ;
 wire \cpu_core.meow_inst.tx_shift[3] ;
 wire \cpu_core.meow_inst.tx_shift[4] ;
 wire \cpu_core.meow_inst.tx_shift[5] ;
 wire \cpu_core.meow_inst.tx_shift[6] ;
 wire \cpu_core.meow_inst.tx_shift[7] ;
 wire \cpu_core.meow_inst.tx_shift[8] ;
 wire \cpu_core.meow_inst.tx_shift[9] ;
 wire net1;
 wire net2;
 wire net37;
 wire net38;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _148_ (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__inv_2 _149_ (.A(\cpu_core.ir[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__inv_2 _150_ (.A(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__inv_2 _151_ (.A(\cpu_core.mem_read_req ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__or3_2 _152_ (.A(\cpu_core.meow_inst.bit_cnt[0] ),
    .B(\cpu_core.meow_inst.bit_cnt[1] ),
    .C(\cpu_core.meow_inst.bit_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__or4_2 _153_ (.A(\cpu_core.meow_inst.bit_cnt[0] ),
    .B(\cpu_core.meow_inst.bit_cnt[1] ),
    .C(\cpu_core.meow_inst.bit_cnt[2] ),
    .D(\cpu_core.meow_inst.bit_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__nor2_2 _154_ (.A(\cpu_core.meow_inst.bit_cnt[4] ),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__and2_2 _155_ (.A(net7),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__nand2_2 _156_ (.A(\cpu_core.mem_read_req ),
    ...
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__o21ai_2 _157_ (.A1(_075_),
    .A2(_081_),
    .B1(_082_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__and2_2 _158_ (.A(_078_),
    .B(\cpu_core.meow_inst.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__nand2b_2 _159_ (.A_N(\cpu_core.mem_read_req ),
    .B(\cpu_core.meow_inst.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__or2_2 _160_ (.A(\cpu_core.meow_inst.state[3] ),
    .B(_083_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__and3b_2 _161_ (.A_N(uo_out[5]),
    .B(uo_out[6]),
    .C(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(uo_out[7]));
 sky130_fd_sc_hd__nor3b_2 _162_ (.A(uo_out[4]),
    .B(uo_out[5]),
    .C_N(uo_out[6]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__and3b_2 _163_ (.A_N(uo_out[6]),
    .B(uo_out[5]),
    .C(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__a32o_2 _164_ (.A1(\cpu_core.exec_cycle[0] ),
    .A2(\cpu_core.exec_cycle[1] ),
    .A3(_085_),
    .B1(_086_),
    .B2(_076_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__xor2_2 _165_ (.A(net109),
    .B(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__and3_2 _166_ (.A(\cpu_core.mem_addr[0] ),
    .B(\cpu_core.mem_addr[1] ),
    .C(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__a21oi_2 _167_ (.A1(net114),
    .A2(net3),
    .B1(net105),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_089_));
 sky130_fd_sc_hd__nor2_2 _168_ (.A(_088_),
    .B(_089_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_004_));
 sky130_fd_sc_hd__xor2_2 _169_ (.A(net97),
    .B(_088_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__and4_2 _170_ (.A(\cpu_core.mem_addr[0] ),
    .B(\cpu_core.mem_addr[1] ),
    .C(\cpu_core.mem_addr[2] ),
    .D(\cpu_core.mem_addr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__nand2_2 _171_ (.A(net3),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__a41o_2 _172_ (.A1(\cpu_core.mem_addr[0] ),
    .A2(\cpu_core.mem_addr[1] ),
    .A3(\cpu_core.mem_addr[2] ),
    .A4(net3),
    .B1(\cpu_core.mem_addr[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__and2_2 _173_ (.A(_091_),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__xnor2_2 _174_ (.A(net103),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__a31oi_2 _175_ (.A1(\cpu_core.mem_addr[4] ),
    .A2(net3),
    .A3(_090_),
    .B1(net107),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__and4_2 _176_ (.A(\cpu_core.mem_addr[4] ),
    .B(\cpu_core.mem_addr[5] ),
    .C(net3),
    .D(_090_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__nor2_2 _177_ (.A(_093_),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_008_));
 sky130_fd_sc_hd__and3_2 _178_ (.A(\cpu_core.mem_addr[4] ),
    .B(\cpu_core.mem_addr[5] ),
    .C(\cpu_core.mem_addr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__xor2_2 _179_ (.A(net83),
    .B(_094_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a31o_2 _180_ (.A1(net3),
    .A2(_090_),
    .A3(_095_),
    .B1(\cpu_core.mem_addr[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__and3_2 _181_ (.A(\cpu_core.mem_addr[7] ),
    .B(_090_),
    .C(_095_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__nand2_2 _182_ (.A(net3),
    .B(_097_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__and2_2 _183_ (.A(_096_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__xnor2_2 _184_ (.A(net111),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__a31o_2 _185_ (.A1(\cpu_core.mem_addr[8] ),
    .A2(net3),
    .A3(_097_),
    .B1(\cpu_core.mem_addr[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__nand2_2 _186_ (.A(\cpu_core.mem_addr[8] ),
    .B(\cpu_core.mem_addr[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__o21a_2 _187_ (.A1(_098_),
    .A2(_100_),
    .B1(_099_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__a41o_2 _188_ (.A1(\cpu_core.mem_addr[8] ),
    .A2(\cpu_core.mem_addr[9] ),
    .A3(net4),
    .A4(_097_),
    .B1(\cpu_core.mem_addr[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__and3_2 _189_ (.A(\cpu_core.mem_addr[8] ),
    .B(\cpu_core.mem_addr[9] ),
    .C(\cpu_core.mem_addr[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__inv_2 _190_ (.A(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__o21a_2 _191_ (.A1(_098_),
    .A2(_103_),
    .B1(_101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a31o_2 _192_ (.A1(net4),
    .A2(_097_),
    .A3(_102_),
    .B1(\cpu_core.mem_addr[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__and4_2 _193_ (.A(\cpu_core.mem_addr[8] ),
    .B(\cpu_core.mem_addr[9] ),
    .C(\cpu_core.mem_addr[10] ),
    .D(\cpu_core.mem_addr[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__and4_2 _194_ (.A(\cpu_core.mem_addr[7] ),
    .B(_090_),
    .C(_095_),
    .D(_105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__nand2_2 _195_ (.A(net4),
    .B(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__and2_2 _196_ (.A(_104_),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__xnor2_2 _197_ (.A(net100),
    .B(_107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__a31oi_2 _198_ (.A1(\cpu_core.mem_addr[12] ),
    .A2(net4),
    .A3(_106_),
    .B1(net104),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__and4_2 _199_ (.A(\cpu_core.mem_addr[12] ),
    .B(\cpu_core.mem_addr[13] ),
    .C(net4),
    .D(_106_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__nor2_2 _200_ (.A(_108_),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__xor2_2 _201_ (.A(net42),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__nor2_2 _202_ (.A(uo_out[4]),
    .B(uo_out[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__or4b_2 _203_ (.A(uo_out[4]),
    .B(uo_out[6]),
    .C(\cpu_core.meow_busy ),
    .D_N(uo_out[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__mux2_1 _204_ (.A0(net48),
    .A1(\cpu_core.ir[0] ),
    .S(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _205_ (.A0(\cpu_core.mem_data_in[1] ),
    .A1(net67),
    .S(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _206_ (.A0(net86),
    .A1(net90),
    .S(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__mux2_1 _207_ (.A0(net88),
    .A1(net95),
    .S(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _208_ (.A0(net51),
    .A1(\cpu_core.ir[15] ),
    .S(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__nor3b_2 _209_ (.A(uo_out[5]),
    .B(uo_out[6]),
    .C_N(uo_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__o31a_2 _210_ (.A1(uo_out[4]),
    .A2(uo_out[5]),
    .A3(uo_out[6]),
    .B1(_078_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__o22ai_2 _211_ (.A1(_078_),
    .A2(_112_),
    .B1(_113_),
    .B2(net40),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__a21boi_2 _212_ (.A1(\cpu_core.exec_cycle[0] ),
    .A2(\cpu_core.exec_cycle[1] ),
    .B1_N(_085_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__mux2_1 _213_ (.A0(_110_),
    .A1(_112_),
    .S(_077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_115_));
 sky130_fd_sc_hd__nor2_2 _214_ (.A(_114_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__or2_2 _215_ (.A(uo_out[7]),
    .B(_110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__mux2_1 _216_ (.A0(uo_out[4]),
    .A1(_117_),
    .S(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__a21o_2 _217_ (.A1(uo_out[5]),
    .A2(_110_),
    .B1(_112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__mux2_1 _218_ (.A0(uo_out[5]),
    .A1(_118_),
    .S(_116_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__a211o_2 _219_ (.A1(net108),
    .A2(_086_),
    .B1(_114_),
    .C1(uo_out[7]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__o21ai_2 _220_ (.A1(_085_),
    .A2(_086_),
    .B1(\cpu_core.exec_cycle[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_119_));
 sky130_fd_sc_hd__nor2_2 _221_ (.A(net4),
    .B(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__o22a_2 _222_ (.A1(net112),
    .A2(_085_),
    .B1(net4),
    .B2(_119_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__o2bb2a_2 _223_ (.A1_N(\cpu_core.ir[15] ),
    .A2_N(_086_),
    .B1(_120_),
    .B2(net113),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__o21a_2 _224_ (.A1(\cpu_core.meow_inst.state[3] ),
    .A2(\cpu_core.meow_inst.state[0] ),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__o22a_2 _225_ (.A1(\cpu_core.meow_inst.state[3] ),
    .A2(_082_),
    .B1(_121_),
    .B2(net106),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__nor2_2 _226_ (.A(net39),
    .B(\cpu_core.meow_inst.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__o21a_2 _227_ (.A1(net8),
    .A2(net41),
    .B1(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__mux2_1 _228_ (.A0(net82),
    .A1(net78),
    .S(net39),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__mux2_1 _229_ (.A0(net48),
    .A1(net66),
    .S(\cpu_core.meow_inst.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__mux2_1 _230_ (.A0(net91),
    .A1(\cpu_core.meow_inst.rx_shift[1] ),
    .S(\cpu_core.meow_inst.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__mux2_1 _231_ (.A0(net86),
    .A1(\cpu_core.meow_inst.rx_shift[2] ),
    .S(\cpu_core.meow_inst.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__mux2_1 _232_ (.A0(net88),
    .A1(\cpu_core.meow_inst.rx_shift[3] ),
    .S(\cpu_core.meow_inst.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__mux2_1 _233_ (.A0(net51),
    .A1(net46),
    .S(\cpu_core.meow_inst.state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__o22ai_2 _234_ (.A1(\cpu_core.meow_inst.state[3] ),
    .A2(_082_),
    .B1(_121_),
    .B2(_077_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__mux2_1 _235_ (.A0(net8),
    .A1(\cpu_core.mem_read_req ),
    .S(\cpu_core.meow_inst.state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__o21ai_2 _236_ (.A1(net8),
    .A2(\cpu_core.meow_inst.state[0] ),
    .B1(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_124_));
 sky130_fd_sc_hd__o31ai_2 _237_ (.A1(\cpu_core.meow_inst.bit_cnt[4] ),
    .A2(_075_),
    .A3(_080_),
    .B1(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__o211a_2 _238_ (.A1(\cpu_core.meow_inst.bit_cnt[4] ),
    .A2(_080_),
    .B1(_084_),
    .C1(net7),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__mux2_1 _239_ (.A0(_125_),
    .A1(_126_),
    .S(\cpu_core.meow_inst.bit_cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__inv_2 _240_ (.A(_127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__o21ai_2 _241_ (.A1(\cpu_core.meow_inst.bit_cnt[0] ),
    .A2(_125_),
    .B1(net101),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__or3_2 _242_ (.A(\cpu_core.meow_inst.bit_cnt[0] ),
    .B(\cpu_core.meow_inst.bit_cnt[1] ),
    .C(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__nor2_2 _243_ (.A(net7),
    .B(_082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__o211ai_2 _244_ (.A1(net7),
    .A2(_082_),
    .B1(net102),
    .C1(_129_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_039_));
 sky130_fd_sc_hd__a21oi_2 _245_ (.A1(net8),
    .A2(_079_),
    .B1(_125_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_131_));
 sky130_fd_sc_hd__a21o_2 _246_ (.A1(net58),
    .A2(_129_),
    .B1(_131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__or4b_2 _247_ (.A(_075_),
    .B(_083_),
    .C(_079_),
    .D_N(\cpu_core.meow_inst.bit_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__o21a_2 _248_ (.A1(net96),
    .A2(_131_),
    .B1(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__or2_2 _249_ (.A(_080_),
    .B(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__a21o_2 _250_ (.A1(net110),
    .A2(_133_),
    .B1(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__a22o_2 _251_ (.A1(net85),
    .A2(_124_),
    .B1(_130_),
    .B2(net114),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__mux2_1 _252_ (.A0(\cpu_core.mem_addr[1] ),
    .A1(\cpu_core.meow_inst.tx_shift[0] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__mux2_1 _253_ (.A0(net69),
    .A1(_134_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__mux2_1 _254_ (.A0(\cpu_core.mem_addr[2] ),
    .A1(\cpu_core.meow_inst.tx_shift[1] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__mux2_1 _255_ (.A0(net65),
    .A1(_135_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__mux2_1 _256_ (.A0(\cpu_core.mem_addr[3] ),
    .A1(\cpu_core.meow_inst.tx_shift[2] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__mux2_1 _257_ (.A0(net70),
    .A1(_136_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__mux2_1 _258_ (.A0(\cpu_core.mem_addr[4] ),
    .A1(\cpu_core.meow_inst.tx_shift[3] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__mux2_1 _259_ (.A0(net77),
    .A1(_137_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__mux2_1 _260_ (.A0(\cpu_core.mem_addr[5] ),
    .A1(\cpu_core.meow_inst.tx_shift[4] ),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__mux2_1 _261_ (.A0(net54),
    .A1(_138_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__mux2_1 _262_ (.A0(\cpu_core.mem_addr[6] ),
    .A1(\cpu_core.meow_inst.tx_shift[5] ),
    .S(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__mux2_1 _263_ (.A0(net61),
    .A1(_139_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_049_));
 sky130_fd_sc_hd__mux2_1 _264_ (.A0(\cpu_core.mem_addr[7] ),
    .A1(\cpu_core.meow_inst.tx_shift[6] ),
    .S(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__mux2_1 _265_ (.A0(net81),
    .A1(_140_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__mux2_1 _266_ (.A0(\cpu_core.mem_addr[8] ),
    .A1(\cpu_core.meow_inst.tx_shift[7] ),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__mux2_1 _267_ (.A0(net55),
    .A1(_141_),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__mux2_1 _268_ (.A0(\cpu_core.mem_addr[9] ),
    .A1(\cpu_core.meow_inst.tx_shift[8] ),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__mux2_1 _269_ (.A0(net50),
    .A1(_142_),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__mux2_1 _270_ (.A0(\cpu_core.mem_addr[10] ),
    .A1(\cpu_core.meow_inst.tx_shift[9] ),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__mux2_1 _271_ (.A0(net57),
    .A1(_143_),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__mux2_1 _272_ (.A0(\cpu_core.mem_addr[11] ),
    .A1(\cpu_core.meow_inst.tx_shift[10] ),
    .S(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__mux2_1 _273_ (.A0(net76),
    .A1(_144_),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__mux2_1 _274_ (.A0(\cpu_core.mem_addr[12] ),
    .A1(\cpu_core.meow_inst.tx_shift[11] ),
    .S(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_145_));
 sky130_fd_sc_hd__mux2_1 _275_ (.A0(net53),
    .A1(_145_),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__mux2_1 _276_ (.A0(\cpu_core.mem_addr[13] ),
    .A1(\cpu_core.meow_inst.tx_shift[12] ),
    .S(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_146_));
 sky130_fd_sc_hd__mux2_1 _277_ (.A0(net64),
    .A1(_146_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__mux2_1 _278_ (.A0(\cpu_core.mem_addr[14] ),
    .A1(\cpu_core.meow_inst.tx_shift[13] ),
    .S(\cpu_core.meow_inst.state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__mux2_1 _279_ (.A0(net84),
    .A1(_147_),
    .S(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__a32o_2 _280_ (.A1(net8),
    .A2(\cpu_core.meow_inst.tx_shift[14] ),
    .A3(_084_),
    .B1(_124_),
    .B2(net78),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__mux2_1 _281_ (.A0(net66),
    .A1(net2),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__mux2_1 _282_ (.A0(net93),
    .A1(net66),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__mux2_1 _283_ (.A0(\cpu_core.meow_inst.rx_shift[2] ),
    .A1(net93),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__mux2_1 _284_ (.A0(net98),
    .A1(\cpu_core.meow_inst.rx_shift[2] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__mux2_1 _285_ (.A0(net59),
    .A1(\cpu_core.meow_inst.rx_shift[3] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__mux2_1 _286_ (.A0(net75),
    .A1(net59),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__mux2_1 _287_ (.A0(net80),
    .A1(net75),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__mux2_1 _288_ (.A0(net62),
    .A1(\cpu_core.meow_inst.rx_shift[6] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__mux2_1 _289_ (.A0(net73),
    .A1(net62),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_067_));
 sky130_fd_sc_hd__mux2_1 _290_ (.A0(\cpu_core.meow_inst.rx_shift[9] ),
    .A1(net73),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__mux2_1 _291_ (.A0(net71),
    .A1(\cpu_core.meow_inst.rx_shift[9] ),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__mux2_1 _292_ (.A0(net56),
    .A1(net71),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__mux2_1 _293_ (.A0(net45),
    .A1(net56),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _294_ (.A0(net43),
    ...
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__mux2_1 _295_ (.A0(\cpu_core.meow_inst.rx_shift[14] ),
    .A1(net43),
    .S(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__mux2_1 _296_ (.A0(net46),
    .A1(\cpu_core.meow_inst.rx_shift[14] ),
    .S(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__dfrtp_2 _297_ (.CLK(clknet_4_4_0_clk),
    .D(_003_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[0] ));
 sky130_fd_sc_hd__dfrtp_2 _298_ (.CLK(clknet_4_1_0_clk),
    .D(_004_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[1] ));
 sky130_fd_sc_hd__dfrtp_2 _299_ (.CLK(clknet_4_1_0_clk),
    .D(_005_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[2] ));
 sky130_fd_sc_hd__dfrtp_2 _300_ (.CLK(clknet_4_0_0_clk),
    .D(_006_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[3] ));
 sky130_fd_sc_hd__dfrtp_2 _301_ (.CLK(clknet_4_1_0_clk),
    .D(_007_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[4] ));
 sky130_fd_sc_hd__dfrtp_2 _302_ (.CLK(clknet_4_2_0_clk),
    .D(_008_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[5] ));
 sky130_fd_sc_hd__dfrtp_2 _303_ (.CLK(clknet_4_2_0_clk),
    .D(_009_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[6] ));
 sky130_fd_sc_hd__dfrtp_2 _304_ (.CLK(clknet_4_2_0_clk),
    .D(_010_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[7] ));
 sky130_fd_sc_hd__dfrtp_2 _305_ (.CLK(clknet_4_8_0_clk),
    .D(_011_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[8] ));
 sky130_fd_sc_hd__dfrtp_2 _306_ (.CLK(clknet_4_8_0_clk),
    .D(_012_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[9] ));
 sky130_fd_sc_hd__dfrtp_2 _307_ (.CLK(clknet_4_8_0_clk),
    .D(_013_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[10] ));
 sky130_fd_sc_hd__dfrtp_2 _308_ (.CLK(clknet_4_9_0_clk),
    .D(_014_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[11] ));
 sky130_fd_sc_hd__dfrtp_2 _309_ (.CLK(clknet_4_3_0_clk),
    .D(_015_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[12] ));
 sky130_fd_sc_hd__dfrtp_2 _310_ (.CLK(clknet_4_3_0_clk),
    .D(_016_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[13] ));
 sky130_fd_sc_hd__dfrtp_2 _311_ (.CLK(clknet_4_3_0_clk),
    .D(_017_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_addr[14] ));
 sky130_fd_sc_hd__dfrtp_2 _312_ (.CLK(clknet_4_13_0_clk),
    .D(net49),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\cpu_core.ir[0] ));
 sky130_fd_sc_hd__dfrtp_2 _313_ (.CLK(clknet_4_13_0_clk),
    .D(net68),
    .RESET_B(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\cpu_core.ir[1] ));
 sky130_fd_sc_hd__dfrtp_2 _314_ (.CLK(clknet_4_13_0_clk),
    .D(_020_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\cpu_core.ir[2] ));
 sky130_fd_sc_hd__dfrtp_2 _315_ (.CLK(clknet_4_13_0_clk),
    .D(_021_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\cpu_core.ir[3] ));
 sky130_fd_sc_hd__dfrtp_2 _316_ (.CLK(clknet_4_12_0_clk),
    .D(net52),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\cpu_core.ir[15] ));
 sky130_fd_sc_hd__dfrtp_2 _317_ (.CLK(clknet_4_6_0_clk),
    .D(_023_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.mem_read_req ));
 sky130_fd_sc_hd__dfrtp_2 _318_ (.CLK(clknet_4_13_0_clk),
    .D(_024_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[4]));
 sky130_fd_sc_hd__dfrtp_2 _319_ (.CLK(clknet_4_7_0_clk),
    .D(_025_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfrtp_2 _320_ (.CLK(clknet_4_12_0_clk),
    .D(_026_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfrtp_2 _321_ (.CLK(clknet_4_9_0_clk),
    .D(_027_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.exec_cycle[0] ));
 sky130_fd_sc_hd__dfrtp_2 _322_ (.CLK(clknet_4_12_0_clk),
    .D(_028_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.exec_cycle[1] ));
 sky130_fd_sc_hd__dfstp_2 _323_ (.CLK(clknet_4_7_0_clk),
    .D(_029_),
    .SET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.spi_cs_n ));
 sky130_fd_sc_hd__dfrtp_2 _324_ (.CLK(clknet_4_7_0_clk),
    .D(_030_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _325_ (.CLK(clknet_4_7_0_clk),
    .D(_031_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _326_ (.CLK(clknet_4_15_0_clk),
    .D(_032_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _327_ (.CLK(clknet_4_15_0_clk),
    .D(net92),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _328_ (.CLK(clknet_4_14_0_clk),
    .D(net87),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _329_ (.CLK(clknet_4_14_0_clk),
    .D(net89),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _330_ (.CLK(clknet_4_12_0_clk),
    .D(_036_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _331_ (.CLK(clknet_4_6_0_clk),
    .D(_037_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_busy ));
 sky130_fd_sc_hd__dfrtp_2 _332_ (.CLK(clknet_4_5_0_clk),
    .D(_038_),
    .RESET_B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.bit_cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _333_ (.CLK(clknet_4_5_0_clk),
    .D(_039_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.bit_cnt[1] ));
 sky130_fd_sc_hd__dfrtp_2 _334_ (.CLK(clknet_4_5_0_clk),
    .D(_040_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.bit_cnt[2] ));
 sky130_fd_sc_hd__dfrtp_2 _335_ (.CLK(clknet_4_5_0_clk),
    .D(_041_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.bit_cnt[3] ));
 sky130_fd_sc_hd__dfrtp_2 _336_ (.CLK(clknet_4_4_0_clk),
    .D(_042_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.bit_cnt[4] ));
 sky130_fd_sc_hd__dfrtp_2 _337_ (.CLK(clknet_4_4_0_clk),
    .D(_043_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[0] ));
 sky130_fd_sc_hd__dfrtp_2 _338_ (.CLK(clknet_4_1_0_clk),
    .D(_044_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[1] ));
 sky130_fd_sc_hd__dfrtp_2 _339_ (.CLK(clknet_4_0_0_clk),
    .D(_045_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[2] ));
 sky130_fd_sc_hd__dfrtp_2 _340_ (.CLK(clknet_4_0_0_clk),
    .D(_046_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[3] ));
 sky130_fd_sc_hd__dfrtp_2 _341_ (.CLK(clknet_4_0_0_clk),
    .D(_047_),
    .RESET_B(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[4] ));
 sky130_fd_sc_hd__dfrtp_2 _342_ (.CLK(clknet_4_0_0_clk),
    .D(_048_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[5] ));
 sky130_fd_sc_hd__dfrtp_2 _343_ (.CLK(clknet_4_2_0_clk),
    .D(_049_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[6] ));
 sky130_fd_sc_hd__dfrtp_2 _344_ (.CLK(clknet_4_2_0_clk),
    .D(_050_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[7] ));
 sky130_fd_sc_hd__dfrtp_2 _345_ (.CLK(clknet_4_8_0_clk),
    .D(_051_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[8] ));
 sky130_fd_sc_hd__dfrtp_2 _346_ (.CLK(clknet_4_8_0_clk),
    .D(_052_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[9] ));
 sky130_fd_sc_hd__dfrtp_2 _347_ (.CLK(clknet_4_9_0_clk),
    .D(_053_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[10] ));
 sky130_fd_sc_hd__dfrtp_2 _348_ (.CLK(clknet_4_9_0_clk),
    .D(_054_),
    .RESET_B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[11] ));
 sky130_fd_sc_hd__dfrtp_2 _349_ (.CLK(clknet_4_3_0_clk),
    .D(_055_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[12] ));
 sky130_fd_sc_hd__dfrtp_2 _350_ (.CLK(clknet_4_6_0_clk),
    .D(_056_),
    .RESET_B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[13] ));
 sky130_fd_sc_hd__dfrtp_2 _351_ (.CLK(clknet_4_1_0_clk),
    .D(_057_),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[14] ));
 sky130_fd_sc_hd__dfrtp_2 _352_ (.CLK(clknet_4_6_0_clk),
    .D(net79),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.tx_shift[15] ));
 sky130_fd_sc_hd__dfrtp_2 _353_ (.CLK(clknet_4_15_0_clk),
    .D(_059_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[0] ));
 sky130_fd_sc_hd__dfrtp_2 _354_ (.CLK(clknet_4_15_0_clk),
    .D(_060_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[1] ));
 sky130_fd_sc_hd__dfrtp_2 _355_ (.CLK(clknet_4_14_0_clk),
    .D(net94),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[2] ));
 sky130_fd_sc_hd__dfrtp_2 _356_ (.CLK(clknet_4_14_0_clk),
    .D(net99),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[3] ));
 sky130_fd_sc_hd__dfrtp_2 _357_ (.CLK(clknet_4_14_0_clk),
    .D(net60),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[4] ));
 sky130_fd_sc_hd__dfrtp_2 _358_ (.CLK(clknet_4_11_0_clk),
    .D(_064_),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[5] ));
 sky130_fd_sc_hd__dfrtp_2 _359_ (.CLK(clknet_4_11_0_clk),
    .D(_065_),
    .RESET_B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[6] ));
 sky130_fd_sc_hd__dfrtp_2 _360_ (.CLK(clknet_4_11_0_clk),
    .D(net63),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[7] ));
 sky130_fd_sc_hd__dfrtp_2 _361_ (.CLK(clknet_4_10_0_clk),
    .D(_067_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[8] ));
 sky130_fd_sc_hd__dfrtp_2 _362_ (.CLK(clknet_4_10_0_clk),
    .D(net74),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[9] ));
 sky130_fd_sc_hd__dfrtp_2 _363_ (.CLK(clknet_4_10_0_clk),
    .D(net72),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[10] ));
 sky130_fd_sc_hd__dfrtp_2 _364_ (.CLK(clknet_4_10_0_clk),
    .D(_070_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[11] ));
 sky130_fd_sc_hd__dfrtp_2 _365_ (.CLK(clknet_4_10_0_clk),
    .D(_071_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[12] ));
 sky130_fd_sc_hd__dfrtp_2 _366_ (.CLK(clknet_4_11_0_clk),
    .D(_072_),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[13] ));
 sky130_fd_sc_hd__dfrtp_2 _367_ (.CLK(clknet_4_9_0_clk),
    .D(net44),
    .RESET_B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[14] ));
 sky130_fd_sc_hd__dfrtp_2 _368_ (.CLK(clknet_4_12_0_clk),
    .D(net47),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.rx_shift[15] ));
 sky130_fd_sc_hd__dfstp_2 _369_ (.CLK(clknet_4_6_0_clk),
    .D(_001_),
    .SET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _370_ (.CLK(clknet_4_5_0_clk),
    .D(net39),
    .RESET_B(net17),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _371_ (.CLK(clknet_4_4_0_clk),
    .D(_002_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.state[2] ));
 sky130_fd_sc_hd__dfrtp_2 _372_ (.CLK(clknet_4_4_0_clk),
    .D(_000_),
    .RESET_B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\cpu_core.meow_inst.state[3] ));
 sky130_fd_sc_hd__buf_2 _386_ (.A(\cpu_core.meow_inst.spi_cs_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[0]));
 sky130_fd_sc_hd__buf_2 _387_ (.A(\cpu_core.meow_inst.spi_mosi ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__buf_2 _388_ (.A(\cpu_core.meow_inst.spi_sck ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[3]));
 sky130_fd_sc_hd__buf_2 _389_ (.A(\cpu_core.ir[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _390_ (.A(\cpu_core.ir[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _391_ (.A(\cpu_core.ir[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _392_ (.A(\cpu_core.ir[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(net11),
    ...
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout11 (.A(\cpu_core.meow_inst.state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(net26),
    ...
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(net26),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout3 (.A(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout4 (.A(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout5 (.A(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout7 (.A(net8),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout8 (.A(\cpu_core.meow_inst.state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(net11),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold100 (.A(\cpu_core.mem_addr[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net100));
 sky130_fd_sc_hd__dlygate4sd3_1 hold101 (.A(\cpu_core.meow_inst.bit_cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net101));
 sky130_fd_sc_hd__dlygate4sd3_1 hold102 (.A(_128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net102));
 sky130_fd_sc_hd__dlygate4sd3_1 hold103 (.A(\cpu_core.mem_addr[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net103));
 sky130_fd_sc_hd__dlygate4sd3_1 hold104 (.A(\cpu_core.mem_addr[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net104));
 sky130_fd_sc_hd__dlygate4sd3_1 hold105 (.A(\cpu_core.mem_addr[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net105));
 sky130_fd_sc_hd__dlygate4sd3_1 hold106 (.A(\cpu_core.meow_inst.spi_cs_n ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net106));
 sky130_fd_sc_hd__dlygate4sd3_1 hold107 (.A(\cpu_core.mem_addr[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net107));
 sky130_fd_sc_hd__dlygate4sd3_1 hold108 (.A(\cpu_core.ir[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net108));
 sky130_fd_sc_hd__dlygate4sd3_1 hold109 (.A(\cpu_core.mem_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net109));
 sky130_fd_sc_hd__dlygate4sd3_1 hold110 (.A(\cpu_core.meow_inst.bit_cnt[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net110));
 sky130_fd_sc_hd__dlygate4sd3_1 hold111 (.A(\cpu_core.mem_addr[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net111));
 sky130_fd_sc_hd__dlygate4sd3_1 hold112 (.A(\cpu_core.exec_cycle[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net112));
 sky130_fd_sc_hd__dlygate4sd3_1 hold113 (.A(\cpu_core.exec_cycle[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net113));
 sky130_fd_sc_hd__dlygate4sd3_1 hold114 (.A(\cpu_core.mem_addr[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net114));
 sky130_fd_sc_hd__dlygate4sd3_1 hold39 (.A(\cpu_core.meow_inst.state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd3_1 hold40 (.A(\cpu_core.meow_busy ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd3_1 hold41 (.A(\cpu_core.meow_inst.spi_sck ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd3_1 hold42 (.A(\cpu_core.mem_addr[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd3_1 hold43 (.A(\cpu_core.meow_inst.rx_shift[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd3_1 hold44 (.A(_073_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\cpu_core.meow_inst.rx_shift[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\cpu_core.meow_inst.rx_shift[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(_074_),
    ...
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\cpu_core.mem_data_in[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(_018_),
    ...
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\cpu_core.meow_inst.tx_shift[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\cpu_core.mem_data_in[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(_022_),
    ...
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\cpu_core.meow_inst.tx_shift[12] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\cpu_core.meow_inst.tx_shift[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\cpu_core.meow_inst.tx_shift[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\cpu_core.meow_inst.rx_shift[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\cpu_core.meow_inst.tx_shift[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\cpu_core.meow_inst.bit_cnt[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\cpu_core.meow_inst.rx_shift[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\cpu_core.meow_inst.tx_shift[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\cpu_core.meow_inst.rx_shift[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\cpu_core.meow_inst.tx_shift[13] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\cpu_core.meow_inst.tx_shift[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\cpu_core.meow_inst.rx_shift[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(\cpu_core.ir[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\cpu_core.meow_inst.tx_shift[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\cpu_core.meow_inst.tx_shift[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(\cpu_core.meow_inst.rx_shift[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(_069_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\cpu_core.meow_inst.rx_shift[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(_068_),
    ...
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\cpu_core.meow_inst.rx_shift[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\cpu_core.meow_inst.tx_shift[11] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\cpu_core.meow_inst.tx_shift[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\cpu_core.meow_inst.tx_shift[15] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\cpu_core.meow_inst.rx_shift[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\cpu_core.meow_inst.tx_shift[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\cpu_core.meow_inst.spi_mosi ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\cpu_core.mem_addr[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\cpu_core.meow_inst.tx_shift[14] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(\cpu_core.meow_inst.tx_shift[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(\cpu_core.mem_data_in[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__dlygate4sd3_1 hold87 (.A(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\cpu_core.mem_data_in[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(_035_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\cpu_core.ir[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net90));
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(\cpu_core.mem_data_in[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(_033_),
    ...
    .VPWR(VPWR),
    .X(net92));
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\cpu_core.meow_inst.rx_shift[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\cpu_core.ir[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\cpu_core.meow_inst.bit_cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold97 (.A(\cpu_core.mem_addr[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold98 (.A(\cpu_core.meow_inst.rx_shift[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net98));
 sky130_fd_sc_hd__dlygate4sd3_1 hold99 (.A(_062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input1 (.A(rst_n),
    ...
    .VPWR(VPWR),
    .X(net1));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input2 (.A(uio_in[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew25 (.A(net24),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net36));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net37));
 sky130_fd_sc_hd__conb_1 tt_um_ahlana_nova_cpu_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net38));
 sky130_fd_sc_hd__clkbuf_4 wire13 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkbuf_4 wire19 (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),

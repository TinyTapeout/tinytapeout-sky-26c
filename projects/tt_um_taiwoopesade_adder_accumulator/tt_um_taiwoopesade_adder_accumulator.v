module tt_um_taiwoopesade_adder_accumulator (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 wire net14;
 wire net15;
 wire \bits[0].accbit.add_or_load ;
 wire \bits[0].accbit.next ;
 wire \bits[0].accbit.q ;
 wire \bits[0].accbit.rst_high ;
 wire \bits[0].accbit.sum ;
 wire \bits[0].accbit.unused_notq ;
 wire \bits[0].fa.cout ;
 wire \bits[0].fa.g1 ;
 wire \bits[0].fa.g2 ;
 wire \bits[0].fa.p ;
 wire \bits[1].accbit.add_or_load ;
 wire \bits[1].accbit.next ;
 wire \bits[1].accbit.q ;
 wire \bits[1].accbit.sum ;
 wire \bits[1].accbit.unused_notq ;
 wire \bits[1].fa.cout ;
 wire \bits[1].fa.g1 ;
 wire \bits[1].fa.g2 ;
 wire \bits[1].fa.p ;
 wire \bits[2].accbit.add_or_load ;
 wire \bits[2].accbit.next ;
 wire \bits[2].accbit.q ;
 wire \bits[2].accbit.sum ;
 wire \bits[2].accbit.unused_notq ;
 wire \bits[2].fa.cout ;
 wire \bits[2].fa.g1 ;
 wire \bits[2].fa.g2 ;
 wire \bits[2].fa.p ;
 wire \bits[3].accbit.add_or_load ;
 wire \bits[3].accbit.next ;
 wire \bits[3].accbit.q ;
 wire \bits[3].accbit.sum ;
 wire \bits[3].accbit.unused_notq ;
 wire \bits[3].fa.cout ;
 wire \bits[3].fa.g1 ;
 wire \bits[3].fa.g2 ;
 wire \bits[3].fa.p ;
 wire carry_add_or_load;
 wire carry_flag;
 wire carry_next;
 wire or_01;
 wire or_23;
 ...
 wire net30;
 wire net31;
 wire unused_carry_notq;
 wire net32;
 wire clknet_0_clk;
 wire zero;
 wire \bits[0].accbit.reg_bit/_0_ ;
 wire \bits[1].accbit.reg_bit/_0_ ;
 wire \bits[2].accbit.reg_bit/_0_ ;
 wire \bits[3].accbit.reg_bit/_0_ ;
 wire \carry_reg/_0_ ;
 wire net;
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_2 _34_ (.A(\bits[0].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _35_ (.A(\bits[1].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _36_ (.A(\bits[2].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _37_ (.A(\bits[3].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _38_ (.A(carry_flag),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _39_ (.A(zero),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__mux2_1 \bits[0].accbit.mux_clr/_0_  (.A0(\bits[0].accbit.add_or_load ),
    .A1(net),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[0].accbit.next ));
 sky130_fd_sc_hd__conb_1 \bits[0].accbit.mux_clr/_0__8  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__mux2_1 \bits[0].accbit.mux_mode/_0_  (.A0(\bits[0].accbit.sum ),
    .A1(net2),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[0].accbit.add_or_load ));
 sky130_fd_sc_hd__inv_2 \bits[0].accbit.reg_bit/_1_  (.A(\bits[0].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[0].accbit.unused_notq ));
 sky130_fd_sc_hd__inv_2 \bits[0].accbit.reg_bit/_2_  (.A(\bits[0].accbit.rst_high ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[0].accbit.reg_bit/_0_ ));
 sky130_fd_sc_hd__dfrtp_2 \bits[0].accbit.reg_bit/_3_  (.CLK(clknet_1_0__leaf_clk),
    .D(\bits[0].accbit.next ),
    .RESET_B(\bits[0].accbit.reg_bit/_0_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bits[0].accbit.q ));
 sky130_fd_sc_hd__and2_2 \bits[0].fa.and_g1/_0_  (.A(net2),
    .B(\bits[0].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[0].fa.g1 ));
 sky130_fd_sc_hd__and2_2 \bits[0].fa.and_g2/_0_  (.A(net8),
    .B(\bits[0].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[0].fa.g2 ));
 sky130_fd_sc_hd__conb_1 \bits[0].fa.and_g2/_0__9  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net8));
 sky130_fd_sc_hd__or2_2 \bits[0].fa.or_cout/_0_  (.A(\bits[0].fa.g2 ),
    .B(\bits[0].fa.g1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[0].fa.cout ));
 sky130_fd_sc_hd__xor2_2 \bits[0].fa.xor_p/_0_  (.A(net2),
    .B(\bits[0].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[0].fa.p ));
 sky130_fd_sc_hd__xor2_2 \bits[0].fa.xor_sum/_0_  (.A(net9),
    .B(\bits[0].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[0].accbit.sum ));
 sky130_fd_sc_hd__conb_1 \bits[0].fa.xor_sum/_0__10  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net9));
 sky130_fd_sc_hd__mux2_1 \bits[1].accbit.mux_clr/_0_  (.A0(\bits[1].accbit.add_or_load ),
    .A1(net10),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[1].accbit.next ));
 sky130_fd_sc_hd__conb_1 \bits[1].accbit.mux_clr/_0__11  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net10));
 sky130_fd_sc_hd__mux2_1 \bits[1].accbit.mux_mode/_0_  (.A0(\bits[1].accbit.sum ),
    .A1(net3),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[1].accbit.add_or_load ));
 sky130_fd_sc_hd__inv_2 \bits[1].accbit.reg_bit/_1_  (.A(\bits[1].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[1].accbit.unused_notq ));
 sky130_fd_sc_hd__inv_2 \bits[1].accbit.reg_bit/_2_  (.A(\bits[0].accbit.rst_high ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[1].accbit.reg_bit/_0_ ));
 sky130_fd_sc_hd__dfrtp_2 \bits[1].accbit.reg_bit/_3_  (.CLK(clknet_1_1__leaf_clk),
    .D(\bits[1].accbit.next ),
    .RESET_B(\bits[1].accbit.reg_bit/_0_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bits[1].accbit.q ));
 sky130_fd_sc_hd__and2_2 \bits[1].fa.and_g1/_0_  (.A(net3),
    .B(\bits[1].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[1].fa.g1 ));
 sky130_fd_sc_hd__and2_2 \bits[1].fa.and_g2/_0_  (.A(\bits[0].fa.cout ),
    .B(\bits[1].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[1].fa.g2 ));
 sky130_fd_sc_hd__or2_2 \bits[1].fa.or_cout/_0_  (.A(\bits[1].fa.g2 ),
    .B(\bits[1].fa.g1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[1].fa.cout ));
 sky130_fd_sc_hd__xor2_2 \bits[1].fa.xor_p/_0_  (.A(net3),
    .B(\bits[1].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[1].fa.p ));
 sky130_fd_sc_hd__xor2_2 \bits[1].fa.xor_sum/_0_  (.A(\bits[0].fa.cout ),
    .B(\bits[1].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[1].accbit.sum ));
 sky130_fd_sc_hd__mux2_1 \bits[2].accbit.mux_clr/_0_  (.A0(\bits[2].accbit.add_or_load ),
    .A1(net11),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[2].accbit.next ));
 sky130_fd_sc_hd__conb_1 \bits[2].accbit.mux_clr/_0__12  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net11));
 sky130_fd_sc_hd__mux2_1 \bits[2].accbit.mux_mode/_0_  (.A0(\bits[2].accbit.sum ),
    .A1(net4),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[2].accbit.add_or_load ));
 sky130_fd_sc_hd__inv_2 \bits[2].accbit.reg_bit/_1_  (.A(\bits[2].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[2].accbit.unused_notq ));
 sky130_fd_sc_hd__inv_2 \bits[2].accbit.reg_bit/_2_  (.A(\bits[0].accbit.rst_high ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[2].accbit.reg_bit/_0_ ));
 sky130_fd_sc_hd__dfrtp_2 \bits[2].accbit.reg_bit/_3_  (.CLK(clknet_1_1__leaf_clk),
    .D(\bits[2].accbit.next ),
    .RESET_B(\bits[2].accbit.reg_bit/_0_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bits[2].accbit.q ));
 sky130_fd_sc_hd__and2_2 \bits[2].fa.and_g1/_0_  (.A(net4),
    .B(\bits[2].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[2].fa.g1 ));
 sky130_fd_sc_hd__and2_2 \bits[2].fa.and_g2/_0_  (.A(\bits[1].fa.cout ),
    .B(\bits[2].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[2].fa.g2 ));
 sky130_fd_sc_hd__or2_2 \bits[2].fa.or_cout/_0_  (.A(\bits[2].fa.g2 ),
    .B(\bits[2].fa.g1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[2].fa.cout ));
 sky130_fd_sc_hd__xor2_2 \bits[2].fa.xor_p/_0_  (.A(net4),
    .B(\bits[2].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[2].fa.p ));
 sky130_fd_sc_hd__xor2_2 \bits[2].fa.xor_sum/_0_  (.A(\bits[1].fa.cout ),
    .B(\bits[2].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[2].accbit.sum ));
 sky130_fd_sc_hd__mux2_1 \bits[3].accbit.mux_clr/_0_  (.A0(\bits[3].accbit.add_or_load ),
    .A1(net12),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[3].accbit.next ));
 sky130_fd_sc_hd__conb_1 \bits[3].accbit.mux_clr/_0__13  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net12));
 sky130_fd_sc_hd__mux2_1 \bits[3].accbit.mux_mode/_0_  (.A0(\bits[3].accbit.sum ),
    .A1(net5),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[3].accbit.add_or_load ));
 sky130_fd_sc_hd__inv_2 \bits[3].accbit.reg_bit/_1_  (.A(\bits[3].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[3].accbit.unused_notq ));
 sky130_fd_sc_hd__inv_2 \bits[3].accbit.reg_bit/_2_  (.A(\bits[0].accbit.rst_high ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[3].accbit.reg_bit/_0_ ));
 sky130_fd_sc_hd__dfrtp_2 \bits[3].accbit.reg_bit/_3_  (.CLK(clknet_1_0__leaf_clk),
    .D(\bits[3].accbit.next ),
    .RESET_B(\bits[3].accbit.reg_bit/_0_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\bits[3].accbit.q ));
 sky130_fd_sc_hd__and2_2 \bits[3].fa.and_g1/_0_  (.A(net5),
    .B(\bits[3].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[3].fa.g1 ));
 sky130_fd_sc_hd__and2_2 \bits[3].fa.and_g2/_0_  (.A(\bits[2].fa.cout ),
    .B(\bits[3].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[3].fa.g2 ));
 sky130_fd_sc_hd__or2_2 \bits[3].fa.or_cout/_0_  (.A(\bits[3].fa.g2 ),
    .B(\bits[3].fa.g1 ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[3].fa.cout ));
 sky130_fd_sc_hd__xor2_2 \bits[3].fa.xor_p/_0_  (.A(net5),
    .B(\bits[3].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[3].fa.p ));
 sky130_fd_sc_hd__xor2_2 \bits[3].fa.xor_sum/_0_  (.A(\bits[2].fa.cout ),
    .B(\bits[3].fa.p ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(\bits[3].accbit.sum ));
 sky130_fd_sc_hd__inv_2 \carry_reg/_1_  (.A(carry_flag),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(unused_carry_notq));
 sky130_fd_sc_hd__inv_2 \carry_reg/_2_  (.A(\bits[0].accbit.rst_high ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\carry_reg/_0_ ));
 sky130_fd_sc_hd__dfrtp_2 \carry_reg/_3_  (.CLK(clknet_1_0__leaf_clk),
    .D(carry_next),
    .RESET_B(\carry_reg/_0_ ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input7 (.A(ui_in[5]),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__mux2_1 \mux_carry_clr/_0_  (.A0(carry_add_or_load),
    .A1(net13),
    .S(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(carry_next));
 sky130_fd_sc_hd__conb_1 \mux_carry_clr/_0__14  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net13));
 sky130_fd_sc_hd__mux2_1 \mux_carry_mode/_0_  (.A0(\bits[3].fa.cout ),
    .A1(net14),
    .S(net6),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(carry_add_or_load));
 sky130_fd_sc_hd__conb_1 \mux_carry_mode/_0__15  (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net14));
 sky130_fd_sc_hd__inv_2 \not_rst/_0_  (.A(net1),
    ...
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(\bits[0].accbit.rst_high ));
 sky130_fd_sc_hd__inv_2 \not_zero/_0_  (.A(or_all),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(zero));
 sky130_fd_sc_hd__or2_2 \or_a/_0_  (.A(\bits[1].accbit.q ),
    .B(\bits[0].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(or_01));
 sky130_fd_sc_hd__or2_2 \or_b/_0_  (.A(\bits[3].accbit.q ),
    .B(\bits[2].accbit.q ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(or_23));
 sky130_fd_sc_hd__or2_2 \or_c/_0_  (.A(or_23),
    .B(or_01),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(or_all));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net15));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_16 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net16));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_17 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net17));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_18 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net18));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_19 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net19));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_20 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net20));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_21 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net21));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_22 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net22));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_23 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net23));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_24 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net24));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_25 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net25));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_taiwoopesade_adder_accumulator_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));

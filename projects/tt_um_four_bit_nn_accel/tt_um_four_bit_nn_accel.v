module tt_um_four_bit_nn_accel (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__inv_2 _228_ (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_176_));
 sky130_fd_sc_hd__inv_2 _229_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__inv_2 _230_ (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_178_));
 sky130_fd_sc_hd__inv_2 _231_ (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__inv_2 _232_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _233_ (.A(net11),
    ...
    .VPWR(VPWR),
    .Y(_181_));
 sky130_fd_sc_hd__o21ai_2 _234_ (.A1(net7),
    .A2(net6),
    .B1(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__a21oi_2 _235_ (.A1(net7),
    .A2(net6),
    .B1(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__a21o_2 _236_ (.A1(net7),
    .A2(net6),
    .B1(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__nand2_2 _237_ (.A(net18),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_185_));
 sky130_fd_sc_hd__nor2_2 _238_ (.A(_176_),
    .B(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__nand2_2 _239_ (.A(net7),
    .B(_177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__a21oi_2 _240_ (.A1(_185_),
    .A2(_186_),
    .B1(_184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_188_));
 sky130_fd_sc_hd__and3_2 _241_ (.A(\accumulator[0] ),
    .B(net18),
    .C(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a2bb2o_2 _242_ (.A1_N(_187_),
    .A2_N(_189_),
    .B1(_176_),
    .B2(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_190_));
 sky130_fd_sc_hd__o22a_2 _243_ (.A1(net45),
    .A2(_188_),
    .B1(_190_),
    .B2(_184_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__a21o_2 _244_ (.A1(net18),
    .A2(net13),
    .B1(\accumulator[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__nand3_2 _245_ (.A(\accumulator[1] ),
    .B(net18),
    .C(net13),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__nand4_2 _246_ (.A(net12),
    .B(net17),
    .C(_191_),
    .D(_192_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__a22o_2 _247_ (.A1(net12),
    .A2(net17),
    .B1(_191_),
    .B2(_192_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_194_));
 sky130_fd_sc_hd__and3_2 _248_ (.A(_189_),
    .B(_193_),
    .C(_194_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_195_));
 sky130_fd_sc_hd__a21oi_2 _249_ (.A1(_193_),
    .A2(_194_),
    .B1(_189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_196_));
 sky130_fd_sc_hd__nor2_2 _250_ (.A(_195_),
    .B(_196_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_197_));
 sky130_fd_sc_hd__a22o_2 _251_ (.A1(_176_),
    .A2(net17),
    .B1(_186_),
    .B2(_197_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__mux2_1 _252_ (.A0(net46),
    .A1(_198_),
    .S(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__a22o_2 _253_ (.A1(net17),
    .A2(net24),
    .B1(net25),
    .B2(net12),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_199_));
 sky130_fd_sc_hd__nand2_2 _254_ (.A(net24),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_200_));
 sky130_fd_sc_hd__and4_2 _255_ (.A(net12),
    .B(net17),
    .C(net24),
    .D(net25),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_201_));
 sky130_fd_sc_hd__nand4_2 _256_ (.A(net12),
    .B(net17),
    .C(net24),
    .D(net25),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_202_));
 sky130_fd_sc_hd__a21oi_2 _257_ (.A1(net8),
    .A2(net14),
    .B1(\accumulator[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_203_));
 sky130_fd_sc_hd__and3_2 _258_ (.A(\accumulator[2] ),
    .B(net8),
    .C(net14),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_204_));
 sky130_fd_sc_hd__nor2_2 _259_ (.A(_203_),
    .B(_204_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__and3_2 _260_ (.A(_199_),
    .B(_202_),
    .C(_205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_206_));
 sky130_fd_sc_hd__a21oi_2 _261_ (.A1(_199_),
    .A2(_202_),
    .B1(_205_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_207_));
 sky130_fd_sc_hd__or2_2 _262_ (.A(_206_),
    .B(_207_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__nand2_2 _263_ (.A(_192_),
    .B(_193_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_209_));
 sky130_fd_sc_hd__and2b_2 _264_ (.A_N(_208_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_210_));
 sky130_fd_sc_hd__xnor2_2 _265_ (.A(_208_),
    .B(_209_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__nand2_2 _266_ (.A(_195_),
    .B(_211_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_2 _267_ (.A(_195_),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__a32o_2 _268_ (.A1(_186_),
    .A2(_212_),
    .A3(_213_),
    .B1(net25),
    .B2(_176_),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__mux2_1 _269_ (.A0(net49),
    .A1(_214_),
    .S(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__and2_2 _270_ (.A(net18),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__nand2_2 _271_ (.A(net18),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_216_));
 sky130_fd_sc_hd__nand2_2 _272_ (.A(net11),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_217_));
 sky130_fd_sc_hd__nand2_2 _273_ (.A(_181_),
    .B(_216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_218_));
 sky130_fd_sc_hd__nand2_2 _274_ (.A(_217_),
    .B(_218_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_219_));
 sky130_fd_sc_hd__xnor2_2 _275_ (.A(\accumulator[3] ),
    .B(_219_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_220_));
 sky130_fd_sc_hd__nand2_2 _276_ (.A(net9),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_221_));
 sky130_fd_sc_hd__and2b_2 _277_ (.A_N(net12),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_222_));
 sky130_fd_sc_hd__and3_2 _278_ (.A(net24),
    .B(net10),
    .C(_222_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_223_));
 sky130_fd_sc_hd__xnor2_2 _279_ (.A(_200_),
    .B(_222_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__xnor2_2 _280_ (.A(_221_),
    .B(_224_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_225_));
 sky130_fd_sc_hd__and2_2 _281_ (.A(_201_),
    .B(_225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_226_));
 sky130_fd_sc_hd__or2_2 _282_ (.A(_201_),
    .B(_225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_227_));
 sky130_fd_sc_hd__xnor2_2 _283_ (.A(_201_),
    .B(_225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_015_));
 sky130_fd_sc_hd__xnor2_2 _284_ (.A(_220_),
    .B(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_016_));
 sky130_fd_sc_hd__or2_2 _285_ (.A(_204_),
    .B(_206_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__nand2_2 _286_ (.A(_016_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_018_));
 sky130_fd_sc_hd__xor2_2 _287_ (.A(_016_),
    .B(_017_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__nand2_2 _288_ (.A(_210_),
    .B(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_020_));
 sky130_fd_sc_hd__xnor2_2 _289_ (.A(_210_),
    .B(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_021_));
 sky130_fd_sc_hd__xnor2_2 _290_ (.A(_212_),
    .B(_021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_022_));
 sky130_fd_sc_hd__o2bb2a_2 _291_ (.A1_N(_022_),
    .A2_N(_186_),
    .B1(net11),
    .B2(_177_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _292_ (.A0(\accumulator[3] ),
    .A1(_023_),
    .S(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a21bo_2 _293_ (.A1(\accumulator[3] ),
    .A2(_218_),
    .B1_N(_217_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__and3_2 _294_ (.A(\accumulator[4] ),
    .B(net18),
    .C(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__nor2_2 _295_ (.A(\accumulator[4] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__or2_2 _296_ (.A(_025_),
    .B(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__nand2_2 _297_ (.A(net17),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__and2b_2 _298_ (.A_N(net24),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__nand2_2 _299_ (.A(net25),
    .B(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__and3_2 _300_ (.A(net25),
    .B(net14),
    .C(_029_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__xnor2_2 _301_ (.A(_029_),
    .B(_030_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__xnor2_2 _302_ (.A(_028_),
    .B(_032_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__a31o_2 _303_ (.A1(net9),
    .A2(net14),
    .A3(_224_),
    .B1(_223_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__nand2_2 _304_ (.A(_033_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__nor2_2 _305_ (.A(_033_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__xor2_2 _306_ (.A(_033_),
    .B(_034_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__xnor2_2 _307_ (.A(_027_),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__a21o_2 _308_ (.A1(_220_),
    .A2(_227_),
    .B1(_226_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__and2_2 _309_ (.A(_038_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__xor2_2 _310_ (.A(_038_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_041_));
 sky130_fd_sc_hd__xnor2_2 _311_ (.A(_024_),
    .B(_041_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__nor2_2 _312_ (.A(_018_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_043_));
 sky130_fd_sc_hd__xor2_2 _313_ (.A(_018_),
    .B(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__o21ai_2 _314_ (.A1(_212_),
    .A2(_021_),
    .B1(_020_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_045_));
 sky130_fd_sc_hd__xor2_2 _315_ (.A(_044_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__o22a_2 _316_ (.A1(_177_),
    .A2(net12),
    .B1(_187_),
    .B2(_046_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__mux2_1 _317_ (.A0(\accumulator[4] ),
    .A1(_047_),
    .S(_183_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__and3_2 _318_ (.A(\accumulator[5] ),
    .B(net18),
    .C(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__inv_2 _319_ (.A(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__or2_2 _320_ (.A(\accumulator[5] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__nand2_2 _321_ (.A(_049_),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__nand2_2 _322_ (.A(net25),
    .B(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__and2b_2 _323_ (.A_N(net14),
    .B(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__and3_2 _324_ (.A(net25),
    .B(net23),
    .C(_053_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_054_));
 sky130_fd_sc_hd__xnor2_2 _325_ (.A(_052_),
    .B(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__xnor2_2 _326_ (.A(_028_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_056_));
 sky130_fd_sc_hd__a31o_2 _327_ (.A1(net17),
    .A2(net15),
    .A3(_032_),
    .B1(_031_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__and2_2 _328_ (.A(_056_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__xor2_2 _329_ (.A(_056_),
    .B(_057_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__xnor2_2 _330_ (.A(_051_),
    .B(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_060_));
 sky130_fd_sc_hd__o21a_2 _331_ (.A1(_027_),
    .A2(_036_),
    .B1(_035_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_061_));
 sky130_fd_sc_hd__and2b_2 _332_ (.A_N(_061_),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__xnor2_2 _333_ (.A(_060_),
    .B(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__xnor2_2 _334_ (.A(_025_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_064_));
 sky130_fd_sc_hd__a21oi_2 _335_ (.A1(_024_),
    .A2(_041_),
    .B1(_040_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__xor2_2 _336_ (.A(_064_),
    .B(_065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__a21oi_2 _337_ (.A1(_044_),
    .A2(_045_),
    .B1(_043_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__xnor2_2 _338_ (.A(_066_),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__o22a_2 _339_ (.A1(_177_),
    .A2(net24),
    .B1(_187_),
    .B2(_068_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__mux2_1 _340_ (.A0(net48),
    .A1(_069_),
    .S(net16),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__and3_2 _341_ (.A(\accumulator[6] ),
    .B(net18),
    .C(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__inv_2 _342_ (.A(_070_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__or2_2 _343_ (.A(\accumulator[6] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_072_));
 sky130_fd_sc_hd__nand2_2 _344_ (.A(_071_),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__o211a_2 _345_ (.A1(_181_),
    .A2(net23),
    .B1(_028_),
    .C1(_052_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__a31o_2 _346_ (.A1(net17),
    .A2(net23),
    .A3(_055_),
    .B1(_054_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__nand3_2 _347_ (.A(net17),
    .B(net25),
    .C(net23),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__a21oi_2 _348_ (.A1(_075_),
    .A2(_076_),
    .B1(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__xnor2_2 _349_ (.A(_073_),
    .B(_077_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_078_));
 sky130_fd_sc_hd__a31o_2 _350_ (.A1(_049_),
    .A2(_050_),
    .A3(_059_),
    .B1(_058_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__nand2_2 _351_ (.A(_078_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__xor2_2 _352_ (.A(_078_),
    .B(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__nand2_2 _353_ (.A(_048_),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__xnor2_2 _354_ (.A(_048_),
    .B(_081_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__a21oi_2 _355_ (.A1(_025_),
    .A2(_063_),
    .B1(_062_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__nor2_2 _356_ (.A(_083_),
    .B(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_085_));
 sky130_fd_sc_hd__inv_2 _357_ (.A(_085_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__nand2_2 _358_ (.A(_083_),
    .B(_084_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__nand2b_2 _359_ (.A_N(_085_),
    .B(_087_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__o22a_2 _360_ (.A1(_018_),
    .A2(_042_),
    .B1(_064_),
    .B2(_065_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__and3_2 _361_ (.A(_044_),
    .B(_045_),
    .C(_066_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__a21oi_2 _362_ (.A1(_064_),
    .A2(_065_),
    .B1(_089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__or2_2 _363_ (.A(_090_),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__o21bai_2 _364_ (.A1(_090_),
    .A2(_091_),
    .B1_N(_088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__xnor2_2 _365_ (.A(_088_),
    .B(_092_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_094_));
 sky130_fd_sc_hd__o22a_2 _366_ (.A1(_177_),
    .A2(net14),
    .B1(_187_),
    .B2(_094_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _367_ (.A0(net47),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__a21o_2 _368_ (.A1(net6),
    .A2(net15),
    .B1(_184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__o2bb2a_2 _369_ (.A1_N(_075_),
    .A2_N(_076_),
    .B1(_073_),
    .B2(_074_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__xnor2_2 _370_ (.A(\accumulator[7] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__and2b_2 _371_ (.A_N(_074_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__xnor2_2 _372_ (.A(_074_),
    .B(_098_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__nor2_2 _373_ (.A(_097_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_101_));
 sky130_fd_sc_hd__xnor2_2 _374_ (.A(_097_),
    .B(_100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_2 _375_ (.A(_071_),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__and2_2 _376_ (.A(_071_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_104_));
 sky130_fd_sc_hd__or2_2 _377_ (.A(_103_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__nand3_2 _378_ (.A(_080_),
    .B(_082_),
    .C(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__inv_2 _379_ (.A(_106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__a21oi_2 _380_ (.A1(_080_),
    .A2(_082_),
    .B1(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__a211o_2 _381_ (.A1(_086_),
    .A2(_093_),
    .B1(_107_),
    .C1(_108_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_109_));
 sky130_fd_sc_hd__o211ai_2 _382_ (.A1(_107_),
    .A2(_108_),
    .B1(_086_),
    .C1(_093_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__a31o_2 _383_ (.A1(_186_),
    .A2(_109_),
    .A3(_110_),
    .B1(_096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__o21a_2 _384_ (.A1(\accumulator[7] ),
    .A2(net16),
    .B1(_111_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__nand2_2 _385_ (.A(\accumulator[8] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__or2_2 _386_ (.A(\accumulator[8] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_113_));
 sky130_fd_sc_hd__and2_2 _387_ (.A(_112_),
    .B(_113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__xnor2_2 _388_ (.A(_099_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__or3b_2 _389_ (.A(_115_),
    .B(_216_),
    .C_N(\accumulator[7] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__a21bo_2 _390_ (.A1(\accumulator[7] ),
    .A2(_215_),
    .B1_N(_115_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__and2_2 _391_ (.A(_116_),
    .B(_117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__o21a_2 _392_ (.A1(_101_),
    .A2(_103_),
    .B1(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__nor3_2 _393_ (.A(_101_),
    .B(_103_),
    .C(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__nor2_2 _394_ (.A(_119_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__a21o_2 _395_ (.A1(_085_),
    .A2(_106_),
    .B1(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__a21o_2 _396_ (.A1(_087_),
    .A2(_106_),
    .B1(_108_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_123_));
 sky130_fd_sc_hd__o21a_2 _397_ (.A1(_092_),
    .A2(_122_),
    .B1(_123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__o311a_2 _398_ (.A1(_090_),
    .A2(_091_),
    .A3(_122_),
    .B1(_123_),
    .C1(_121_),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__nor2_2 _399_ (.A(_187_),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_126_));
 sky130_fd_sc_hd__o21a_2 _400_ (.A1(_121_),
    .A2(_124_),
    .B1(_126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__o22a_2 _401_ (.A1(\accumulator[8] ),
    .A2(net16),
    .B1(_096_),
    .B2(_127_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__xnor2_2 _402_ (.A(\accumulator[9] ),
    .B(_215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__nor2_2 _403_ (.A(_074_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__xnor2_2 _404_ (.A(_128_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__xor2_2 _405_ (.A(_112_),
    .B(_130_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__or3_2 _406_ (.A(_074_),
    .B(_098_),
    .C(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_132_));
 sky130_fd_sc_hd__a21oi_2 _407_ (.A1(_116_),
    .A2(_132_),
    .B1(_131_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__nand3_2 _408_ (.A(_116_),
    .B(_131_),
    .C(_132_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__and2b_2 _409_ (.A_N(_133_),
    .B(_134_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__or3_2 _410_ (.A(_119_),
    .B(_125_),
    .C(_135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__o21ai_2 _411_ (.A1(_119_),
    .A2(_125_),
    .B1(_135_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_137_));
 sky130_fd_sc_hd__a31o_2 _412_ (.A1(_186_),
    .A2(_136_),
    .A3(_137_),
    .B1(_096_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_138_));
 sky130_fd_sc_hd__o21a_2 _413_ (.A1(\accumulator[9] ),
    .A2(net16),
    .B1(_138_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__a21o_2 _414_ (.A1(_119_),
    .A2(_134_),
    .B1(_133_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__a21o_2 _415_ (.A1(_125_),
    .A2(_135_),
    .B1(_139_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_140_));
 sky130_fd_sc_hd__and3b_2 _416_ (.A_N(_074_),
    .B(_114_),
    .C(_128_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__a31o_2 _417_ (.A1(\accumulator[8] ),
    .A2(_215_),
    .A3(_130_),
    .B1(_141_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_142_));
 sky130_fd_sc_hd__a21o_2 _418_ (.A1(\accumulator[9] ),
    .A2(_216_),
    .B1(_074_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_143_));
 sky130_fd_sc_hd__o21a_2 _419_ (.A1(\accumulator[9] ),
    .A2(_216_),
    .B1(_143_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__xnor2_2 _420_ (.A(\accumulator[10] ),
    .B(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__nand2_2 _421_ (.A(_142_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__or2_2 _422_ (.A(_142_),
    .B(_145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__a221oi_2 _423_ (.A1(_125_),
    .A2(_135_),
    .B1(_146_),
    .B2(_147_),
    .C1(_139_),
    ...
    .VPWR(VPWR),
    .Y(_148_));
 sky130_fd_sc_hd__a311oi_2 _424_ (.A1(_140_),
    .A2(_146_),
    .A3(_147_),
    .B1(_148_),
    .C1(_187_),
    ...
    .VPWR(VPWR),
    .Y(_149_));
 sky130_fd_sc_hd__o22a_2 _425_ (.A1(\accumulator[10] ),
    .A2(net16),
    .B1(_096_),
    .B2(_149_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__or3b_2 _426_ (.A(_176_),
    .B(_177_),
    .C_N(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__or2_2 _427_ (.A(\accumulator[10] ),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__mux4_2 _428_ (.A0(\accumulator[4] ),
    .A1(\accumulator[5] ),
    .A2(\accumulator[6] ),
    .A3(\accumulator[7] ),
    .S0(net20),
    ...
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__and2_2 _429_ (.A(net20),
    .B(\accumulator[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__mux4_2 _430_ (.A0(\accumulator[6] ),
    .A1(\accumulator[7] ),
    .A2(\accumulator[8] ),
    .A3(\accumulator[9] ),
    .S0(net20),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__a21o_2 _431_ (.A1(_152_),
    .A2(_154_),
    .B1(_180_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_155_));
 sky130_fd_sc_hd__and2_2 _432_ (.A(\accumulator[7] ),
    .B(_178_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__mux4_2 _433_ (.A0(\accumulator[5] ),
    .A1(\accumulator[7] ),
    .A2(\accumulator[6] ),
    .A3(\accumulator[8] ),
    .S0(net19),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__mux4_2 _434_ (.A0(\accumulator[3] ),
    .A1(\accumulator[5] ),
    .A2(\accumulator[4] ),
    .A3(\accumulator[6] ),
    .S0(net19),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__o31a_2 _435_ (.A1(_152_),
    .A2(_154_),
    .A3(_158_),
    .B1(_180_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__mux4_2 _436_ (.A0(\accumulator[1] ),
    .A1(\accumulator[3] ),
    .A2(\accumulator[2] ),
    .A3(\accumulator[4] ),
    .S0(net4),
    ...
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__mux4_2 _437_ (.A0(\accumulator[0] ),
    .A1(\accumulator[1] ),
    .A2(\accumulator[2] ),
    .A3(\accumulator[3] ),
    .S0(net3),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__mux4_2 _438_ (.A0(\accumulator[2] ),
    .A1(\accumulator[3] ),
    .A2(\accumulator[4] ),
    .A3(\accumulator[5] ),
    .S0(net3),
    ...
    .VPWR(VPWR),
    .X(_162_));
 sky130_fd_sc_hd__inv_2 _439_ (.A(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__and3_2 _440_ (.A(_180_),
    .B(_160_),
    .C(_161_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__o31a_2 _441_ (.A1(\accumulator[8] ),
    .A2(_153_),
    .A3(_156_),
    .B1(_179_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_165_));
 sky130_fd_sc_hd__or3_2 _442_ (.A(net20),
    .B(net19),
    .C(net5),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_166_));
 sky130_fd_sc_hd__a221o_2 _443_ (.A1(_178_),
    .A2(\accumulator[9] ),
    .B1(_166_),
    .B2(\accumulator[10] ),
    .C1(_165_),
    ...
    .VPWR(VPWR),
    .X(_167_));
 sky130_fd_sc_hd__a211o_2 _444_ (.A1(_155_),
    .A2(_157_),
    .B1(_159_),
    .C1(_167_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__a21oi_2 _445_ (.A1(_162_),
    .A2(_164_),
    .B1(_168_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_169_));
 sky130_fd_sc_hd__a21bo_2 _446_ (.A1(net5),
    .A2(_152_),
    .B1_N(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__a21oi_2 _447_ (.A1(_180_),
    .A2(_161_),
    .B1(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_171_));
 sky130_fd_sc_hd__a2bb2o_2 _448_ (.A1_N(_171_),
    .A2_N(_151_),
    .B1(_150_),
    .B2(uo_out[0]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__a21bo_2 _449_ (.A1(net5),
    .A2(_157_),
    .B1_N(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__a21oi_2 _450_ (.A1(_180_),
    .A2(_160_),
    .B1(_172_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__a2bb2o_2 _451_ (.A1_N(_173_),
    .A2_N(_151_),
    .B1(_150_),
    .B2(uo_out[1]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__nand2_2 _452_ (.A(net5),
    .B(_154_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__o211a_2 _453_ (.A1(net5),
    .A2(_163_),
    .B1(_169_),
    .C1(_174_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__a2bb2o_2 _454_ (.A1_N(_175_),
    .A2_N(_151_),
    .B1(_150_),
    .B2(uo_out[2]),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__and2_2 _455_ (.A(uo_out[3]),
    .B(_150_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__dfrtp_2 _456_ (.CLK(clknet_1_1__leaf_clk),
    .D(_000_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[0] ));
 sky130_fd_sc_hd__dfrtp_2 _457_ (.CLK(clknet_1_1__leaf_clk),
    .D(_001_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[1] ));
 sky130_fd_sc_hd__dfrtp_2 _458_ (.CLK(clknet_1_1__leaf_clk),
    .D(_002_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[2] ));
 sky130_fd_sc_hd__dfrtp_2 _459_ (.CLK(clknet_1_1__leaf_clk),
    .D(_003_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[3] ));
 sky130_fd_sc_hd__dfrtp_2 _460_ (.CLK(clknet_1_1__leaf_clk),
    .D(_004_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[4] ));
 sky130_fd_sc_hd__dfrtp_2 _461_ (.CLK(clknet_1_1__leaf_clk),
    .D(_005_),
    .RESET_B(net22),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[5] ));
 sky130_fd_sc_hd__dfrtp_2 _462_ (.CLK(clknet_1_1__leaf_clk),
    .D(_006_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[6] ));
 sky130_fd_sc_hd__dfrtp_2 _463_ (.CLK(clknet_1_0__leaf_clk),
    .D(_007_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[7] ));
 sky130_fd_sc_hd__dfrtp_2 _464_ (.CLK(clknet_1_0__leaf_clk),
    .D(_008_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[8] ));
 sky130_fd_sc_hd__dfrtp_2 _465_ (.CLK(clknet_1_0__leaf_clk),
    .D(_009_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[9] ));
 sky130_fd_sc_hd__dfrtp_2 _466_ (.CLK(clknet_1_0__leaf_clk),
    .D(_010_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\accumulator[10] ));
 sky130_fd_sc_hd__dfrtp_2 _467_ (.CLK(clknet_1_0__leaf_clk),
    .D(_011_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _468_ (.CLK(clknet_1_0__leaf_clk),
    .D(_012_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _469_ (.CLK(clknet_1_0__leaf_clk),
    .D(_013_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _470_ (.CLK(clknet_1_0__leaf_clk),
    .D(_014_),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_1_1__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__dlygate4sd3_1 hold45 (.A(\accumulator[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd3_1 hold46 (.A(\accumulator[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__dlygate4sd3_1 hold47 (.A(\accumulator[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\accumulator[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\accumulator[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input6 (.A(ui_in[6]),
    ...
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input7 (.A(ui_in[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(uio_in[1]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_2 max_cap16 (.A(_183_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__buf_2 max_cap19 (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__buf_2 max_cap20 (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__buf_2 max_cap24 (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_26 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net26));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_27 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net27));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_28 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net28));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_29 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net29));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_30 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net30));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_31 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net31));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_32 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net32));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_four_bit_nn_accel_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));

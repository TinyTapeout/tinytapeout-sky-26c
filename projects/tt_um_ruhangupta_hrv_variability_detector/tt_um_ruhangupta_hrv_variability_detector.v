module tt_um_ruhangupta_hrv_variability_detector (clk,
    ena,
    rst_n,
    VPWR,
    VGND,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__and2b_2 _26_ (.A_N(uio_out[2]),
    .B(\cur_interval[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__nand2b_2 _27_ (.A_N(uio_out[2]),
    .B(\cur_interval[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_07_));
 sky130_fd_sc_hd__and2b_2 _28_ (.A_N(uio_out[1]),
    .B(\cur_interval[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_08_));
 sky130_fd_sc_hd__xnor2_2 _29_ (.A(uio_out[1]),
    .B(\cur_interval[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_09_));
 sky130_fd_sc_hd__nand2b_2 _30_ (.A_N(\cur_interval[0] ),
    .B(uio_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__nand2_2 _31_ (.A(_09_),
    .B(_10_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_11_));
 sky130_fd_sc_hd__a21oi_2 _32_ (.A1(_09_),
    .A2(_10_),
    .B1(_08_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_12_));
 sky130_fd_sc_hd__and2b_2 _33_ (.A_N(\cur_interval[2] ),
    .B(uio_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_13_));
 sky130_fd_sc_hd__o21a_2 _34_ (.A1(_12_),
    .A2(_13_),
    .B1(_07_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(sign));
 sky130_fd_sc_hd__and2b_2 _35_ (.A_N(uio_out[0]),
    .B(\cur_interval[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__nand2b_2 _36_ (.A_N(uio_out[0]),
    .B(\cur_interval[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _37_ (.A(_10_),
    ...
    .VPWR(VPWR),
    .Y(_16_));
 sky130_fd_sc_hd__o211a_2 _38_ (.A1(_12_),
    .A2(_13_),
    .B1(_16_),
    .C1(_07_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_17_));
 sky130_fd_sc_hd__or2_2 _39_ (.A(_09_),
    .B(_10_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_18_));
 sky130_fd_sc_hd__nand2_2 _40_ (.A(_11_),
    .B(_18_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_19_));
 sky130_fd_sc_hd__xnor2_2 _41_ (.A(_17_),
    .B(_19_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_20_));
 sky130_fd_sc_hd__mux2_1 _42_ (.A0(_06_),
    .A1(_13_),
    .S(_12_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_21_));
 sky130_fd_sc_hd__and3_2 _43_ (.A(_16_),
    .B(_20_),
    .C(_21_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(ge7));
 sky130_fd_sc_hd__or4_2 _44_ (.A(_06_),
    .B(_11_),
    .C(_13_),
    .D(_14_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(ge1));
 sky130_fd_sc_hd__a41o_2 _45_ (.A1(_09_),
    .A2(_10_),
    .A3(sign),
    .A4(_15_),
    .B1(_21_),
    ...
    .VPWR(VPWR),
    .X(ge4));
 sky130_fd_sc_hd__or2_2 _46_ (.A(_20_),
    .B(ge4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(ge2));
 sky130_fd_sc_hd__a21o_2 _47_ (.A1(_16_),
    .A2(_20_),
    .B1(ge4),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(ge3));
 sky130_fd_sc_hd__o21a_2 _48_ (.A1(_11_),
    .A2(_14_),
    .B1(_21_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(ge5));
 sky130_fd_sc_hd__and2_2 _49_ (.A(_20_),
    .B(ge4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(ge6));
 sky130_fd_sc_hd__nor2_2 _50_ (.A(net17),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_00_));
 sky130_fd_sc_hd__a21oi_2 _51_ (.A1(\cur_interval[1] ),
    .A2(\cur_interval[0] ),
    .B1(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_22_));
 sky130_fd_sc_hd__o21a_2 _52_ (.A1(\cur_interval[1] ),
    .A2(\cur_interval[0] ),
    .B1(_22_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_01_));
 sky130_fd_sc_hd__a21oi_2 _53_ (.A1(\cur_interval[1] ),
    .A2(\cur_interval[0] ),
    .B1(\cur_interval[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_23_));
 sky130_fd_sc_hd__a31o_2 _54_ (.A1(\cur_interval[2] ),
    .A2(\cur_interval[1] ),
    .A3(\cur_interval[0] ),
    .B1(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_24_));
 sky130_fd_sc_hd__nor2_2 _55_ (.A(_23_),
    .B(_24_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_02_));
 sky130_fd_sc_hd__and2b_2 _56_ (.A_N(beat_prev),
    .B(beat_level),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_25_));
 sky130_fd_sc_hd__mux2_1 _57_ (.A0(uio_out[0]),
    .A1(\cur_interval[0] ),
    .S(_25_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__mux2_1 _58_ (.A0(uio_out[1]),
    .A1(\cur_interval[1] ),
    .S(_25_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_04_));
 sky130_fd_sc_hd__mux2_1 _59_ (.A0(uio_out[2]),
    .A1(\cur_interval[2] ),
    .S(_25_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _60_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uio_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _61_ (.CLK(clknet_1_0__leaf_clk),
    .D(_04_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _64_ (.CLK(clknet_1_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\cur_interval[1] ));
 sky130_fd_sc_hd__dfrtp_2 _65_ (.CLK(clknet_1_0__leaf_clk),
    .D(_02_),
    .RESET_B(net1),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _68_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(beat_prev));
 sky130_fd_sc_hd__buf_2 _82_ (.A(ge1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[0]));
 sky130_fd_sc_hd__buf_2 _83_ (.A(ge2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[1]));
 sky130_fd_sc_hd__buf_2 _84_ (.A(ge3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[2]));
 sky130_fd_sc_hd__buf_2 _85_ (.A(ge4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[3]));
 sky130_fd_sc_hd__buf_2 _86_ (.A(ge5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[4]));
 sky130_fd_sc_hd__buf_2 _87_ (.A(ge6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[5]));
 sky130_fd_sc_hd__buf_2 _88_ (.A(ge7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uo_out[6]));
 sky130_fd_sc_hd__buf_2 _89_ (.A(sign),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_1_1__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlygate4sd3_1 hold15 (.A(\beat_sync[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__dlygate4sd3_1 hold16 (.A(beat_level),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(\cur_interval[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(beat_level),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input2 (.A(ui_in[0]),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_10 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net10));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_11 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net11));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_12 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net12));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_13 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net13));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_14 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net14));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_3 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net3));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_4 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net4));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_5 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net5));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net6));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_7 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net7));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_8 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net8));
 sky130_fd_sc_hd__conb_1 tt_um_ruhangupta_hrv_variability_detector_9 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net9));

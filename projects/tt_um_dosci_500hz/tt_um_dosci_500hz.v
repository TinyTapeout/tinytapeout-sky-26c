module tt_um_dosci_500hz (clk,
 ...
 sky130_fd_sc_hd__inv_2 _274_ (.A(uio_out[0]),
    ...
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__inv_2 _275_ (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__inv_2 _276_ (.A(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _290_ (.A(net78),
    .B(_047_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_2 _295_ (.A(net74),
    .B(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_2 _305_ (.A(\u_dosci500.cnt_reg[7] ),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__a21oi_2 _306_ (.A1(net96),
    .A2(_056_),
    .B1(net61),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _308_ (.A(\u_dosci500.cnt_reg[9] ),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__nor2_2 _309_ (.A(net90),
    .B(_058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_2 _311_ (.A(net76),
    .B(_060_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_2 _322_ (.A(\u_tx115.cnt[7] ),
    ...
    .VPWR(VPWR),
    .Y(_070_));
 sky130_fd_sc_hd__nor2_2 _323_ (.A(net84),
    .B(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _329_ (.A(\u_tx115.cnt[3] ),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__o21ai_2 _330_ (.A1(net94),
    .A2(_073_),
    .B1(net4),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_2 _332_ (.A1(\u_tx115.cnt[4] ),
    ...
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__o21a_2 _333_ (.A1(\u_tx115.cnt[4] ),
    .A2(_074_),
    .B1(_076_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _351_ (.A0(uio_out[7]),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__or2_2 _352_ (.A(net36),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__and2_2 _353_ (.A(net36),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__xnor2_2 _354_ (.A(net37),
    .B(uio_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_2 _356_ (.A(uio_out[0]),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__nand2_2 _357_ (.A(net28),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__xnor2_2 _358_ (.A(net28),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _367_ (.A(uio_out[5]),
    ...
    .VPWR(VPWR),
    .Y(_098_));
 sky130_fd_sc_hd__and2b_2 _368_ (.A_N(net33),
    .B(uio_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _371_ (.A1(_084_),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__a21o_2 _372_ (.A1(net28),
    .A2(_100_),
    .B1(_102_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _380_ (.A0(_110_),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__nand2_2 _381_ (.A(net30),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__xnor2_2 _382_ (.A(net30),
    .B(net26),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__nor2_2 _383_ (.A(net36),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__and2_2 _384_ (.A(net36),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__xnor2_2 _385_ (.A(net36),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _391_ (.A1(_118_),
    ...
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__nand3_2 _392_ (.A(net25),
    .B(_120_),
    .C(_121_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _403_ (.A0(_132_),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__and2_2 _404_ (.A(net28),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_133_));
 sky130_fd_sc_hd__nand2_2 _405_ (.A(net28),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_134_));
 sky130_fd_sc_hd__or2_2 _406_ (.A(net28),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_135_));
 sky130_fd_sc_hd__or2_2 _407_ (.A(net32),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__and2b_2 _408_ (.A_N(net32),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o2111ai_2 _409_ (.A1(_037_),
    ...
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__a221o_2 _410_ (.A1(net32),
    .A2(_085_),
    .B1(_134_),
    .B2(_135_),
    .C1(_137_),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__and2_2 _411_ (.A(net36),
    .B(_099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_2 _418_ (.A1(_144_),
    ...
    .VPWR(VPWR),
    .X(_147_));
 sky130_fd_sc_hd__nand3_2 _419_ (.A(net23),
    .B(_146_),
    .C(_147_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21bo_2 _433_ (.A1(_152_),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__nand2_2 _434_ (.A(net26),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__or2_2 _435_ (.A(net26),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _436_ (.A(_162_),
    ...
    .VPWR(VPWR),
    .X(_164_));
 sky130_fd_sc_hd__mux2_1 _437_ (.A0(net28),
    .A1(_089_),
    .S(net30),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _445_ (.A(_170_),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__nand2_2 _446_ (.A(net22),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_174_));
 sky130_fd_sc_hd__xnor2_2 _447_ (.A(net22),
    .B(_173_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_2 _461_ (.A1(_133_),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__nand2_2 _462_ (.A(net25),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_189_));
 sky130_fd_sc_hd__or2_2 _463_ (.A(net25),
    .B(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_2 _464_ (.A(_189_),
    ...
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__mux2_1 _465_ (.A0(net26),
    .A1(_112_),
    .S(net28),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _466_ (.A(_191_),
    ...
    .VPWR(VPWR),
    .Y(_193_));
 sky130_fd_sc_hd__nand2_2 _467_ (.A(net32),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_2 _469_ (.A(_193_),
    ...
    .VPWR(VPWR),
    .X(_196_));
 sky130_fd_sc_hd__and3_2 _470_ (.A(net26),
    .B(net22),
    .C(_196_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xor2_2 _473_ (.A(_188_),
    ...
    .VPWR(VPWR),
    .X(_200_));
 sky130_fd_sc_hd__xnor2_2 _474_ (.A(net22),
    .B(_200_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_2 _485_ (.A1(_207_),
    ...
    .VPWR(VPWR),
    .Y(_211_));
 sky130_fd_sc_hd__or2_2 _486_ (.A(net26),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_212_));
 sky130_fd_sc_hd__nand2_2 _487_ (.A(net26),
    .B(_135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_2 _488_ (.A1(_133_),
    ...
    .VPWR(VPWR),
    .X(_214_));
 sky130_fd_sc_hd__nand2_2 _489_ (.A(net28),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_215_));
 sky130_fd_sc_hd__a2bb2o_2 _490_ (.A1_N(net26),
    .A2_N(_215_),
    .B1(_192_),
    .B2(_191_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_2 _497_ (.A(_220_),
    ...
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__xnor2_2 _498_ (.A(net23),
    .B(_223_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__a21o_2 _499_ (.A1(net23),
    .A2(_200_),
    .B1(_199_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _509_ (.A0(_234_),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a21oi_2 _510_ (.A1(net23),
    .A2(_223_),
    .B1(_222_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_235_));
 sky130_fd_sc_hd__nand2_2 _511_ (.A(net26),
    .B(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_2 _512_ (.A(_135_),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__xnor2_2 _513_ (.A(net22),
    .B(_217_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__a31oi_2 _514_ (.A1(net25),
    .A2(net22),
    .A3(_219_),
    .B1(_238_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_2 _540_ (.A(\u_tx115.TX_232 ),
    ...
    .VPWR(VPWR),
    .X(_263_));
 sky130_fd_sc_hd__a221o_2 _541_ (.A1(net81),
    .A2(net5),
    .B1(net2),
    .B2(AXIS_TREADY),
    .C1(_263_),
 ...
 sky130_fd_sc_hd__and2_2 _542_ (.A(\u_tx115.q_r[1] ),
    ...
    .VPWR(VPWR),
    .X(_264_));
 sky130_fd_sc_hd__a221o_2 _543_ (.A1(net79),
    .A2(net5),
    .B1(net2),
    .B2(net66),
    .C1(_264_),
 ...
 sky130_fd_sc_hd__and2_2 _544_ (.A(\u_tx115.q_r[2] ),
    ...
    .VPWR(VPWR),
    .X(_265_));
 sky130_fd_sc_hd__a221o_2 _545_ (.A1(net77),
    .A2(net5),
    .B1(net2),
    .B2(net70),
    .C1(_265_),
 ...
 sky130_fd_sc_hd__and2_2 _548_ (.A(\u_tx115.q_r[4] ),
    ...
    .VPWR(VPWR),
    .X(_267_));
 sky130_fd_sc_hd__a221o_2 _549_ (.A1(net80),
    .A2(net5),
    .B1(net2),
    .B2(net62),
    .C1(_267_),
 ...
 sky130_fd_sc_hd__and2_2 _550_ (.A(\u_tx115.q_r[5] ),
    ...
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__a221o_2 _551_ (.A1(net75),
    .A2(net5),
    .B1(net2),
    .B2(net68),
    .C1(_268_),
 ...
 sky130_fd_sc_hd__nor2_2 _560_ (.A(net9),
    ...
    .VPWR(VPWR),
    .Y(_272_));
 sky130_fd_sc_hd__a22o_2 _561_ (.A1(net38),
    .A2(net9),
    .B1(_272_),
    .B2(net66),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__a22o_2 _562_ (.A1(net35),
    .A2(_042_),
    .B1(_272_),
    .B2(net70),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _582_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(net29));
 sky130_fd_sc_hd__dfrtp_2 _583_ (.CLK(clknet_3_1__leaf_clk),
    .D(_013_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _584_ (.CLK(clknet_3_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uio_out[6]));
 sky130_fd_sc_hd__dfrtp_2 _585_ (.CLK(clknet_3_0__leaf_clk),
    .D(_015_),
    .RESET_B(net11),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _590_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_tx115.q_r[4] ));
 sky130_fd_sc_hd__dfrtp_2 _591_ (.CLK(clknet_3_6__leaf_clk),
    .D(_021_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _592_ (.CLK(clknet_3_6__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_tx115.q_r[6] ));
 sky130_fd_sc_hd__dfrtp_2 _593_ (.CLK(clknet_3_7__leaf_clk),
    .D(_023_),
    .RESET_B(net20),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _599_ (.CLK(clknet_3_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_tx115.dato_r[3] ));
 sky130_fd_sc_hd__dfrtp_2 _600_ (.CLK(clknet_3_2__leaf_clk),
    .D(_030_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_tx115.dato_r[4] ));
 sky130_fd_sc_hd__dfrtp_2 _601_ (.CLK(clknet_3_3__leaf_clk),
    .D(_031_),
    .RESET_B(net15),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _606_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_sreset.rst_mid ));
 sky130_fd_sc_hd__conb_1 _606__45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net45));
 ...
 sky130_fd_sc_hd__dfrtp_2 _613_ (.CLK(clknet_3_1__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_2 _614_ (.CLK(clknet_3_4__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_2 _616_ (.CLK(clknet_3_4__leaf_clk),
 ...
 sky130_fd_sc_hd__dfrtp_2 _622_ (.CLK(clknet_3_5__leaf_clk),
    .D(\u_tx115.cnt_sig[0] ),
    .RESET_B(net18),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\u_tx115.cnt[0] ));
 sky130_fd_sc_hd__dfrtp_2 _623_ (.CLK(clknet_3_5__leaf_clk),
    .D(net73),
    .RESET_B(net18),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _628_ (.CLK(clknet_3_7__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\u_tx115.cnt[6] ));
 sky130_fd_sc_hd__dfrtp_2 _629_ (.CLK(clknet_3_7__leaf_clk),
    .D(\u_tx115.cnt_sig[7] ),
    .RESET_B(net21),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout10 (.A(net12),
    ...
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout12 (.A(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout13 (.A(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout2 (.A(_261_),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(net55),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net23),
    ...
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(uio_out[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(net24),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[7]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(uio_out[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout26 (.A(uio_out[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout27 (.A(net27),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(uio_out[5]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout28 (.A(uio_out[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout29 (.A(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout3 (.A(net4),
    ...
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(uio_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout32 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout33 (.A(uio_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout34 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout35 (.A(net35),
    ...
    .VPWR(VPWR),
    .X(uio_out[1]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout9 (.A(_042_),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\u_sreset.rst_mid ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(AXIS_ARESETN),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\u_tx115.dato_r[3] ),
    ...
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\u_dosci500.cnt_reg[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\u_tx115.dato_r[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__dlygate4sd3_1 hold63 (.A(\u_tx115.dato_r[8] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd3_1 hold64 (.A(\u_dosci500.y_aux[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd3_1 hold65 (.A(\u_tx115.dato_r[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__dlygate4sd3_1 hold66 (.A(\u_tx115.dato_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd3_1 hold67 (.A(_027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd3_1 hold68 (.A(\u_tx115.dato_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold69 (.A(\u_tx115.q_r[4] ),
    ...
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd3_1 hold70 (.A(\u_tx115.dato_r[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd3_1 hold71 (.A(_028_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd3_1 hold72 (.A(\u_tx115.cnt[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd3_1 hold73 (.A(\u_tx115.cnt_sig[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd3_1 hold74 (.A(\u_dosci500.cnt_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__dlygate4sd3_1 hold75 (.A(\u_tx115.q_r[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd3_1 hold76 (.A(\u_dosci500.cnt_reg[10] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold77 (.A(\u_tx115.q_r[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__dlygate4sd3_1 hold78 (.A(\u_dosci500.cnt_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__dlygate4sd3_1 hold79 (.A(\u_tx115.q_r[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__dlygate4sd3_1 hold80 (.A(\u_tx115.q_r[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__dlygate4sd3_1 hold81 (.A(\u_tx115.q_r[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold82 (.A(\u_tx115.q_r[8] ),
    ...
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__dlygate4sd3_1 hold83 (.A(\u_dosci500.y_aux[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlygate4sd3_1 hold84 (.A(\u_tx115.cnt[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__dlygate4sd3_1 hold85 (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlygate4sd3_1 hold86 (.A(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold88 (.A(\u_tx115.cnt[8] ),
    ...
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd3_1 hold89 (.A(\u_dosci500.y_aux[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__dlygate4sd3_1 hold90 (.A(\u_dosci500.cnt_reg[9] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold91 (.A(AXIS_TVALID),
    ...
    .VPWR(VPWR),
    .X(net91));
 sky130_fd_sc_hd__dlygate4sd3_1 hold92 (.A(\u_tx115.cnt[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold93 (.A(\u_tx115.cnt[6] ),
    ...
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold94 (.A(\u_tx115.cnt[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold95 (.A(\u_dosci500.y_aux[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold96 (.A(\u_dosci500.cnt_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew14 (.A(net13),
    ...
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkbuf_4 load_slew17 (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__buf_2 load_slew36 (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__clkbuf_2 load_slew37 (.A(uio_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__conb_1 tt_um_dosci_500hz (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_dosci_500hz_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 ...
 sky130_fd_sc_hd__conb_1 tt_um_dosci_500hz_52 (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .HI(net52));
 sky130_fd_sc_hd__conb_1 tt_um_dosci_500hz_53 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net53));
 sky130_fd_sc_hd__clkbuf_4 wire20 (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),

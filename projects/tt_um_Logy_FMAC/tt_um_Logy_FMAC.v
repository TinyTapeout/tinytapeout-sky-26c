module tt_um_Logy_FMAC (clk,
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_9_137 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__nand2_2 _194_ (.A(net23),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_183_));
 sky130_fd_sc_hd__a21bo_2 _195_ (.A1(\c_reg[1] ),
    .A2(_176_),
    .B1_N(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_184_));
 sky130_fd_sc_hd__a22o_2 _196_ (.A1(net16),
    .A2(net21),
    .B1(net20),
    .B2(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_185_));
 sky130_fd_sc_hd__nand4_2 _197_ (.A(net17),
    .B(net16),
    .C(net21),
    .D(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__nand3_2 _198_ (.A(\c_reg[2] ),
    .B(_185_),
    .C(_186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_187_));
 sky130_fd_sc_hd__a21o_2 _199_ (.A1(_185_),
    .A2(_186_),
    .B1(\c_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_188_));
 sky130_fd_sc_hd__and3_2 _200_ (.A(_184_),
    .B(_187_),
    .C(_188_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__a21oi_2 _201_ (.A1(_187_),
    .A2(_188_),
    .B1(_184_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_190_));
 sky130_fd_sc_hd__nor2_2 _202_ (.A(_189_),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_191_));
 sky130_fd_sc_hd__xnor2_2 _203_ (.A(_183_),
    .B(_191_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_192_));
 sky130_fd_sc_hd__xor2_2 _204_ (.A(net13),
    .B(_192_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_193_));
 sky130_fd_sc_hd__mux2_1 _205_ (.A0(uo_out[2]),
    .A1(_193_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__a22oi_2 _206_ (.A1(net21),
    .A2(net15),
    .B1(net14),
    .B2(net23),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_032_));
 sky130_fd_sc_hd__and4_2 _207_ (.A(net23),
    .B(net21),
    .C(net15),
    .D(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__or2_2 _208_ (.A(_032_),
    .B(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__a22o_2 _209_ (.A1(net16),
    .A2(net20),
    .B1(net19),
    .B2(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__nand4_2 _210_ (.A(net17),
    .B(net16),
    .C(net20),
    .D(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_036_));
 sky130_fd_sc_hd__nand3_2 _211_ (.A(\c_reg[3] ),
    .B(_035_),
    .C(_036_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_037_));
 sky130_fd_sc_hd__a21o_2 _212_ (.A1(_035_),
    .A2(_036_),
    .B1(\c_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_038_));
 sky130_fd_sc_hd__a21bo_2 _213_ (.A1(\c_reg[2] ),
    .A2(_185_),
    .B1_N(_186_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__and3_2 _214_ (.A(_037_),
    .B(_038_),
    .C(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_040_));
 sky130_fd_sc_hd__nand3_2 _215_ (.A(_037_),
    .B(_038_),
    .C(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__a21oi_2 _216_ (.A1(_037_),
    .A2(_038_),
    .B1(_039_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__or3_2 _217_ (.A(_034_),
    .B(_040_),
    .C(_042_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__o21ai_2 _218_ (.A1(_040_),
    .A2(_042_),
    .B1(_034_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_044_));
 sky130_fd_sc_hd__and2_2 _219_ (.A(_043_),
    .B(_044_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__o21ba_2 _220_ (.A1(_183_),
    .A2(_190_),
    .B1_N(_189_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__and2b_2 _221_ (.A_N(_046_),
    .B(_045_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__xnor2_2 _222_ (.A(_045_),
    .B(_046_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_048_));
 sky130_fd_sc_hd__nand3_2 _223_ (.A(net13),
    .B(_192_),
    .C(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__a21o_2 _224_ (.A1(net13),
    .A2(_192_),
    .B1(_048_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__and2b_2 _225_ (.A_N(net25),
    .B(uo_out[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__a31o_2 _226_ (.A1(net25),
    .A2(_049_),
    .A3(_050_),
    .B1(_051_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__nand2_2 _227_ (.A(_036_),
    .B(_037_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_052_));
 sky130_fd_sc_hd__a22o_2 _228_ (.A1(net16),
    .A2(net19),
    .B1(\a_reg[4] ),
    .B2(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_053_));
 sky130_fd_sc_hd__nand4_2 _229_ (.A(net17),
    .B(net16),
    .C(net19),
    .D(\a_reg[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__nand3_2 _230_ (.A(\c_reg[4] ),
    .B(_053_),
    .C(_054_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_055_));
 sky130_fd_sc_hd__a21o_2 _231_ (.A1(_053_),
    .A2(_054_),
    .B1(\c_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__nand3_2 _232_ (.A(_033_),
    .B(_055_),
    .C(_056_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_057_));
 sky130_fd_sc_hd__a21o_2 _233_ (.A1(_055_),
    .A2(_056_),
    .B1(_033_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__nand3_2 _234_ (.A(_052_),
    .B(_057_),
    .C(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__a21o_2 _235_ (.A1(_057_),
    .A2(_058_),
    .B1(_052_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__nand2_2 _236_ (.A(net15),
    .B(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__and4_2 _237_ (.A(net23),
    .B(net21),
    .C(\b_reg[4] ),
    .D(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__a22o_2 _238_ (.A1(net23),
    .A2(\b_reg[4] ),
    .B1(net14),
    .B2(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_063_));
 sky130_fd_sc_hd__and2b_2 _239_ (.A_N(_062_),
    .B(_063_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__xnor2_2 _240_ (.A(_061_),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_065_));
 sky130_fd_sc_hd__and3_2 _241_ (.A(_059_),
    .B(_060_),
    .C(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__a21oi_2 _242_ (.A1(_059_),
    .A2(_060_),
    .B1(_065_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__a211o_2 _243_ (.A1(_041_),
    .A2(_043_),
    .B1(_066_),
    .C1(_067_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__o211ai_2 _244_ (.A1(_066_),
    .A2(_067_),
    .B1(_041_),
    .C1(_043_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_069_));
 sky130_fd_sc_hd__and3_2 _245_ (.A(_047_),
    .B(_068_),
    .C(_069_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__a21oi_2 _246_ (.A1(_068_),
    .A2(_069_),
    .B1(_047_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _247_ (.A(_070_),
    ...
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__xnor2_2 _248_ (.A(_049_),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__mux2_1 _249_ (.A0(uo_out[4]),
    .A1(_073_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__o21ba_2 _250_ (.A1(_049_),
    .A2(_071_),
    .B1_N(_070_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__nand2_2 _251_ (.A(_057_),
    .B(_059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_075_));
 sky130_fd_sc_hd__nand2_2 _252_ (.A(_054_),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_076_));
 sky130_fd_sc_hd__a31o_2 _253_ (.A1(net15),
    .A2(net20),
    .A3(_063_),
    .B1(_062_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__a22o_2 _254_ (.A1(net16),
    .A2(\a_reg[4] ),
    .B1(\a_reg[5] ),
    .B2(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__nand4_2 _255_ (.A(net17),
    .B(net16),
    .C(\a_reg[4] ),
    .D(\a_reg[5] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_079_));
 sky130_fd_sc_hd__nand3_2 _256_ (.A(\c_reg[5] ),
    .B(_078_),
    .C(_079_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__a21o_2 _257_ (.A1(_078_),
    .A2(_079_),
    .B1(\c_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_081_));
 sky130_fd_sc_hd__nand3_2 _258_ (.A(_077_),
    .B(_080_),
    .C(_081_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__a21o_2 _259_ (.A1(_080_),
    .A2(_081_),
    .B1(_077_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_083_));
 sky130_fd_sc_hd__nand3_2 _260_ (.A(_076_),
    .B(_082_),
    .C(_083_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_084_));
 sky130_fd_sc_hd__a21o_2 _261_ (.A1(_082_),
    .A2(_083_),
    .B1(_076_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__nand2_2 _262_ (.A(net23),
    .B(\b_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__nand2_2 _263_ (.A(net15),
    .B(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_087_));
 sky130_fd_sc_hd__and3_2 _264_ (.A(net21),
    .B(net20),
    .C(\b_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_088_));
 sky130_fd_sc_hd__a22o_2 _265_ (.A1(net21),
    .A2(\b_reg[4] ),
    .B1(net14),
    .B2(net20),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__a21bo_2 _266_ (.A1(net14),
    .A2(_088_),
    .B1_N(_089_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__xor2_2 _267_ (.A(_087_),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__and3_2 _268_ (.A(net24),
    .B(\b_reg[5] ),
    .C(_091_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_092_));
 sky130_fd_sc_hd__xnor2_2 _269_ (.A(_086_),
    .B(_091_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__and3_2 _270_ (.A(_084_),
    .B(_085_),
    .C(_093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__a21oi_2 _271_ (.A1(_084_),
    .A2(_085_),
    .B1(_093_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_095_));
 sky130_fd_sc_hd__or3b_2 _272_ (.A(_094_),
    .B(_095_),
    .C_N(_066_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_096_));
 sky130_fd_sc_hd__o21bai_2 _273_ (.A1(_094_),
    .A2(_095_),
    .B1_N(_066_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_097_));
 sky130_fd_sc_hd__and3_2 _274_ (.A(_075_),
    .B(_096_),
    .C(_097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__nand3_2 _275_ (.A(_075_),
    .B(_096_),
    .C(_097_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_099_));
 sky130_fd_sc_hd__a21oi_2 _276_ (.A1(_096_),
    .A2(_097_),
    .B1(_075_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_100_));
 sky130_fd_sc_hd__o21a_2 _277_ (.A1(_098_),
    .A2(_100_),
    .B1(_068_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__or3_2 _278_ (.A(_068_),
    .B(_098_),
    .C(_100_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__and2b_2 _279_ (.A_N(_101_),
    .B(_102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__xnor2_2 _280_ (.A(_074_),
    .B(_103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__mux2_1 _281_ (.A0(uo_out[5]),
    .A1(_104_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__a22o_2 _282_ (.A1(net20),
    .A2(\b_reg[4] ),
    .B1(net14),
    .B2(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_105_));
 sky130_fd_sc_hd__nand4_2 _283_ (.A(net20),
    .B(\b_reg[4] ),
    .C(net14),
    .D(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__a22o_2 _284_ (.A1(net15),
    .A2(\a_reg[4] ),
    .B1(_105_),
    .B2(_106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__nand4_2 _285_ (.A(net15),
    .B(\a_reg[4] ),
    .C(_105_),
    .D(_106_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__nand4_2 _286_ (.A(net24),
    .B(net22),
    .C(\b_reg[5] ),
    .D(\b_reg[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__nand2_2 _287_ (.A(\b_reg[5] ),
    .B(_109_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__a22o_2 _288_ (.A1(net22),
    .A2(\b_reg[5] ),
    .B1(\b_reg[6] ),
    .B2(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_111_));
 sky130_fd_sc_hd__and2_2 _289_ (.A(_109_),
    .B(_111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__nand3_2 _290_ (.A(_107_),
    .B(_108_),
    .C(_112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__a21o_2 _291_ (.A1(_107_),
    .A2(_108_),
    .B1(_112_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_114_));
 sky130_fd_sc_hd__nand2_2 _292_ (.A(_113_),
    .B(_114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__nand3_2 _293_ (.A(_092_),
    .B(_113_),
    .C(_114_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__xor2_2 _294_ (.A(_092_),
    .B(_115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__nand2_2 _295_ (.A(_079_),
    .B(_080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_118_));
 sky130_fd_sc_hd__a32o_2 _296_ (.A1(net15),
    .A2(net19),
    .A3(_089_),
    .B1(_088_),
    .B2(net14),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__a22o_2 _297_ (.A1(\b_reg[1] ),
    .A2(\a_reg[5] ),
    .B1(\a_reg[6] ),
    .B2(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_120_));
 sky130_fd_sc_hd__nand2_2 _298_ (.A(\b_reg[1] ),
    .B(\a_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_121_));
 sky130_fd_sc_hd__nand4_2 _299_ (.A(net18),
    .B(\b_reg[1] ),
    .C(\a_reg[5] ),
    .D(\a_reg[6] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_122_));
 sky130_fd_sc_hd__nand3_2 _300_ (.A(\c_reg[6] ),
    .B(_120_),
    .C(_122_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__a21o_2 _301_ (.A1(_120_),
    .A2(_122_),
    .B1(\c_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__nand3_2 _302_ (.A(_119_),
    .B(_123_),
    .C(_124_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_125_));
 sky130_fd_sc_hd__a21o_2 _303_ (.A1(_123_),
    .A2(_124_),
    .B1(_119_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_126_));
 sky130_fd_sc_hd__and3_2 _304_ (.A(_118_),
    .B(_125_),
    .C(_126_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_127_));
 sky130_fd_sc_hd__a21oi_2 _305_ (.A1(_125_),
    .A2(_126_),
    .B1(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_128_));
 sky130_fd_sc_hd__or3_2 _306_ (.A(_117_),
    .B(_127_),
    .C(_128_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_129_));
 sky130_fd_sc_hd__o21ai_2 _307_ (.A1(_127_),
    .A2(_128_),
    .B1(_117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_130_));
 sky130_fd_sc_hd__and3_2 _308_ (.A(_094_),
    .B(_129_),
    .C(_130_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_131_));
 sky130_fd_sc_hd__a21oi_2 _309_ (.A1(_129_),
    .A2(_130_),
    .B1(_094_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_132_));
 sky130_fd_sc_hd__a211oi_2 _310_ (.A1(_082_),
    .A2(_084_),
    .B1(_131_),
    .C1(_132_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__o211a_2 _311_ (.A1(_131_),
    .A2(_132_),
    .B1(_082_),
    .C1(_084_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_134_));
 sky130_fd_sc_hd__a211oi_2 _312_ (.A1(_096_),
    .A2(_099_),
    .B1(_133_),
    .C1(_134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__a211o_2 _313_ (.A1(_096_),
    .A2(_099_),
    .B1(_133_),
    .C1(_134_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_136_));
 sky130_fd_sc_hd__o211a_2 _314_ (.A1(_133_),
    .A2(_134_),
    .B1(_096_),
    .C1(_099_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__nor2_2 _315_ (.A(_135_),
    .B(_137_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__a21o_2 _316_ (.A1(_074_),
    .A2(_102_),
    .B1(_101_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__xnor2_2 _317_ (.A(_138_),
    .B(_139_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_140_));
 sky130_fd_sc_hd__mux2_1 _318_ (.A0(uo_out[6]),
    .A1(_140_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__o21a_2 _319_ (.A1(_137_),
    .A2(_139_),
    .B1(_136_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_141_));
 sky130_fd_sc_hd__nor2_2 _320_ (.A(_131_),
    .B(_133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_142_));
 sky130_fd_sc_hd__nand2_2 _321_ (.A(_116_),
    .B(_129_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_143_));
 sky130_fd_sc_hd__a31o_2 _322_ (.A1(_119_),
    .A2(_123_),
    .A3(_124_),
    .B1(_127_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_144_));
 sky130_fd_sc_hd__xnor2_2 _323_ (.A(_143_),
    .B(_144_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_145_));
 sky130_fd_sc_hd__nand2_2 _324_ (.A(_106_),
    .B(_108_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_146_));
 sky130_fd_sc_hd__nand2_2 _325_ (.A(_122_),
    .B(_123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_147_));
 sky130_fd_sc_hd__xor2_2 _326_ (.A(_146_),
    .B(_147_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_148_));
 sky130_fd_sc_hd__a22o_2 _327_ (.A1(\b_reg[4] ),
    .A2(net19),
    .B1(\a_reg[4] ),
    .B2(net14),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_149_));
 sky130_fd_sc_hd__nand4_2 _328_ (.A(\b_reg[4] ),
    .B(\b_reg[3] ),
    .C(net19),
    .D(\a_reg[4] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_150_));
 sky130_fd_sc_hd__nand2_2 _329_ (.A(net15),
    .B(\a_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_151_));
 sky130_fd_sc_hd__xnor2_2 _330_ (.A(_121_),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_152_));
 sky130_fd_sc_hd__a22oi_2 _331_ (.A1(net22),
    .A2(\b_reg[6] ),
    .B1(\b_reg[7] ),
    .B2(net24),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_153_));
 sky130_fd_sc_hd__and4_2 _332_ (.A(net24),
    .B(net22),
    .C(\b_reg[6] ),
    .D(\b_reg[7] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_154_));
 sky130_fd_sc_hd__nand2_2 _333_ (.A(net18),
    .B(\a_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_155_));
 sky130_fd_sc_hd__xor2_2 _334_ (.A(\c_reg[7] ),
    .B(_155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_156_));
 sky130_fd_sc_hd__mux2_1 _335_ (.A0(_109_),
    .A1(_110_),
    .S(\a_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_157_));
 sky130_fd_sc_hd__o211a_2 _336_ (.A1(_153_),
    .A2(_154_),
    .B1(_149_),
    .C1(_150_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_158_));
 sky130_fd_sc_hd__a211o_2 _337_ (.A1(_149_),
    .A2(_150_),
    .B1(_153_),
    .C1(_154_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_159_));
 sky130_fd_sc_hd__and2b_2 _338_ (.A_N(_158_),
    .B(_159_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_160_));
 sky130_fd_sc_hd__xnor2_2 _339_ (.A(_152_),
    .B(_156_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_161_));
 sky130_fd_sc_hd__xnor2_2 _340_ (.A(_157_),
    .B(_161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__xnor2_2 _341_ (.A(_148_),
    .B(_160_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_163_));
 sky130_fd_sc_hd__xnor2_2 _342_ (.A(_113_),
    .B(_162_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_164_));
 sky130_fd_sc_hd__xnor2_2 _343_ (.A(_163_),
    .B(_164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_165_));
 sky130_fd_sc_hd__xnor2_2 _344_ (.A(_145_),
    .B(_165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_166_));
 sky130_fd_sc_hd__xnor2_2 _345_ (.A(_142_),
    .B(_166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_167_));
 sky130_fd_sc_hd__xnor2_2 _346_ (.A(_141_),
    .B(_167_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_168_));
 sky130_fd_sc_hd__mux2_1 _347_ (.A0(uo_out[7]),
    .A1(_168_),
    .S(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_007_));
 sky130_fd_sc_hd__or3_2 _348_ (.A(net3),
    .B(net2),
    .C(net4),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _349_ (.A0(net5),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__mux2_1 _350_ (.A0(net6),
    .A1(net22),
    .S(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__mux2_1 _351_ (.A0(net7),
    .A1(net56),
    .S(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__mux2_1 _352_ (.A0(net8),
    .A1(net48),
    .S(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__mux2_1 _353_ (.A0(net9),
    .A1(\a_reg[4] ),
    .S(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__mux2_1 _354_ (.A0(net10),
    .A1(\a_reg[5] ),
    .S(_169_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__mux2_1 _355_ (.A0(net11),
    .A1(net62),
    .S(_169_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _356_ (.A0(net12),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__or3b_2 _357_ (.A(net3),
    .B(net4),
    .C_N(net2),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__mux2_1 _358_ (.A0(net5),
    .A1(net18),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__mux2_1 _359_ (.A0(net6),
    .A1(\b_reg[1] ),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__mux2_1 _360_ (.A0(net7),
    .A1(net49),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_018_));
 sky130_fd_sc_hd__mux2_1 _361_ (.A0(net8),
    .A1(net51),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_019_));
 sky130_fd_sc_hd__mux2_1 _362_ (.A0(net9),
    .A1(\b_reg[4] ),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__mux2_1 _363_ (.A0(net10),
    .A1(\b_reg[5] ),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _364_ (.A0(net11),
    .A1(\b_reg[6] ),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__mux2_1 _365_ (.A0(net12),
    .A1(net53),
    .S(_170_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__or3b_2 _366_ (.A(net2),
    .B(net4),
    .C_N(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__mux2_1 _367_ (.A0(net5),
    .A1(net52),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_024_));
 sky130_fd_sc_hd__mux2_1 _368_ (.A0(net6),
    .A1(net60),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__mux2_1 _369_ (.A0(net7),
    .A1(net61),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_026_));
 sky130_fd_sc_hd__mux2_1 _370_ (.A0(net8),
    .A1(net57),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__mux2_1 _371_ (.A0(net9),
    .A1(net55),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__mux2_1 _372_ (.A0(net10),
    .A1(net54),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__mux2_1 _373_ (.A0(net11),
    .A1(net58),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_030_));
 sky130_fd_sc_hd__mux2_1 _374_ (.A0(net12),
    .A1(net59),
    .S(_171_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_031_));
 sky130_fd_sc_hd__and3b_2 _375_ (.A_N(net4),
    .B(net2),
    .C(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_172_));
 sky130_fd_sc_hd__nand3_2 _376_ (.A(net17),
    .B(net23),
    .C(\c_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_173_));
 sky130_fd_sc_hd__a21o_2 _377_ (.A1(net17),
    .A2(net23),
    .B1(\c_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__and2b_2 _378_ (.A_N(net25),
    .B(uo_out[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__a31o_2 _379_ (.A1(net25),
    .A2(_173_),
    .A3(_174_),
    .B1(_175_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__a22o_2 _380_ (.A1(net23),
    .A2(net16),
    .B1(net21),
    .B2(net18),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_176_));
 sky130_fd_sc_hd__nand4_2 _381_ (.A(net18),
    .B(net23),
    .C(net16),
    .D(net21),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__and3_2 _382_ (.A(\c_reg[1] ),
    .B(_176_),
    .C(_177_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_178_));
 sky130_fd_sc_hd__a21oi_2 _383_ (.A1(_176_),
    .A2(_177_),
    .B1(\c_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_179_));
 sky130_fd_sc_hd__nor3_2 _384_ (.A(_173_),
    .B(_178_),
    .C(_179_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_180_));
 sky130_fd_sc_hd__o21a_2 _385_ (.A1(_178_),
    .A2(_179_),
    .B1(_173_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_181_));
 sky130_fd_sc_hd__o21ai_2 _386_ (.A1(_180_),
    .A2(_181_),
    .B1(net25),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_182_));
 sky130_fd_sc_hd__o21a_2 _387_ (.A1(uo_out[1]),
    .A2(_172_),
    .B1(_182_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__dfrtp_2 _388_ (.CLK(clknet_2_0__leaf_clk),
    .D(_000_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[0]));
 sky130_fd_sc_hd__dfrtp_2 _389_ (.CLK(clknet_2_1__leaf_clk),
    .D(_001_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[1]));
 sky130_fd_sc_hd__dfrtp_2 _390_ (.CLK(clknet_2_1__leaf_clk),
    .D(_002_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[2]));
 sky130_fd_sc_hd__dfrtp_2 _391_ (.CLK(clknet_2_1__leaf_clk),
    .D(_003_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[3]));
 sky130_fd_sc_hd__dfrtp_2 _392_ (.CLK(clknet_2_1__leaf_clk),
    .D(_004_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _393_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(uo_out[5]));
 sky130_fd_sc_hd__dfrtp_2 _394_ (.CLK(clknet_2_1__leaf_clk),
    .D(_006_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[6]));
 sky130_fd_sc_hd__dfrtp_2 _395_ (.CLK(clknet_2_1__leaf_clk),
    .D(_007_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(uo_out[7]));
 sky130_fd_sc_hd__dfrtp_2 _396_ (.CLK(clknet_2_3__leaf_clk),
    .D(_008_),
    .RESET_B(net26),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[0] ));
 sky130_fd_sc_hd__dfrtp_2 _397_ (.CLK(clknet_2_3__leaf_clk),
    .D(_009_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[1] ));
 sky130_fd_sc_hd__dfrtp_2 _398_ (.CLK(clknet_2_0__leaf_clk),
    .D(_010_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[2] ));
 sky130_fd_sc_hd__dfrtp_2 _399_ (.CLK(clknet_2_2__leaf_clk),
    .D(_011_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[3] ));
 sky130_fd_sc_hd__dfrtp_2 _400_ (.CLK(clknet_2_2__leaf_clk),
    .D(_012_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_2 _401_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[5] ));
 sky130_fd_sc_hd__dfrtp_2 _402_ (.CLK(clknet_2_2__leaf_clk),
    .D(_014_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[6] ));
 sky130_fd_sc_hd__dfrtp_2 _403_ (.CLK(clknet_2_3__leaf_clk),
    .D(_015_),
    .RESET_B(net28),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\a_reg[7] ));
 sky130_fd_sc_hd__dfrtp_2 _404_ (.CLK(clknet_2_3__leaf_clk),
    .D(_016_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[0] ));
 sky130_fd_sc_hd__dfrtp_2 _405_ (.CLK(clknet_2_0__leaf_clk),
    .D(_017_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[1] ));
 sky130_fd_sc_hd__dfrtp_2 _406_ (.CLK(clknet_2_0__leaf_clk),
    .D(_018_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[2] ));
 sky130_fd_sc_hd__dfrtp_2 _407_ (.CLK(clknet_2_2__leaf_clk),
    .D(_019_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[3] ));
 sky130_fd_sc_hd__dfrtp_2 _408_ (.CLK(clknet_2_2__leaf_clk),
    .D(_020_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[4] ));
 sky130_fd_sc_hd__dfrtp_2 _409_ (.CLK(clknet_2_2__leaf_clk),
    .D(_021_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[5] ));
 sky130_fd_sc_hd__dfrtp_2 _410_ (.CLK(clknet_2_2__leaf_clk),
    .D(_022_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[6] ));
 sky130_fd_sc_hd__dfrtp_2 _411_ (.CLK(clknet_2_3__leaf_clk),
    .D(_023_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\b_reg[7] ));
 sky130_fd_sc_hd__dfrtp_2 _412_ (.CLK(clknet_2_3__leaf_clk),
    .D(_024_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c_reg[0] ));
 sky130_fd_sc_hd__dfrtp_2 _413_ (.CLK(clknet_2_1__leaf_clk),
    .D(_025_),
    .RESET_B(net29),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c_reg[1] ));
 sky130_fd_sc_hd__dfrtp_2 _414_ (.CLK(clknet_2_0__leaf_clk),
    .D(_026_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c_reg[2] ));
 sky130_fd_sc_hd__dfrtp_2 _415_ (.CLK(clknet_2_0__leaf_clk),
    .D(_027_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c_reg[3] ));
 sky130_fd_sc_hd__dfrtp_2 _416_ (.CLK(clknet_2_0__leaf_clk),
    .D(_028_),
    .RESET_B(net27),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c_reg[4] ));
 sky130_fd_sc_hd__dfrtp_2 _417_ (.CLK(clknet_2_0__leaf_clk),
    .D(_029_),
    .RESET_B(net32),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c_reg[5] ));
 sky130_fd_sc_hd__dfrtp_2 _418_ (.CLK(clknet_2_2__leaf_clk),
    .D(_030_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\c_reg[6] ));
 sky130_fd_sc_hd__dfrtp_2 _419_ (.CLK(clknet_2_3__leaf_clk),
    .D(_031_),
    .RESET_B(net30),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout14 (.A(\b_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout15 (.A(\b_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout16 (.A(\b_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout17 (.A(net18),
    ...
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(\b_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout19 (.A(\a_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout20 (.A(\a_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout21 (.A(\a_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(\a_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout23 (.A(\a_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout24 (.A(\a_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout25 (.A(_172_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout30 (.A(net31),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout31 (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__dlygate4sd3_1 hold48 (.A(\a_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd3_1 hold49 (.A(\b_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlygate4sd3_1 hold50 (.A(\a_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd3_1 hold51 (.A(\b_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__dlygate4sd3_1 hold52 (.A(\c_reg[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd3_1 hold53 (.A(\b_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd3_1 hold54 (.A(\c_reg[5] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__dlygate4sd3_1 hold55 (.A(\c_reg[4] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__dlygate4sd3_1 hold56 (.A(\a_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd3_1 hold57 (.A(\c_reg[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd3_1 hold58 (.A(\c_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__dlygate4sd3_1 hold59 (.A(\c_reg[7] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd3_1 hold60 (.A(\c_reg[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd3_1 hold61 (.A(\c_reg[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__dlygate4sd3_1 hold62 (.A(\a_reg[6] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 input4 (.A(ui_in[2]),
    ...
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input5 (.A(uio_in[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input6 (.A(uio_in[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input7 (.A(uio_in[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input8 (.A(uio_in[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkdlybuf4s25_1 input9 (.A(uio_in[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 load_slew32 (.A(net31),
    ...
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__clkbuf_2 max_cap13 (.A(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_33 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net33));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_34 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net34));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_35 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net35));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_36 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net36));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_37 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net37));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_38 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net38));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_39 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net39));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_40 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net40));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_41 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net41));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_42 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net42));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_43 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net43));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_44 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net44));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_45 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net45));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_46 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net46));
 sky130_fd_sc_hd__conb_1 tt_um_Logy_FMAC_47 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net47));
